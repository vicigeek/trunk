...
$report_name = 'Usuário Planilha de Tempo';
$db_source = 'M';
...
if ($calls_summary)
	...
	$MAIN.="TOTAL DE CHAMADAS TAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[DOWNLOAD]</a>\n";
	...
	$MAIN.="----------------------------------------------------------------\n";
	$MAIN.="TOTAL ACTIVE AGENTE TIME: $pfTOTAL_TIME_HMS\n\n";
	$CSV_text1.=$CSV_text_header;
	$CSV_text1.="\"\",\"TOTAL DE CHAMADAS TAKEN: $row[0]\"\n";
	...
	$CSV_text1.="\"\",\"TOTAL ACTIVE AGENTE TIME:\",\"$pfTOTAL_TIME_HMS\"\n\n";
	}
else
	{
...
$MAIN.="<B>TIMECLOCK HORÁRIO DE LOGIN/LOGOUT:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[DOWNLOAD]</a></B>\n";
...
$CSV_text2.=$CSV_login;
$CSV_text2.="\"TIMECLOCK HORÁRIO DE LOGIN/LOGOUT:\"\n";
$CSV_text2.="\"\",\"ID\",\"EDIT\",\"EVENT\",\"DATE\",\"IP ADDRESS\",\"GROUP\",\"HORAS:MINUTOS\"\n";
