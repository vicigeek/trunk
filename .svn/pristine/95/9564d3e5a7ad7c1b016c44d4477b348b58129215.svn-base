...
{
echo "\n\n";
echo "PLEASE SELECT A DATE RANGE ABOVE AND CLICK INVIA\n";
}
...
### GRAB ALL RECORDS WITHIN RANGE FROM THE DATABASE ###
echo "List Update Dettagliata:<BR>\n";
echo "<TABLE CELLPADDING=1 CELLSPACING=1 Border=1>\n";
echo "<TR><TD><B>DATE/TIME</B></TD><TD><B>LEAD_ID</B></TD><TD><B>VENDOR_ID</B></TD><TD><B>PHONE</B></TD><TD><B>ESITO</B></TD><TD><B>OLD_STATUS</B></TD><TD><B>OLD_LIST</B></TD><TD><B>FILENAME</B></TD><TD><B>RESULT</B></TD><TD><B>UPDATED_ROWS</B></TD>\n";
echo "</TR>\n";
