...
$report_name = 'Ομάδα ΧρήστηΏρα ρολόι Status Report';
$db_source = 'M';
...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>Ώρα ρολόι Status for $user_group</TD><TD ALIGN=RIGHT> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
$MAIN.="<a href=\"./timeclock_report.php\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>TIMECLOCK REPORT</a> | ";
$MAIN.="<a href=\"./admin.php?ADD=311111&user_group=$user_group\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>ΟΜΑΔΑ ΧΡΗΣΤΩΝ</a>\n";
$MAIN.="</TD></TR>\n";
...
$MAIN.="<B>USER STATUS FOR ΟΜΑΔΑ ΧΡΗΣΤΩΝ: $user_group &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$PHP_SELF?DB=$DB&user_group=$user_group&submit=$submit&file_download=1'>[ΛΗΨΗ]</a></B>\n";
...
$CSV_text.="\"USER STATUS FOR ΟΜΑΔΑ ΧΡΗΣΤΩΝ: $user_group\"\n";
...
$MAIN.="<B>TIMECLOCK  ΧΡΟΝΟΣ ΣYΝΔΕΣΗΣ/ΑΠΟΣΥΝΔΕΣΗΣ:</B>\n";
