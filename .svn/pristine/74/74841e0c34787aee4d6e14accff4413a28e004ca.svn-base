...
$report_name = 'Agent Time Détails';
$db_source = 'M';
...
if ( (strlen($group[0]) < 1) or (strlen($user_group[0]) < 1) )
	...
	$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>AGENT TIME BREAKDOWN</caption><tr><th class='thgraph' scope='col'>ETAT</th>";
	...
	# Affichers park info - need to run regardless so HTML view will populate
	$park_array=array();
...
echo "</SELECT>\n";
echo "</TD><TD VALIGN=TOP>Groupes d'utilisateurs:<BR>";
echo "<SELECT SIZE=5 NAME=user_group[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$user_group_string))
	{echo "<option value=\"--ALL--\" selected>-- ALL GROUPES D'UTILISATEURS --</option>\n";}
else
	{echo "<option value=\"--ALL--\">-- ALL GROUPES D'UTILISATEURS --</option>\n";}
$o=0;
...
echo "<INPUT TYPE=Submit NAME=VALIDER VALUE=VALIDER>$NWB#agent_time_detail$NWE\n";
echo "</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";

echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
echo " <a href=\"$LINKbase&stage=$stage&file_download=1\">TÉLÉCHARGER</a> | \n";
echo " <a href=\"./admin.php?ADD=999999\">RAPPORTS</a> </FONT>\n";
echo "</FONT>\n";
echo "</TD></TR></TABLE>";
