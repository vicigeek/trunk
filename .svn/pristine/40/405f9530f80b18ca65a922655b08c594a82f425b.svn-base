...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&VALIDER=$VALIDER&file_download=1\">TÉLÉCHARGER</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFIER</a> | <a href=\"./admin.php?ADD=999999\">RAPPORTS</a>";
$MAIN.="</FONT>\n";
$MAIN.="</FORM>\n\n";
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>INBOUND SERVICE NIVEAU REPORT</caption><tr><th class='thgraph' scope='col'>ETAT</th>";
...
$ASCII_text.="+-------------+-----------------------+-------+-------+  +-----------------------+-------+-------+\n";
$ASCII_text.="|    TIME     |  AVG HOLD TIME (sec)  | (en secondes)  |  |    CALLS HANDLED      |       |       |\n";
...
$MAIN.="\n";
$MAIN.="---------- CALL TIME HOLD RÉPARTITION EN SECONDES\n";
$MAIN.="+-------------+-------+-----------------------------------------+ +------+--------------------------------+\n";
$MAIN.="|    TIME     |       |  % OF CALLS GROUPED BY HOLD TIME (SEC)  | |   AVERAGE TIME BEFORE REPONSE (SEC)    |\n";
$MAIN.="| 15 MIN INT  | CALLS |    0   20   40   60   80  100  120 120+ | | AVG  |0   20   40   60   80  100  120 |\n";
$MAIN.="+-------------+-------+-----------------------------------------+ +------+--------------------------------+\n";

$CSV_text.="\"CALL TIME HOLD RÉPARTITION EN SECONDES\"\n";
$CSV_text.="\"TIME 15-MIN INT\",\"CALLS\",\"0 (seconds)\",\"20\",\"40\",\"60\",\"80\",\"100\",\"120\",\"120+\",\"AVG TIME BEFORE REPONSE(SEC)\"\n";
