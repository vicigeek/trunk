...
$report_name = 'Statistiche utente';
$db_source = 'M';
...
if ($did > 0)
	...
	{$MAIN.="<B> &nbsp; Statistiche utente for $user";}
...
if ($did > 0)
	...
	$MAIN.=" | <a href=\"./admin.php?ADD=3311&did_id=$did_id\">ModificareDID</a>\n";
	}
else
	{
	$MAIN.="<a href=\"./AST_agent_time_sheet.php?agent=$user\">Agent Time Sheet</a>\n";
	$MAIN.=" | <a href=\"./user_status.php?user=$user\">Status Utente</a>\n";
	$MAIN.=" | <a href=\"./admin.php?ADD=3&user=$user\">Modifica Utente</a>\n";
	$MAIN.=" | <a href=\"./AST_agent_days_detail.php?user=$user&query_date=$begin_date&end_date=$end_date&group[]=--ALL--&shift=ALL\">Utente multiple day status detail report</a>";
	}
$MAIN.="</center>\n";
...
if ($pause_code_rpt >= 1)
	...
	$MAIN.="<tr><td><font size=2>EVENT TIME</td><td align=right><font size=2>CAMPAGNA ID</td><td align=right><font size=2>Utente Group</td><td align=right><font size=2>PAUSE CODE</td><td align=right><font size=2>PAUSE LENGTH (HH:MM:SS)</td></tr>\n";

	$CSV_text11.="\"AGENT PAUSE LOGS\"\n";
	$CSV_text11.="\"\",\"EVENT TIME\",\"CAMPAGNA ID\",\"Utente Group\",\"PAUSE CODE\",\"PAUSE LENGTH (HH:MM:SS)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>AGENT TEMPO DI CHIAMATA E ESITO:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=1'>[DOWNLOAD]</a></B>\n";

		$MAIN.="<center><TABLE width=300 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>ESITO</td><td align=right><font size=2>CUENTA</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";

		$CSV_text1.="\"AGENT TEMPO DI CHIAMATA E ESITO\"\n";
		...
		$MAIN.="<tr><td><font size=2>TOTALE CHIAMATE </td><td align=right><font size=2> $total_calls</td><td align=right><font size=2> $call_hours_minutes</td></tr>\n";
		$CSV_text1.="\"\",\"TOTALE CHIAMATE\",\"$total_calls\",\"$call_hours_minutes\"\n";
		$MAIN.="</TABLE></center>\n";
		...
		$MAIN.="<B>AGENT TIEMPO LOGIN/LOGOUT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=2'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=850 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>EVENTO </td><td align=right><font size=2> DATA</td><td align=right><font size=2> CAMPAGNA</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>SESSION<BR>HOURS:MM:SS</td><td align=right><font size=2>SERVER</td><td align=right><font size=2>PHONE</td><td align=right><font size=2>COMPUTER</td><td align=right><font size=2>PHONE<BR>LOGIN</td><td align=right><font size=2>PHONE IP</td></tr>\n";

		$CSV_text2.="\"AGENT TIEMPO LOGIN/LOGOUT\"\n";
		...
		$MAIN.="<tr><td><font size=2>TOTALE</td>";
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2> </td>\n";
		...
		$MAIN.="<B>TIMECLOCK TIEMPO LOGIN/LOGOUT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=3'>[DOWNLOAD]</a></B>\n";
		...
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2><font size=2>TOTALE </td>\n";
		$MAIN.="<td align=right><font size=2> $total_login_hours_minutes  </td></tr>\n";
		...
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2> CAMPAGNA</td><td align=left><font size=2>BLEND</td><td align=left><font size=2> GROUPS</td><td align=left><font size=2> MANAGER</td></tr>\n";
		...
		if ($firstlastname_display_user_stats > 0)
			{
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> CAMPAGNA</td><td align=right><font size=2> GROUP</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> NAME</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
			}
		else
			{
		...
		while ($logs_to_print > $u) 
			...
			if ($LOGadmin_hide_phone_data != '0')
				{
				if ($DB > 0) {echo "NASCONDIPHONEDATA|$row[10]|$LOGadmin_hide_phone_data|\n";}
				$phone_temp = $row[10];
		...
		if ($allow_emails>0) 
			...
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>UTENTE</td><td align=left><font size=2> CAMPAGNA</td><td align=left><font size=2> EMAIL TO</td><td align=right><font size=2> ATTACHMENTS</td><td align=right><font size=2> LEAD</td></tr>\n";
	...
	$MAIN.="<td colspan=2><font size=2>TOTALI</td>";
	...
	$CSV_text6.="\"\",\"\",\"TOTALI\",\"$TOTALinSECONDS\",\"\",\"\",\"\",\"\",\"$TOTALagentSECONDS\"\n";


	##### vicidial agent activity records for this time period #####
	if ($did < 1)
		{
		$MAIN.="<B>ATTIVITA 'AGENTE PER QUESTO PERIODO DI TEMPO: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=7'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td colspan=2><font size=1> &nbsp; </td><td colspan=6 align=center bgcolor=white><font size=1>questi campi sono in pochi secondi </td><td colspan=4><font size=1> &nbsp; </td></tr>\n";
		...
		$CSV_text7.="\"ATTIVITA 'AGENTE PER QUESTO PERIODO DI TEMPO: (10000 record limit)\"\n";
		...
		$CSV_text7.="\"\",\"\",\"TOTALI\",\"$TOTALpauseSECONDS\",\"$TOTALwaitSECONDS\",\"$TOTALtalkSECONDS\",\"$TOTALdispoSECONDS\",\"$TOTALdeadSECONDS\",\"$TOTALcustomerSECONDS\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>PIOMBO RICERCHE PER QUESTO PERIODO DI TEMPO: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=10'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		...
		$CSV_text10.="\"PIOMBO RICERCHE PER QUESTO PERIODO DI TEMPO: (10000 record limit)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=1># </td><td NOWRAP><font size=2>DATE/TIME &nbsp; </td><td align=right NOWRAP><font size=2> LEAD ID &nbsp; </td><td align=right NOWRAP><font size=2> STATUS &nbsp; </td><td align=right NOWRAP><font size=2> COUNT &nbsp; </td><td align=right NOWRAP><font size=2> CAMPAGNA</td></tr>\n";
...
$MAIN.="<font size=0>\n\n\n<br><br><br>\nTempo Esecuzione Script: $RUNtime seconds|$db_source</font>";
