...
$select_list .= "<a href=\"#\" onclick=\"hideDiv(\'campaign_select_list\');\">Chiudi pannello</a><BR><BR>";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right>";
	$select_list .= "Mostra statistiche Presets:  </TD><TD align=left><SELECT SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value=\"0\"";
...
$select_list .= "<INPUT type=button VALUE=INVIA onclick=\"update_variables(\'form_submit\',\'\');\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; ";
$select_list .= "</TD></TR>";
...
$open_list = "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#D9E6FE\"><TR><TD ALIGN=CENTER><a href=\"#\" onclick=\"showDiv(\'campaign_select_list\');\"><font size=2>Scegli Opzioni di visualizzazione Relazione</a></TD></TR></TABLE>";
...
if (strlen($monitor_phone)>1)
	...
	if ($Mph_ct > 0)
		...
		#	echo "<!-- debug: $webphone_dialpad|$webphone_dialpad_override|$monitor_phone|$extension -->";
			...
			if ($webphone_auto_answer == 'Y') {$webphone_options .= "--AUTORISPOSTA_Y";}
			if ($webphone_auto_answer == 'N') {$webphone_options .= "--AUTORISPOSTA_N";}
...
function update_variables(task_option,task_choice,force_reload)
	...
	if (task_option == 'UGdisplay')
		{
		if (UGdisplay == '1') {UGdisplay='0';   document.getElementById("UGdisplayTXT").innerHTML = 'MOSTRA GRUPPI UTENTI';}
		else {UGdisplay='1';   document.getElementById("UGdisplayTXT").innerHTML = 'NASCONDI GRUPPI UTENTI';}
		}
	if (task_option == 'SERVdisplay')
		{
		if (SERVdisplay == '1') {SERVdisplay='0';   document.getElementById("SERVdisplayTXT").innerHTML = 'MOSTRA INFO SERVER';}
		else {SERVdisplay='1';   document.getElementById("SERVdisplayTXT").innerHTML = 'NASCONDI INFO SERVER';}
		}
	if (task_option == 'CALLSdisplay')
		{
		if (CALLSdisplay == '1') {CALLSdisplay='0';   document.getElementById("CALLSdisplayTXT").innerHTML = 'MOSTRA WAITING CALLS';}
		else {CALLSdisplay='1';   document.getElementById("CALLSdisplayTXT").innerHTML = 'NASCONDI WAITING CALLS';}
		}
	if (task_option == 'PHONEdisplay')
		{
		if (PHONEdisplay == '1') {PHONEdisplay='0';   document.getElementById("PHONEdisplayTXT").innerHTML = 'MOSTRA PHONES';}
		else {PHONEdisplay='1';   document.getElementById("PHONEdisplayTXT").innerHTML = 'NASCONDI PHONES';}
		}
	if (task_option == 'CUSTPHONEdisplay')
		{
		if (CUSTPHONEdisplay == '1') {CUSTPHONEdisplay='0';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = 'MOSTRA CUSTPHONES';}
		else {CUSTPHONEdisplay='1';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = 'NASCONDI CUSTPHONES';}
		}
	if (task_option == 'ALLINGROUPstats')
		{
		if (ALLINGROUPstats == '1') {ALLINGROUPstats='0';   document.getElementById("ALLINGROUPstatsTXT").innerHTML = 'MOSTRA IN-GROUP STATS';}
		else {ALLINGROUPstats='1';   document.getElementById("ALLINGROUPstatsTXT").innerHTML = 'NASCONDI IN-GROUP STATS';}
		}
...
echo "<a href=\"#\" onclick=\"showDiv('campaign_select_list');\">Scegli Opzioni di visualizzazione Relazione</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
...
echo " &nbsp; &nbsp; &nbsp; rinfrescare: <span id=refresh_countdown name=refresh_countdown></span>\n\n";
...
if ($UGdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>NASCONDI GRUPPI UTENTI</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>MOSTRA GRUPPI UTENTI</span></font></a>";}
if ($SERVdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>NASCONDI INFO SERVER</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>MOSTRA INFO SERVER</span></font></a>";}
if ($CALLSdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CALLSdisplay','');\"><font size=1><span id=CALLSdisplayTXT>NASCONDI WAITING CALLS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CALLSdisplay','');\"><font size=1><span id=CALLSdisplayTXT>MOSTRA WAITING CALLS</span></font></a>";}
if ($ALLINGROUPstats>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('ALLINGROUPstats','');\"><font size=1><span id=ALLINGROUPstatsTXT>NASCONDI IN-GROUP STATS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('ALLINGROUPstats','');\"><font size=1><span id=ALLINGROUPstatsTXT>MOSTRA IN-GROUP STATS</span></font></a>";}
if ($PHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('PHONEdisplay','');\"><font size=1><span id=PHONEdisplayTXT>NASCONDI PHONES</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('PHONEdisplay','');\"><font size=1><span id=PHONEdisplayTXT>MOSTRA PHONES</span></font></a>";}
if ($CUSTPHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><font size=1><span id=CUSTPHONEdisplayTXT>NASCONDI CUSTPHONES</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><font size=1><span id=CUSTPHONEdisplayTXT>MOSTRA CUSTPHONES</span></font></a>";}
