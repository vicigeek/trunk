...
{
echo "\n\n";
echo "SELECCIONE POR FAVOR UN NÚMERO Y FECHA ARRIBA Y CLICK CLICK EN REMITIR\n";
}
...
echo "Llamadas totales que llegaron a este número:       $TOTALcalls\n";
...
if ($output == 'FULL')
	...
	echo "GRÁFICO EN INCREMENTOS DE 15 MIN DEL TOTAL DE LAS LLAMADAS\n";
