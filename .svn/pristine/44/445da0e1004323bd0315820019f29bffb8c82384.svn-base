...
$MAIN.="<b>"._QXZ("$report_name")."</b> $NWB#erlang_report$NWE\n";

#$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 BORDER=1><TR BGCOLOR=\"#".$SSframe_background."\"><TD VALIGN=TOP> <b>"._QXZ("Dates").":</b><BR>";
...
$MAIN.="</TD>\n";
$MAIN.="<TD VALIGN=TOP><b>"._QXZ("Erlang type").":</b><BR>";
...
$MAIN.="<INPUT TYPE=submit NAME='SUBMIT' VALUE='"._QXZ("SUBMIT")."'><BR><BR><FONT FACE=\"Arial,Helvetica\" size=2><a href=\"./AST_inbound_forecasting.php\">"._QXZ("Basic Forecasting Report")."</a></FONT><BR><BR><FONT FACE=\"Arial,Helvetica\" size=2><a href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&drop_percent=$drop_percent&actual_agents=$actual_agents&hourly_pay=$hourly_pay&revenue_per_sale=$revenue_per_sale&sale_chance=$sale_chance&retry_rate=$retry_rate$campaignQS$groupQS&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a></FONT> | <FONT FACE=\"Arial,Helvetica\" size=2><a href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a></FONT> | <FONT FACE=\"Arial,Helvetica\" size=2><a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></FONT></TD></TR></TABLE>\n";
