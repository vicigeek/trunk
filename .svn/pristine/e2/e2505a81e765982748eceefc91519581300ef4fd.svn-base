...
//	echo $stmt="SELECT conf_exten,server_ip,extension from vicidial_conferences order by conf_exten";
    ...
    echo "<td><font size=1 color=white align=left><B>Kampagnen-ID</B></td>";
    echo "<td><font size=1 color=white><B>CAMPAIGN NAME</B></td>";
    echo "<td><font size=1 color=white><B>QC STATUSES</B></td>";
    echo "<td align=center><font size=1 color=white><B>ÄNDERN Sie</B></td></tr>\n";
    ...
    while ($vicidialconf_to_print > $o) {
        ...
        echo "<td align=center><font size=1><a href=\"$PHP_SELF?ADD=31&campaign_id=$row[0]\">ÄNDERN Sie</a></td></tr>\n";
        $o++;
    }
...
if (($ADD==881) && ($qc_auth=='1')) {
    ...
    echo "<br>$campaign_id - {$row[1]} - Qualitätskontrolle Queue<br>QC statuses: $qc_status_list\n";
