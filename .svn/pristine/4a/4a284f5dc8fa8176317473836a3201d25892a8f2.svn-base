...
$report_name = 'Inbound Résumé Hourly Report';
$db_source = 'M';
...
if ($bareformat < 1)
	...
	$MAIN.="<a href=\"$PHP_SELF?DB=$DB&inbound_rate=$inbound_rate&outbound_rate=$outbound_rate$groupQS&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date&exclude_rollover=$exclude_rollover&VALIDER=$VALIDER&shift=$shift&file_download=1\">TÉLÉCHARGER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=3111&group_id=$group[0]\">MODIFIER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=999999\">RAPPORTS</a>";
	$MAIN.="</FONT>\n";
	$MAIN.="<BR> &nbsp; Afficher as:&nbsp;";
...
if ($groups_to_print < 1)
	...
	$MAIN .= "Inbound Résumé Hourly Report: $group_string          $NOW_TIME\n";
	$CSV_main.="Inbound Résumé Hourly Report:,$NOW_TIME\n";
	...
	if ($group_ct > 0)
		...
		$ASCII_text .= "| IN-GROUP                                 | CALLS  | REPONSE | TALK      | TALK    | TIME      | TIME    | TIME    | CALLS  |\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+-----------+---------+-----------+---------+---------+--------+\n";

		$CSV_main.="\"MULTI-GROUP BREAKDOWN:\"\n";
		$CSV_main.="\"IN-GROUP\",\"TOTAL DES APPELS\",\"TOTAL REPONSE\",\" TOTAL TALK\",\" AVERAGE TALK\",\" TOTAL QUEUE TIME\",\" AVERAGE QUEUE TIME\",\" MAXIMUM QUEUE TIME\",\" TOTAL ABANDON CALLS\"\n";
		$CSV_subreports="";
		...
		$GRAPH.="<tr><th width='12%' class='grey_graph_cell' id='multigroup_graph1'><a href='#' onClick=\"DrawGraph('CALLS', '1'); return false;\">TOTAL DES APPELS</a></th><th width='12%' class='grey_graph_cell' id='multigroup_graph2'><a href='#' onClick=\"DrawGraph('REPONSE', '2'); return false;\">TOTAL REPONSE</a></th><th width='12%' class='grey_graph_cell' id='multigroup_graph3'><a href='#' onClick=\"DrawGraph('TALK', '3'); return false;\">TOTAL TALK</a></th><th width='12%' class='grey_graph_cell' id='multigroup_graph4'><a href='#' onClick=\"DrawGraph('AVGTALK', '4'); return false;\">AVERAGE TALK</a></th><th width='13%' class='grey_graph_cell' id='multigroup_graph5'><a href='#' onClick=\"DrawGraph('QUEUE', '5'); return false;\">TOTAL QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='multigroup_graph6'><a href='#' onClick=\"DrawGraph('AVGQUEUE', '6'); return false;\">AVERAGE QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='multigroup_graph7'><a href='#' onClick=\"DrawGraph('MAXQUEUE', '7'); return false;\">MAXIMUM QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='multigroup_graph8'><a href='#' onClick=\"DrawGraph('TOTALABANDONS', '8'); return false;\">TOTAL ABANDON CALLS</a></th></tr>";
		$GRAPH.="<tr><td colspan='8' class='graph_span_cell'><span id='multigroup_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
		$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>INBOUND SERVICE NIVEAU REPORT</caption><tr><th class='thgraph' scope='col'>IN-GROUP</th>";
		$CALLS_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL DES APPELS</th></tr>";
		$REPONSE_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL REPONSE </th></tr>";
		...
		while($i < $group_ct)
			...
			$gREPONSEcalls =	sprintf("%6s", $answer_count[$i]);
			...
			$ASCII_text .= "| $groupDISPLAY | $gTOTALcalls | $gREPONSEcalls | $gSUMtalk | $gAVGtalk | $gSUMqueue | $gAVGqueue | $gMAXqueue | $gDROPcalls |";
			$CSV_main.="\"$groupDISPLAY\",\"$gTOTALcalls\",\"$gREPONSEcalls\",\"$gSUMtalk\",\"$gAVGtalk\",\"$gSUMqueue\",\"$gAVGqueue\",\"$gMAXqueue\",\"$gDROPcalls\"\n";
			...
			$SUBoutput .= "| HOUR | CALLS  | REPONSE | TALK      | TALK    | TIME      | TIME    | TIME    | CALLS  |\n";
			$SUBoutput .= "+------+--------+--------+-----------+---------+-----------+---------+---------+--------+\n";

			$CSV_subreports.="\n\n\"$group[$i] - $group_name[$i]\"\n\"HOURLY BREAKDOWN:\"\n";
			$CSV_subreports.="\"HOUR\",\"TOTAL DES APPELS\",\"TOTAL REPONSE\",\" TOTAL TALK\",\" AVERAGE TALK\",\" TOTAL QUEUE TIME\",\" AVERAGE QUEUE TIME\",\" MAXIMUM QUEUE TIME\",\" TOTAL ABANDON CALLS\"\n";
			...
			$sub_GRAPH.="<tr><th width='12%' class='grey_graph_cell' id='".$group[$i]."_graph1'><a href='#' onClick=\"Draw".$group[$i]."Graph('CALLS', '1'); return false;\">TOTAL DES APPELS</a></th><th width='12%' class='grey_graph_cell' id='".$group[$i]."_graph2'><a href='#' onClick=\"Draw".$group[$i]."Graph('REPONSE', '2'); return false;\">TOTAL REPONSE</a></th><th width='12%' class='grey_graph_cell' id='".$group[$i]."_graph3'><a href='#' onClick=\"Draw".$group[$i]."Graph('TALK', '3'); return false;\">TOTAL TALK</a></th><th width='12%' class='grey_graph_cell' id='".$group[$i]."_graph4'><a href='#' onClick=\"Draw".$group[$i]."Graph('AVGTALK', '4'); return false;\">AVERAGE TALK</a></th><th width='13%' class='grey_graph_cell' id='".$group[$i]."_graph5'><a href='#' onClick=\"Draw".$group[$i]."Graph('QUEUE', '5'); return false;\">TOTAL QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='".$group[$i]."_graph6'><a href='#' onClick=\"Draw".$group[$i]."Graph('AVGQUEUE', '6'); return false;\">AVERAGE QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='".$group[$i]."_graph7'><a href='#' onClick=\"Draw".$group[$i]."Graph('MAXQUEUE', '7'); return false;\">MAXIMUM QUEUE TIME</a></th><th width='13%' class='grey_graph_cell' id='".$group[$i]."_graph8'><a href='#' onClick=\"Draw".$group[$i]."Graph('TOTALABANDONS', '8'); return false;\">TOTAL ABANDON CALLS</a></th></tr>";
			...
			$sub_CALLS_graph=$sub_graph_header."<th class='thgraph' scope='col'>TOTAL DES APPELS</th></tr>";
			$sub_REPONSE_graph=$sub_graph_header."<th class='thgraph' scope='col'>TOTAL REPONSE </th></tr>";
			...
			while ($h < 24)
				...
				if ($Hcalltime[$h] > 0)
					...
					$hREPONSEcalls =	sprintf("%6s", $Hanswer_count[$h]);
					...
					$SUBoutput .= "| $hPRINT   | $hTOTALcalls | $hREPONSEcalls | $hSUMtalk | $hAVGtalk | $hSUMqueue | $hAVGqueue | $hMAXqueue | $hDROPcalls |\n";
					$CSV_subreports.="\"$hPRINT\",\"$hTOTALcalls\",\"$hREPONSEcalls\",\"$hSUMtalk\",\"$hAVGtalk\",\"$hSUMqueue\",\"$hAVGqueue\",\"$hMAXqueue\",\"$hDROPcalls\"\n";
			...
			for ($q=0; $q<count($sub_graph_stats); $q++) {
				...
				$sub_REPONSE_graph.="  <tr><td class='chart_td$class'>".$sub_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$sub_graph_stats[$q][2], $sub_max_answer))."' height='16' />".$sub_graph_stats[$q][2]."</td></tr>";
			...
			$sub_REPONSE_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($hTOTanswer_count)."</th></tr></table>";
			...
			$JS_text.="	var REPONSE_graph=\"$sub_REPONSE_graph\";\n";
...
#			$SUBoutput.=$sub_GRAPH;
		...
		for ($q=0; $q<count($graph_stats); $q++) {
			...
			$REPONSE_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$graph_stats[$q][2], $max_answer))."' height='16' />".$graph_stats[$q][2]."</td></tr>";
		...
		$REPONSE_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($gTOTanswer_count)."</th></tr></table>";
		...
		$JS_text.="	var REPONSE_graph=\"$REPONSE_graph\";\n";
