...
$select_list .= "<a href=\"#\" onclick=\"hideDiv(\'campaign_select_list\');\">Fechar Painel</a><BR><BR>";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right>";
	$select_list .= "Mostrar Estatísticas Presets:  </TD><TD align=left><SELECT SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value=\"0\"";
...
$select_list .= "<INPUT type=button VALUE=ENVIAR onclick=\"update_variables(\'form_submit\',\'\');\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; ";
$select_list .= "</TD></TR>";
...
$open_list = "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#D9E6FE\"><TR><TD ALIGN=CENTER><a href=\"#\" onclick=\"showDiv(\'campaign_select_list\');\"><font size=2>Escolher Opções do Relat.</a></TD></TR></TABLE>";
...
if (strlen($monitor_phone)>1)
	...
	if ($Mph_ct > 0)
		...
		#	echo "<!-- debug: $webphone_dialpad|$webphone_dialpad_override|$monitor_phone|$extension -->";
			...
			if ($webphone_auto_answer == 'Y') {$webphone_options .= "--AUTORESPOSTA_Y";}
			if ($webphone_auto_answer == 'N') {$webphone_options .= "--AUTORESPOSTA_N";}
...
function update_variables(task_option,task_choice,force_reload)
	...
	if (task_option == 'UGdisplay')
		{
		if (UGdisplay == '1') {UGdisplay='0';   document.getElementById("UGdisplayTXT").innerHTML = 'VIEW GRUPO DE USUÁRIOS';}
		else {UGdisplay='1';   document.getElementById("UGdisplayTXT").innerHTML = 'ESCONDER GRUPO DE USUÁRIOS';}
		}
	if (task_option == 'SERVdisplay')
		...
		else {SERVdisplay='1';   document.getElementById("SERVdisplayTXT").innerHTML = 'ESCONDER SERVIDOR INFO';}
		}
	if (task_option == 'CALLSdisplay')
		...
		else {CALLSdisplay='1';   document.getElementById("CALLSdisplayTXT").innerHTML = 'ESCONDER WAITING CALLS';}
		}
	if (task_option == 'PHONEdisplay')
		...
		else {PHONEdisplay='1';   document.getElementById("PHONEdisplayTXT").innerHTML = 'ESCONDER PHONES';}
		}
	if (task_option == 'CUSTPHONEdisplay')
		...
		else {CUSTPHONEdisplay='1';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = 'ESCONDER CUSTPHONES';}
		}
	if (task_option == 'ALLINGROUPstats')
		...
		else {ALLINGROUPstats='1';   document.getElementById("ALLINGROUPstatsTXT").innerHTML = 'ESCONDER IN-GROUP STATS';}
		}
...
echo "<a href=\"#\" onclick=\"showDiv('campaign_select_list');\">Escolher Opções do Relat.</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
...
echo " &nbsp; ";
echo "</span>\n";
echo "<a href=\"#\" onclick=\"update_variables('form_submit','','YES')\">RELOAD AGORA</a>";
...
if ($UGdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>ESCONDER GRUPO DE USUÁRIOS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>VIEW GRUPO DE USUÁRIOS</span></font></a>";}
if ($SERVdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>ESCONDER SERVIDOR INFO</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>MOSTRAR SERVIDOR INFO</span></font></a>";}
if ($CALLSdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CALLSdisplay','');\"><font size=1><span id=CALLSdisplayTXT>ESCONDER WAITING CALLS</span></font></a>";}
else
...
if ($ALLINGROUPstats>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('ALLINGROUPstats','');\"><font size=1><span id=ALLINGROUPstatsTXT>ESCONDER IN-GROUP STATS</span></font></a>";}
else
...
if ($PHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('PHONEdisplay','');\"><font size=1><span id=PHONEdisplayTXT>ESCONDER PHONES</span></font></a>";}
else
...
if ($CUSTPHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><font size=1><span id=CUSTPHONEdisplayTXT>ESCONDER CUSTPHONES</span></font></a>";}
else
