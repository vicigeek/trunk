...
$report_name = 'Listes Pass Report';
$db_source = 'M';
...
if ($use_lists > 0)
	{
	$MAIN.="</TD><TD VALIGN=TOP> Listes:<BR>";
	...
	{
	$MAIN.="</TD><TD VALIGN=TOP> Campagnes:<BR>";
	$MAIN.="<SELECT SIZE=5 NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
if (strlen($group[0]) > 1)
	{
	$MAIN.=" <a href=\"./admin.php?ADD=34&campaign_id=$group[0]\">MODIFIER</a> | \n";
	$MAIN.=" <a href=\"./admin.php?ADD=999999\">RAPPORTS</a> </FONT>\n";
	}
else
	{
...
if (strlen($group[0]) < 1)
	{
	$MAIN.="\n\n";
	$MAIN.="VEUILLEZ SELECTIONNER UNE CAMPAGNE ET UNE DATE CI-DESSUS ET CLIQUEZ SUR VALIDER\n";
	}

else
	{
	$OUToutput = '';
	$OUToutput .= "Listes Pass Report                             $NOW_TIME\n";

	$OUToutput .= "\n";

	##############################
	#########  ID DE LA LISTE BREAKDOWN STATS

	$TOTALleads = 0;

	$OUToutput .= "\n";
	$OUToutput .= "---------- ID DE LA LISTE SUMMARY     <a href=\"$PHP_SELF?DB=$DB$groupQS&VALIDER=$VALIDER&file_download=1\">TÉLÉCHARGER</a>\n";
	...
	$OUToutput .= "|  LOAD DATE | ID DE LA LISTE and NAME                         | CAMPAIGN | COUNT      | ACTIVE   |";
	...
	$CSV_text1.="\"ID DE LA LISTE SUMMARY\"\n";
	...
	$GRAPH="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"ID DE LA LISTE Summary\" class=\"horizontalgraph\">\n";
	$GRAPH.="<caption align='top'>ID DE LA LISTE SUMMARY</caption>";
	$GRAPH.="<tr>\n";
	...
	$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>ID DE LA LISTE SUMMARY</caption><tr><th class='thgraph' scope='col'>LISTS</th>";
