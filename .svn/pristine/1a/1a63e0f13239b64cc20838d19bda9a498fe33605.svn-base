...
<title>AMMINISTRAZIONE: campagna multi-Alt-Leads
<?php 
...
if ($camp_multi < 1)
	{
	echo "Questa campagna non è impostata su Auto-Alt-Dial MULTI_LEAD\n";
	exit;
	}
...
if ($action == "BLANK")
	...
	echo "<br>Multi-Lead automatica delle impostazioni di composizione Alt Forma<form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=DB value=\"$DB\">\n";
	echo "<input type=hidden name=campaign_id value=\"$campaign_id\">\n";
	echo "<input type=hidden name=action value=ALT_MULTI_INVIA>\n";
	echo "<center><TABLE width=$section_width cellspacing=3>\n";
	echo "<tr><td align=center colspan=2>\n";


	echo "<br><b>PHONE TYPES WITHIN THE LISTS FOR THIS CAMPAGNA: <a href=\"./admin.php?ADD=31&campaign_id=$campaign_id\">$campaign_id</a></b>\n";
	echo "<TABLE width=700 cellspacing=3>\n";
	echo "<tr><td>PHONE NUMBER TYPE</td><td>CHIAMATI</td><td>NON CHIAMATI</td><td>SELECTED</td><td>OLD CLASSIFICA</td><td>NEW CLASSIFICA</td></tr>\n";
	...
	echo "<tr bgcolor=\"#9BB9FB\"><td><font size=1>TOTALE</td><td colspan=3 align=center><font size=1>$lead_list[count]</td><td align=center><font size=1>$o</td></tr>\n";
	...
	echo "<tr bgcolor=#B6D3FC><td align=right>Order List Randomize: </td><td align=left><select size=1 name=lead_order_randomize><option>Y</option><option>N</option><option SELECTED>$lead_order_randomize</option></select></td></tr>\n";
	echo "<tr bgcolor=#B6D3FC><td align=right>Elenco Ordine Secondario: </td><td align=left><select size=1 name=lead_order_secondary><option>LEAD_ASCEND</option><option>LEAD_DESCEND</option><option>CALLTIME_ASCEND</option><option>CALLTIME_DESCEND</option><option SELECTED>$lead_order_secondary</option></select></td></tr>\n";
