...
if ($groups_to_print < 1)
	...
	$MAIN.="\n\n";
	if ($EMAIL=='Y')
		{$MAIN.="PLEASE SELECT AN EMAIL ACCOUNT AND DATE RANGE ABOVE AND CLICK REMITIR\n";}
	if ($DID=='Y')
		{$MAIN.="PLEASE SELECT A DID AND DATE RANGE ABOVE AND CLICK REMITIR\n";}
	else
...
if ($EMAIL=='Y') 
	{
	$MAIN.="Inbound Email Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=1\">DESCARGAR</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
else
	{
	$MAIN.="Inbound Call Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=1\">DESCARGAR</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
...
$RESPUESTAEDpercent = (MathZDC($RESPUESTAEDcalls, $TOTALcalls) * 100);
...
if ($EMAIL=='Y')
	{
	$MAIN.="Total Emails taken in to this In-Grupo:        $TOTALcalls\n";
	$MAIN.="Average Email Length for all Emails:            $average_call_seconds seconds\n";
	$MAIN.="Answered Emails:                               $RESPUESTAEDcalls  $RESPUESTAEDpercent%\n";
	$MAIN.="Average queue time for Answered Emails:        $average_answer_seconds seconds\n";
	$MAIN.="Emails taken into the IVR for this In-Grupo:   $IVRcalls\n";
	...
	$CSV_text1.="\"Answered Emails:\",\"$RESPUESTAEDcalls\",\"$RESPUESTAEDpercent%\"\n";
	...
	{
	$MAIN.="Total de llamadas tomadas en este In-Grupo:        $TOTALcalls\n";
	$MAIN.="Average Call Length for all Calls:            $average_call_seconds seconds\n";
	$MAIN.="Answered Calls:                               $RESPUESTAEDcalls  $RESPUESTAEDpercent%\n";
	$MAIN.="Average queue time for Answered Calls:        $average_answer_seconds seconds\n";
	$MAIN.="Calls taken into the IVR for this In-Grupo:   $IVRcalls\n";

	$CSV_text1.="\"Total de llamadas tomadas en este In-Grupo:\",\"$TOTALcalls\"\n";
	$CSV_text1.="\"Average Call Length for all Calls:\",\"$average_call_seconds seconds\"\n";
	$CSV_text1.="\"Answered Calls:\",\"$RESPUESTAEDcalls\",\"$RESPUESTAEDpercent%\"\n";
...
$DROP_RESPUESTAEDpercent = (MathZDC($DROPcalls, $RESPUESTAEDcalls) * 100);
$DROP_RESPUESTAEDpercent = round($DROP_RESPUESTAEDpercent, 0);

if ($EMAIL=='Y')
	{
	$MAIN.="Total DROP Emails:                             $DROPcalls  $DROPpercent%               drop/answered: $DROP_RESPUESTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Emails:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Emails:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RESPUESTAEDpercent%\"\n";
	$CSV_text1.="\"Average hold time for DROP Emails:\",\"$average_hold_seconds seconds\"\n";
	}
else
	{
	$MAIN.="Total Llamadas Caidas:                          $DROPcalls  $DROPpercent%               drop/answered: $DROP_RESPUESTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Calls:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Calls:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RESPUESTAEDpercent%\"\n";
...
if (strlen($group_SQL)>3)
	...
	if ($DID!='Y')
		...
		$PCTanswer_sec_pct_rt_stat_one = (MathZDC($answer_sec_pct_rt_stat_one, $RESPUESTAEDcalls) * 100);
		...
		$PCTanswer_sec_pct_rt_stat_two = (MathZDC($answer_sec_pct_rt_stat_two, $RESPUESTAEDcalls) * 100);
...
if ($EMAIL=='Y')
	...
	$MAIN.="GDE (Answered/Total emails taken in to this In-Group):  $RESPUESTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RESPUESTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Total emails taken in to this In-Group):\",\"$RESPUESTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RESPUESTAEDpercent%\"\n";
	}
else
	{
	$MAIN.="\n";
	$MAIN.="---------- CUSTOM INDICATORS\n";
	$MAIN.="GDE (Answered/Llamadas totales tomadas in to this In-Group):  $RESPUESTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RESPUESTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Llamadas totales tomadas in to this In-Group):\",\"$RESPUESTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RESPUESTAEDpercent%\"\n";
	}
...
if ($EMAIL=='Y')
	...
	{
	$MAIN.="Total de llamadas That entered Queue:               $QUEUEcalls  $QUEUEpercent%\n";
	...
	$CSV_text1.="\"Total de llamadas That entered Queue:\",\"$QUEUEcalls\",\"$QUEUEpercent%\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HOLD TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=2\">DESCARGAR</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="           $rpt_type_verbiage RESPUESTAED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"$rpt_type_verbiage RESPUESTAED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
if ($report_display_type=="HTML") {
	...
	$GRAPH_text.="g.render(\"CallTimeCanvas\", \"CALL RESPUESTAED TIME BREAKDOWN\");\n";
	$GRAPH_text.="</script>";
	$MAIN.=$GRAPH_text;
	}
else
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HANGUP REASON STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=3\">DESCARGAR</a>\n";
$ASCII_text.="+----------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage STATUS STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=4\">DESCARGAR</a>\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
$ASCII_text.="| STATUS | DESCRIPTION          | CATEGORÍA             | $rpt_type_verbiages     | TOTAL TIME | AVG TIME |$rpt_type_verbiages/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
...
$CSV_text4.="\"STATUS\",\"DESCRIPTION\",\"CATEGORÍA\",\"$rpt_type_verbiages\",\"TOTAL TIME\",\"AVG TIME\",\"$rpt_type_verbiages/HOUR\"\n";
...
$max_avg_time=1;
$max_callshr=1;
$graph_header="<table cellspacing='0' cellpadding='0' summary='STATUS' class='horizontalgraph'><caption align='top'>CALL STATUS STATS</caption><tr><th class='thgraph' scope='col'>ESTADO</th>";
...
$ASCII_text="\n";
$ASCII_text.="---------- CUSTOM STATUS CATEGORÍA STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=5\">DESCARGAR</a>\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";
$ASCII_text.="| CATEGORÍA             | $rpt_type_verbiages     | DESCRIPTION                    |\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";

$CSV_text5.="\n\"CUSTOM STATUS CATEGORÍA STATS\"\n";
$CSV_text5.="\"CATEGORÍA\",\"$rpt_type_verbiages\",\"DESCRIPTION\"\n";
...
if ($report_display_type=="HTML") 
	...
	$GRAPH_text="</PRE>\n";
	$GRAPH_text.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"CUSTOM STATUS CATEGORÍA STATS\" class=\"horizontalgraph\">\n";
	$GRAPH_text.="  <caption align=\"top\">CUSTOM STATUS CATEGORÍA STATS</caption>\n";
	$GRAPH_text.="  <tr>\n";
	$GRAPH_text.="	<th class=\"thgraph\" scope=\"col\">CATEGORÍA </th>\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage INITIAL QUEUE POSITION BREAKDOWN       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=6\">DESCARGAR</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- AGENTE STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=7\">DESCARGAR</a>\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
$ASCII_text.="| AGENTE                    | $rpt_type_verbiages     | TIME H:M:S |AVERAGE |\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>AGENTE STATS</caption><tr><th class='thgraph' scope='col'>AGENT</th>";
...
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
$ASCII_text.="| TOTAL Agentes: $TOTagents | $TOTcalls | $TOTtime | $TOTavg |\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$CSV_text7.="\"TOTAL Agentes: $TOTagents\",\"$TOTcalls\",\"$TOTtime\",\"$TOTavg\"\n";

##############################
#########  TIME STATS

$MAIN.="\n";
$MAIN.="---------- ESTADÍSTICAS  DE TIEMPO       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=9\">DESCARGAR</a>\n";
...
$MAIN.="\n";
$MAIN.="---------- $rpt_type_verbiage RESPUESTAED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&REMITIR=$REMITIR&file_download=8\">DESCARGAR</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"$rpt_type_verbiage RESPUESTAED TIME BREAKDOWN IN SECONDS\"\n";
