...
if ($end_call > 0)
	...
	echo "Anruf ist dispositioned gewesen &nbsp; &nbsp; &nbsp; $NOW_TIME\n<BR><BR>\n";
	...
	if ($lead_count > 0)
		...
		echo "<tr><td colspan=2>Vendor ID: $vendor_id &nbsp; &nbsp; Kampagne Identifikation: $campaign_id</td></tr>\n";
		echo "<tr><td colspan=2>Fronter: $tsr &nbsp; &nbsp; Liste Identifikation: $list_id</td></tr>\n";
		...
		echo "<tr><td colspan=2><input type=submit name=submit value=\"DISPO ANRUF\"></td></tr>\n";
		echo "</table></form>\n";
		echo "<BR><BR><BR>\n";
		}
	else
