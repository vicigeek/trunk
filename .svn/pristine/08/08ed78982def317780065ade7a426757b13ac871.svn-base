...
{
$MAIN.="\n";
$MAIN.="PLEASE SELECT AN MITTELID AND DATE-TIME ABOVE AND CLICK SUBMIT\n";
...
if ($calls_summary)
	...
	$MAIN.="GESAMTANRUFETAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[DOWNLOAD]</a>\n";
	...
	$MAIN.="----------------------------------------------------------------\n";
	$MAIN.="TOTAL ACTIVE MITTELTIME: $pfTOTAL_TIME_HMS\n\n";
	$CSV_text1.=$CSV_text_header;
	$CSV_text1.="\"\",\"GESAMTANRUFETAKEN: $row[0]\"\n";
	...
	$CSV_text1.="\"\",\"TOTAL ACTIVE MITTELTIME:\",\"$pfTOTAL_TIME_HMS\"\n\n";
	}
else
	{
...
$MAIN.="<B>TIMECLOCK LOGIN/LOGOUT ZEIT:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[DOWNLOAD]</a></B>\n";
$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2>FALL </td><td align=right><font size=2>DATUM</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>HOURS:MINUTES</td></tr>\n";

$CSV_text2.=$CSV_text_header;
$CSV_text2.=$CSV_login;
$CSV_text2.="\"TIMECLOCK LOGIN/LOGOUT ZEIT:\"\n";
