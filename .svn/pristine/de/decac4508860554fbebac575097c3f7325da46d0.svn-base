...
echo "<!-- VERSÃO: <?php echo $version ?>     BUILD: <?php echo $build ?> -->\n";
?>
...
if ($move_submit == "move" )
	...
	if (($enable_move_vendor_lead_code == "enabled") && ($move_vendor_lead_code != ''))
		...
		$move_parm = $move_parm . "&nbsp;&nbsp;&nbsp;&nbsp;código do fornecedor is like $move_vendor_lead_code<br />";
	...
	elseif ($enable_move_security_phrase == "enabled")
		{
		blank_field('Frase de Segurança',true);
		}
...
if ($update_submit == "update" )
	...
	if ($update_list == '') { missing_required_field('ID da Lista'); }
	...
	if (($enable_update_vendor_lead_code == "enabled") && ($update_vendor_lead_code != ''))
		...
		$update_parm = $update_parm . "&nbsp;&nbsp;&nbsp;&nbsp;código do fornecedor is like $update_vendor_lead_code<br />";
...
if ( ( $delete_submit == "delete" ) && ( $delete_lists > 0 ) )
	...
	if ($delete_list == '') { missing_required_field('ID da Lista'); }
	...
	if (($enable_delete_vendor_lead_code == "enabled") && ($delete_vendor_lead_code != ''))
		...
		$delete_parm = $delete_parm . "&nbsp;&nbsp;&nbsp;&nbsp;;código do fornecedor is like $delete_vendor_lead_code<br />";
...
if (
	...
	if ( preg_match("/ALL\-CAMPANHAS/i",$allowed_campaigns) )
		{
		if ($DB) { echo "|ProcesandoAll Campanhas|\n"; }
	...
	echo "<p>The following are advanced lead management tools.  They will only work on listas inativas with less than $list_lead_limit leads in them. This is to avoid data inconsistencies.</p>";
	...
	echo "</td></tr>\n";
	echo "<tr bgcolor=#B6D3FC><td align=right>AlterarDate</td></td><td align=left>\n";
	...
	echo "</td></tr>\n";
	echo "<tr bgcolor=#B6D3FC><td align=right>Frase de Segurança</td></td><td align=left>\n";
	...
	if ( $delete_lists > 0 )
		...
		echo "</table></center>\n";
		echo "<br /><center><table width=$section_width cellspacing=3>\n";
		echo "<tr bgcolor=#015B91><td colspan=2 align=center><font color=white><b>RemoverLeads</b></font></td></tr>\n";
		echo "<tr bgcolor=#B6D3FC><td align=right>List</td><td align=left>\n";
