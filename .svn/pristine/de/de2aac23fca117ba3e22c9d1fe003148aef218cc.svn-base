...
$report_name='In-Group Utente List';
...
echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFICA</a> \n";
echo "</FORM>\n\n";
...
if (!$group)
	{
	echo "\n\n";
	echo "PLEASE SELECT A IN-GROUP ABOVE AND CLICK INVIA\n";
	}

else
	{
	echo "Live Current Agenti logged in to take calls from $group - $selected_name         $NOW_TIME\n";
	...
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
	echo "| #    | UTENTE                        | CAMPAIGN             | STATUS | LAST ACTIVITY       |\n";
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
