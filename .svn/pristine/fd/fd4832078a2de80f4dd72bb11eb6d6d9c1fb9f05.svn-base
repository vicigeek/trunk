...
$HTML_text.="<INPUT TYPE=submit NAME=REMITIR VALUE=REMITIR>\n";
$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <a href=\"$PHP_SELF?query_date=$query_date&group=$group&shift=$shift&file_download=1\">DESCARGAR</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFICAR</a> | <a href=\"./admin.php?ADD=999999\">INFORMES</a><BR/></FONT>\n";
$HTML_text.="</FORM>\n\n";
...
{
$HTML_text.="\n\n";
$HTML_text.="PLEASE SELECT AN IN-GROUP AND DATE ABOVE THEN CLICK REMITIR\n";
}
...
$ASCII_text.="+--------------------------+-------+--------+--------+------+------+------+\n";
$ASCII_text.="| AGENTE                    |SUCCESS| XFERS  |SUCCESS%| SALE | DROP |OTHER |\n";
$ASCII_text.="+--------------------------+-------+--------+--------+------+------+------+\n";
...
$ASCII_text.="+--------------------------+--------+------+------+------+------+-------+\n";
$ASCII_text.="| AGENTE                    | CALLS  | SALE | DROP |OTHER | SALE | CONV %|\n";
$ASCII_text.="+--------------------------+--------+------+------+------+------+-------+\n";
