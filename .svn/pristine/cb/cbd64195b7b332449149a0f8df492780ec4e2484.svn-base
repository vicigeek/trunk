...
<title>QC ModifierLead: <?php echo "$lead_id - ".urldecode($lead_name).urldecode(" (Campagne: $campaign_id - $campaign_name)"); ?></title>
...
if ($end_call > 0) {
	...
	echo "<br>Informations modifiées<BR><BR>\n";
...
#		echo "<a href=\"$PHP_SELF\">Close this window</a>\n<BR><BR>\n";
	...
	echo "<tr><td colspan=2>Fronter: <A HREF=\"user_stats.php?user=$tsr\">$tsr</A> &nbsp; &nbsp; ID de la liste: $list_id &nbsp; &nbsp; Called Count: $called_count</td></tr>\n";
	...
	while ($row_count > $o)
		...
		$rowx=mysqli_fetch_row($rslt);
             	echo "<tr><td align=right>$rowx[0] : </td><td align=left><hr>$rowx[1]<br><b>ID de la liste:</b> $rowx[2]; <b>ID de la campagne:</b> $rowx[3]<br>$rowx[4]</td></tr>\n";
		$o++;
		}
