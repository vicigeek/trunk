...
$report_name='Usuario Estadisticas x hora de Grupo';
...
<title>ADMINISTRATION: Estadisticas x hora de Grupo
<?php
...
<CENTER>
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; Estadisticas x hora de Grupo <?php echo $group ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; </TD></TR>
...
echo "<B>CONTADOR DE HORAS DE TSR: <a href=\"./admin.php?ADD=3111&group_id=$group\">$group</a> | $status | $date_with_hour | $date_no_hour</B>\n";
...
echo "<tr><td><font size=2>TSR </td><td align=left><font size=2>ID </td><td align=right><font size=2> &nbsp; $status</td><td align=right><font size=2> &nbsp; LLAMADAS TOTALES</td><td align=right><font size=2> &nbsp; $status DAY</td><td align=right><font size=2> &nbsp; &nbsp; </td></tr>\n";
	...
	while($o < $tsrs_to_print)
		...
		echo "<td align=right><font size=1><a href=\"./admin.php?ADD=3&user=$VDuser[$o]\">MODIFICAR</a> | <a href=\"./user_stats.php?user=$VDuser[$o]\">ESTADÍSTICAS</a></td></tr>\n";
...
echo "<br>Inscriba por favor a grupo que usted desea que genere estadisticas cada hora: <form action=$PHP_SELF method=GET>\n";
...
echo "<input type=submit name=submit value=REMITIR>\n";
echo "<BR><BR><BR>\n";
