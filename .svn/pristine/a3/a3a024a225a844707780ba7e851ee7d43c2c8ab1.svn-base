...
if ($action == "CALLCARD_DETAIL")
	...
	if ($details_to_print > 0) 
		...
		echo "<br>CallCard Λεπτομέρειες<form action=$PHP_SELF method=POST>\n";
		...
		echo "<tr bgcolor=#B6D3FC><td align=right>Κατάσταση:</td><td align=left><B>$status</B></td></tr>\n";
		...
		echo "<tr bgcolor=#B6D3FC><td align=right>In-Ομάδα:</td><td align=left><B>$inbound_group_id</B></td></tr>\n";
		...
		echo "<tr bgcolor=#B6D3FC><td align=right>Σχόλια: </td><td align=left><B>$note_comments</B></td></tr>\n";
		echo "<tr bgcolor=#B6D3FC><td align=right>Create Χρήστης/Date: </td><td align=left><B>$create_user / $create_time</B></td></tr>\n";
		echo "<tr bgcolor=#B6D3FC><td align=right>Activate Χρήστης/Date: </td><td align=left><B>$activate_user / $activate_time</B></td></tr>\n";
		echo "<tr bgcolor=#B6D3FC><td align=right>Used Χρήστης/Date: </td><td align=left><B>$used_user / $used_time</B></td></tr>\n";
		echo "<tr bgcolor=#B6D3FC><td align=right>Void Χρήστης/Date: </td><td align=left><B>$void_user / $void_time</B></td></tr>\n";
		echo "</TABLE>\n";
		echo "<BR><BR><BR>\n";
		...
		echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=2 color=white>ΧΕΙΡΙΣΤΗΣΗΜΕΡΑ</B></TD>";
		echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=2 color=white>ΧΕΙΡΙΣΤΗΣDISPO</B></TD>";
		echo "</TR>\n";
...
if ($action == "CALLCARD_SUMMARY")
	...
	echo "<TR BGCOLOR=BLACK>";
	echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=1 color=white>ΚΑΤΑΣΤΑΣΗ</B></TD>";
	echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=1 color=white>ΚΑΤΑΜΕΤΡΗΣΗ</B></TD>";
	echo "</TR>\n";
...
if ($action == "GENERATE")
	...
	echo "<tr bgcolor=#B6D3FC><td align=right>In-Ομάδα:</td><td align=left><input type=text name=inbound_group_id size=20 maxlength=20></td></tr>\n";
...
<BR><font size=1>CallCard &nbsp; &nbsp; ΕΚΔΟΣΗ: <?php echo $version ?> &nbsp; &nbsp; ΔΗΜΙΟΥΡΓΙΑ: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</TD></TR></TABLE>
