...
$report_name = 'Statistiques utilisateur';
$db_source = 'M';
...
if ($did > 0)
	...
	{$MAIN.="<B> &nbsp; Statistiques utilisateur for $user";}
...
if ($did > 0)
	...
	$MAIN.=" | <a href=\"./admin.php?ADD=3311&did_id=$did_id\">ModifierDID</a>\n";
	}
else
	{
	$MAIN.="<a href=\"./AST_agent_time_sheet.php?agent=$user\">Agent Feuille de temps</a>\n";
	$MAIN.=" | <a href=\"./user_status.php?user=$user\">Utilisateur Status</a>\n";
	$MAIN.=" | <a href=\"./admin.php?ADD=3&user=$user\">Modifier un utilisateur</a>\n";
	$MAIN.=" | <a href=\"./AST_agent_days_detail.php?user=$user&query_date=$begin_date&end_date=$end_date&group[]=--ALL--&shift=ALL\">Utilisateur multiple day status detail report</a>";
	}
$MAIN.="</center>\n";
...
if ($pause_code_rpt >= 1)
	...
	$MAIN.="<B>AGENT PAUSE LOGS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=11'>[TÉLÉCHARGER]</a></B>\n";

	$MAIN.="<center><TABLE width=600 cellspacing=0 cellpadding=1>\n";
	$MAIN.="<tr><td><font size=2>EVENT TIME</td><td align=right><font size=2>CAMPAIGN ID</td><td align=right><font size=2>GROUPE D'UTILISATEURS</td><td align=right><font size=2>PAUSE CODE</td><td align=right><font size=2>PAUSE LENGTH (HH:MM:SS)</td></tr>\n";

	$CSV_text11.="\"AGENT PAUSE LOGS\"\n";
	$CSV_text11.="\"\",\"EVENT TIME\",\"CAMPAIGN ID\",\"GROUPE D'UTILISATEURS\",\"PAUSE CODE\",\"PAUSE LENGTH (HH:MM:SS)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>AGENT TEMPS DE CONVERSATION ET ETAT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=1'>[TÉLÉCHARGER]</a></B>\n";

		$MAIN.="<center><TABLE width=300 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>ETAT</td><td align=right><font size=2>NOMBRE</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";

		$CSV_text1.="\"AGENT TEMPS DE CONVERSATION ET ETAT\"\n";
		...
		$MAIN.="<tr><td><font size=2>TOTAL DES APPELS</td><td align=right><font size=2> $total_calls</td><td align=right><font size=2> $call_hours_minutes</td></tr>\n";
		$CSV_text1.="\"\",\"TOTAL DES APPELS\",\"$total_calls\",\"$call_hours_minutes\"\n";
		$MAIN.="</TABLE></center>\n";


		##### Login and Déconnection time from vicidial agent interface #####

		$MAIN.="<br><br>\n";

		$MAIN.="<center>\n";

		$MAIN.="<B>AGENT HEURE DE CONNECTION/DECONNECTION:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=2'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=850 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>EVENEMENT</td><td align=right><font size=2> DATE</td><td align=right><font size=2> CAMPAGNE</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>SESSION<BR>HOURS:MM:SS</td><td align=right><font size=2>SERVER</td><td align=right><font size=2>PHONE</td><td align=right><font size=2>COMPUTER</td><td align=right><font size=2>PHONE<BR>LOGIN</td><td align=right><font size=2>PHONE IP</td></tr>\n";

		$CSV_text2.="\"AGENT HEURE DE CONNECTION/DECONNECTION\"\n";
		...
		$MAIN.="<B>TIMECLOCK HEURE DE CONNECTION/DECONNECTION:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=3'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2>EVENEMENT</td><td align=right><font size=2> DATE</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";
		$CSV_text3.="\"TIMECLOCK HEURE DE CONNECTION/DECONNECTION\"\n";
		...
		$MAIN.="<B>CLOSER IN-GROUP SELECTION LOGS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=4'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=670 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2> CAMPAGNE</td><td align=left><font size=2>BLEND</td><td align=left><font size=2> GROUPS</td><td align=left><font size=2> MANAGER</td></tr>\n";
		...
		$MAIN.="<B>OUTBOUND CALLS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=5'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=700 cellspacing=0 cellpadding=1>\n";
		if ($firstlastname_display_user_stats > 0)
			{
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> CAMPAGNE</td><td align=right><font size=2> GROUP</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> NAME</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
			}
		else
			{
		...
		while ($logs_to_print > $u) 
			...
			if ($LOGadmin_hide_phone_data != '0')
				{
				if ($DB > 0) {echo "CACHERPHONEDATA|$row[10]|$LOGadmin_hide_phone_data|\n";}
				$phone_temp = $row[10];
		...
		if ($allow_emails>0) 
			{
			$MAIN.="<B>OUTBOUND EMAILS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=5'>[TÉLÉCHARGER]</a></B>\n";
			$MAIN.="<TABLE width=670 cellspacing=0 cellpadding=3>\n";
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>USER</td><td align=left><font size=2> CAMPAGNE</td><td align=left><font size=2> EMAIL TO</td><td align=right><font size=2> ATTACHMENTS</td><td align=right><font size=2> LEAD</td></tr>\n";
	...
	$MAIN.="<B>INBOUND/CLOSER CALLS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=6'>[TÉLÉCHARGER]</a></B>\n";
	...
	if ($did < 1)
		{
		$MAIN.="<B>Activité de l'agent Pour cette période: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=7'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td colspan=2><font size=1> &nbsp; </td><td colspan=6 align=center bgcolor=white><font size=1>ces champs sont en quelques secondes </td><td colspan=4><font size=1> &nbsp; </td></tr>\n";
		...
		$CSV_text7.="\"Activité de l'agent Pour cette période: (10000 record limit)\"\n";
	...
	$MAIN.="<B>RECORDINGS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=8'>[TÉLÉCHARGER]</a></B>\n";
	$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>MANUAL OUTBOUND CALLS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=9'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>LEAD RECHERCHES POUR CETTE PÉRIODE: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=10'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		...
		$CSV_text10.="\"LEAD RECHERCHES POUR CETTE PÉRIODE: (10000 record limit)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>PREVIEW LEAD SKIPS FOR THIS TIME PERIOD: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=11'>[TÉLÉCHARGER]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=1># </td><td NOWRAP><font size=2>DATE/TIME &nbsp; </td><td align=right NOWRAP><font size=2> LEAD ID &nbsp; </td><td align=right NOWRAP><font size=2> STATUS &nbsp; </td><td align=right NOWRAP><font size=2> COUNT &nbsp; </td><td align=right NOWRAP><font size=2> CAMPAGNE</td></tr>\n";
