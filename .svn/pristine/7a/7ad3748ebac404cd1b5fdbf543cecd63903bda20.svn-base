...
$report_name = 'Listes Statuts De Campagne Report';
$db_source = 'M';
...
if (strlen($group[0]) < 1)
	...
	{
	$OUToutput = '';
	$OUToutput .= "Listes Statistiques d'état de la campagne                             $NOW_TIME\n";
	...
	$OUToutput .= "\n";
	$OUToutput .= "\n";
	$OUToutput .= "---------- STATUS FLAGS SUMMARY:    (and % of leads in selected lists)     <a href=\"$PHP_SELF?DB=$DB$groupQS&VALIDER=$VALIDER&file_download=2\">TÉLÉCHARGER</a>\n";
	$OUToutput .= "+------------------+------------+----------+\n";
	$OUToutput .= "| Réponse de l'homme     | $HA_count |  $HA_percent% |\n";
	...
	$CSV_text2 .= "\"Réponse de l'homme\",\"$HA_count\",\"$HA_percent%\"\n";
	...
	$GRAPH.="  <tr>\n";
	$GRAPH.="	<td class=\"chart_td first\">Réponse de l'homme</td>\n";
	...
	##############################
	#########  STATUS CATÉGORIE STATS

	$OUToutput .= "\n";
	$OUToutput .= "---------- CUSTOM STATUS CATÉGORIE STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&VALIDER=$VALIDER&file_download=3\">TÉLÉCHARGER</a>\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";
	$OUToutput .= "| CATÉGORIE             | CALLS      | DESCRIPTION                    |\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";

	$CSV_text3.="\"CUSTOM STATUS CATÉGORIE STATS\"\n";
	$CSV_text3.="\"CATÉGORIE\",\"CALLS\",\"DESCRIPTION\"\n";

	$max_calls=1; $graph_stats=array();
	$GRAPH.="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"DID Summary\" class=\"horizontalgraph\">\n";
	$GRAPH.="<caption align='top'>CUSTOM STATUS CATÉGORIE STATS</caption>";
	$GRAPH.="<tr>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">CATÉGORIE</th>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">CALLS</th>\n";
	$GRAPH.="</tr>\n";
	...
	$TOTALleads = 0;
	$OUToutput .= "\n";
	$OUToutput .= "---------- PER LIST DETAIL STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&VALIDER=$VALIDER&file_download=4\">TÉLÉCHARGER</a>\n";
	$OUToutput .= "\n";
	...
	while ($i < $listids_to_print)
		...
		$STATUS_graph=$graph_header."<tr><th class='thgraph' scope='col'>ETAT</th><th class='thgraph' scope='col'>NOMBRE</th></tr>";

		$CSV_text4.="\"ID DE LA LISTE: $LISTIDlists[$i]\",\"$LISTIDlist_names[$i]\",\"$LISTIDlist_active[$i]\"\n";
		...
		$FLAGS_graph.="  <tr><td class='chart_td first'>RÉPONSE HUMAINE</td><td nowrap class='chart_td value first'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$HA_count, $max_flags))."' height='16' />$HA_count ($HA_percent%)</td></tr>";
		...
		$CSV_text4.="\"Réponse de l'homme:\",\"$HA_count\",\"$HA_percent%\"\n";
		...
		$CSV_text4.="\"Rappels de service programmés:\",\"$SC_count\",\"$SC_percent%\"\n\n";
