...
echo "Πράκτορες Time On Calls           $NOW_TIME    <a href=\"$PHP_SELF?server_ip=$server_ip&DB=$DB&reset_counter=$reset_counter&closer_display=$closer_display_reverse\">$closer_reverse_link</a> | <a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a>\n\n";
...
$talking_to_print = mysqli_num_rows($rslt);
	...
	#	echo "  <SPAN class=\"purple\"><B>          </SPAN> - Πάνω από 10 λεπτά σε κλήση</B>\n";
		...
		echo "  <SPAN class=\"yellow\"><B>          </SPAN> - Χειριστές σε παύση</B>\n";
		echo "  <SPAN class=\"blue\"><B>          </SPAN> - 5 λεπτά ή παραπάνω σε κλήση</B>\n";
		echo "  <SPAN class=\"purple\"><B>          </SPAN> - Πάνω από 10 λεπτά σε κλήση</B>\n";
		}
