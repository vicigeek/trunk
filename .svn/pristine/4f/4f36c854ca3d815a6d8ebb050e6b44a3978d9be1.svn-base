...
if (!$group)
	...
	$ASCII_text="---------- PERFORMANCE Détails -------------\n";

	$HTML_text.="Agent Performance Comparison                        $NOW_TIME\n";
	$HTML_text.="Starting date: $query_date                         <a href=\"$LINKbase&stage=$stage&file_download=1\">[TÉLÉCHARGER]</a>\n\n";
	...
	for ($q=0; $q<count($rpt_date_array); $q++) 
		...
		$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>$rpt_subtitle SUMMARY</caption><tr><th class='thgraph' scope='col'>UTILISATEURS</th>";
