...
<?php
echo "<title>OPERATORI REMOTI: $LOGfullname - $PHP_AUTH_USER   ";
...
if ($ADD==71111)
	...
	if ( (strlen($server_ip) < 2) or (strlen($user) < 2) )
		...
		echo "Stats de entrada del agente alejado                               $NOW_TIME\n\n";
		echo "\n";
