...
{
$MAIN.="\n";
$MAIN.="PLEASE SELECT AN ΧΕΙΡΙΣΤΗΣID AND DATE-TIME ABOVE AND CLICK ΕΠΙΒΕΒΑΙΩΣΗ\n";
...
$MAIN.="AgentΏρα Φύλλο                            $NOW_TIME\n";

$MAIN.="Time range: $query_date_BEGIN to $query_date_END\n\n";
$MAIN.="---------- ΧΕΙΡΙΣΤΗΣTIME SHEET: $agent - $full_name -------------\n\n";

$CSV_text_header.="\"AgentΏρα Φύλλο- $NOW_TIME\"\n";
$CSV_text_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n";
$CSV_text_header.="\"ΧΕΙΡΙΣΤΗΣTIME SHEET: $agent - $full_name\"\n\n";
...
if ($calls_summary)
	...
	$MAIN.="ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣTAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[ΛΗΨΗ]</a>\n";
	...
	$MAIN.="----------------------------------------------------------------\n";
	$MAIN.="TOTAL ACTIVE ΧΕΙΡΙΣΤΗΣTIME: $pfTOTAL_TIME_HMS\n\n";
	$CSV_text1.=$CSV_text_header;
	$CSV_text1.="\"\",\"ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣTAKEN: $row[0]\"\n";
	...
	$CSV_text1.="\"\",\"TOTAL ACTIVE ΧΕΙΡΙΣΤΗΣTIME:\",\"$pfTOTAL_TIME_HMS\"\n\n";
	}
else
	{
...
$MAIN.="<B>TIMECLOCK  ΧΡΟΝΟΣ ΣYΝΔΕΣΗΣ/ΑΠΟΣΥΝΔΕΣΗΣ:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[ΛΗΨΗ]</a></B>\n";
$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2 >ΣΥΜΒΑΝ</td><td align=right><font size=2> ΗΜΕΡΑ</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>ΩΡΕΣ:ΛΕΠΤΑ</td></tr>\n";

$CSV_text2.=$CSV_text_header;
$CSV_text2.=$CSV_login;
$CSV_text2.="\"TIMECLOCK  ΧΡΟΝΟΣ ΣYΝΔΕΣΗΣ/ΑΠΟΣΥΝΔΕΣΗΣ:\"\n";
$CSV_text2.="\"\",\"ID\",\"EDIT\",\"EVENT\",\"DATE\",\"IP ADDRESS\",\"GROUP\",\"ΩΡΕΣ:ΛΕΠΤΑ\"\n";
