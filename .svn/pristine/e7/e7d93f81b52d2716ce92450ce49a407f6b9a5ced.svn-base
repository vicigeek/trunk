...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&DB=$DB&ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&file_download=1\">ΛΗΨΗ</a> | <a href=\"./admin.php?ADD=3311&did_id=$group[0]\">ΤΡΟΠΟΠΟΙΗΣΗ</a> | <a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a> </FONT>\n";
$MAIN.="</TD></TR></TABLE>\n";
$MAIN.="</FORM>\n";
...
if (!$group)
	...
	### ΔΗΜΙΟΥΡΓΙΑ HOUR:MIN DISPLAY ARRAY ###
	$i=0;
	$h=4;
	$j=0;
	$Zhour=1;
	...
	if (strlen($extension[0]) > 0)
		...
		while ($d < $stats_array_ct)
			...
			$GRAPH_text.="  <tr>\n";
			$GRAPH_text.="	<th class=\"thgraph\" scope=\"col\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣ:</th>\n";
