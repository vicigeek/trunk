...
$report_name='Utilisateur Statistiques du groupe par heures';
...
<title>ADMINISTRATION: Statistiques du groupe par heures
<?php
...
<CENTER>
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; Statistiques du groupe par heures <?php echo $group ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; </TD></TR>
...
echo "<br>Veuillez entrez le groupe pour lequel vous souhaitez avoir les statistiques horaires : <form action=$PHP_SELF method=GET>\n";
