...
if ($groups_to_print < 1)
	...
	$MAIN.="\n\n";
	if ($EMAIL=='Y')
		{$MAIN.="PLEASE SELECT AN EMAIL ACCOUNT AND DATE RANGE ABOVE AND CLICK INVIA\n";}
	if ($DID=='Y')
		{$MAIN.="PLEASE SELECT A DID AND DATE RANGE ABOVE AND CLICK INVIA\n";}
	else
...
if ($EMAIL=='Y') 
	{
	$MAIN.="Inbound Email Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=1\">DOWNLOAD</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
else
	{
	$MAIN.="Inbound Call Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=1\">DOWNLOAD</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
...
$MAIN.="\n";
$MAIN.="Intervallo Di Tempo: $query_date_BEGIN to $query_date_END\n\n";
$MAIN.="---------- TOTALI\n";

$CSV_text1.="\n\"Intervallo Di Tempo:\",\"$query_date_BEGIN\",\"to\",\"$query_date_END\"\n\n";
...
$RISPOSTAEDpercent = (MathZDC($RISPOSTAEDcalls, $TOTALcalls) * 100);
...
if ($EMAIL=='Y')
	{
	$MAIN.="Total Emails taken in to this In-Gruppo:        $TOTALcalls\n";
	$MAIN.="Average Email Length for all Emails:            $average_call_seconds seconds\n";
	$MAIN.="Answered Emails:                               $RISPOSTAEDcalls  $RISPOSTAEDpercent%\n";
	$MAIN.="Average queue time for Answered Emails:        $average_answer_seconds seconds\n";
	$MAIN.="Emails taken into the IVR for this In-Gruppo:   $IVRcalls\n";
	...
	$CSV_text1.="\"Answered Emails:\",\"$RISPOSTAEDcalls\",\"$RISPOSTAEDpercent%\"\n";
	...
	{
	$MAIN.="Totale chiamate a prendere in questo gruppo:        $TOTALcalls\n";
	$MAIN.="Average Call Length for all Calls:            $average_call_seconds seconds\n";
	$MAIN.="Answered Calls:                               $RISPOSTAEDcalls  $RISPOSTAEDpercent%\n";
	$MAIN.="Average queue time for Answered Calls:        $average_answer_seconds seconds\n";
	$MAIN.="Calls taken into the IVR for this In-Gruppo:   $IVRcalls\n";

	$CSV_text1.="\"Totale chiamate a prendere in questo gruppo:\",\"$TOTALcalls\"\n";
	$CSV_text1.="\"Average Call Length for all Calls:\",\"$average_call_seconds seconds\"\n";
	$CSV_text1.="\"Answered Calls:\",\"$RISPOSTAEDcalls\",\"$RISPOSTAEDpercent%\"\n";
...
$DROP_RISPOSTAEDpercent = (MathZDC($DROPcalls, $RISPOSTAEDcalls) * 100);
$DROP_RISPOSTAEDpercent = round($DROP_RISPOSTAEDpercent, 0);

if ($EMAIL=='Y')
	{
	$MAIN.="Total DROP Emails:                             $DROPcalls  $DROPpercent%               drop/answered: $DROP_RISPOSTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Emails:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Emails:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RISPOSTAEDpercent%\"\n";
	$CSV_text1.="\"Average hold time for DROP Emails:\",\"$average_hold_seconds seconds\"\n";
	}
else
	{
	$MAIN.="Totale Chiamate ABBATTUTE: $DROPcalls  $DROPpercent%               drop/answered: $DROP_RISPOSTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Calls:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Calls:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RISPOSTAEDpercent%\"\n";
...
if (strlen($group_SQL)>3)
	...
	if ($DID!='Y')
		...
		$PCTanswer_sec_pct_rt_stat_one = (MathZDC($answer_sec_pct_rt_stat_one, $RISPOSTAEDcalls) * 100);
		...
		$PCTanswer_sec_pct_rt_stat_two = (MathZDC($answer_sec_pct_rt_stat_two, $RISPOSTAEDcalls) * 100);
...
if ($EMAIL=='Y')
	...
	$MAIN.="GDE (Answered/Total emails taken in to this In-Group):  $RISPOSTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RISPOSTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Total emails taken in to this In-Group):\",\"$RISPOSTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RISPOSTAEDpercent%\"\n";
	}
else
	{
	$MAIN.="\n";
	$MAIN.="---------- CUSTOM INDICATORS\n";
	$MAIN.="GDE (Answered/Llamadas totales tomadas in to this In-Group):  $RISPOSTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RISPOSTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Llamadas totales tomadas in to this In-Group):\",\"$RISPOSTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RISPOSTAEDpercent%\"\n";
	}
...
if ($EMAIL=='Y')
	...
	{
	$MAIN.="Chiamate totali That entered Queue:               $QUEUEcalls  $QUEUEpercent%\n";
	...
	$CSV_text1.="\"Chiamate totali That entered Queue:\",\"$QUEUEcalls\",\"$QUEUEpercent%\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HOLD TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=2\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="           $rpt_type_verbiage RISPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"$rpt_type_verbiage RISPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
if ($report_display_type=="HTML") {
	...
	$GRAPH_text.="g.render(\"CallTimeCanvas\", \"CALL RISPOSTAED TIME BREAKDOWN\");\n";
	$GRAPH_text.="</script>";
	$MAIN.=$GRAPH_text;
	}
else
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HANGUP REASON STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=3\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage STATUS STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=4\">DOWNLOAD</a>\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
$ASCII_text.="| STATUS | DESCRIZIONE          | CATEGORIA             | $rpt_type_verbiages     | TOTAL TIME | AVG TIME |$rpt_type_verbiages/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
...
$CSV_text4.="\"STATUS\",\"DESCRIZIONE\",\"CATEGORIA\",\"$rpt_type_verbiages\",\"TOTAL TIME\",\"AVG TIME\",\"$rpt_type_verbiages/HOUR\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CUSTOM STATUS CATEGORIA STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=5\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";
$ASCII_text.="| CATEGORIA             | $rpt_type_verbiages     | DESCRIZIONE                    |\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";

$CSV_text5.="\n\"CUSTOM STATUS CATEGORIA STATS\"\n";
$CSV_text5.="\"CATEGORIA\",\"$rpt_type_verbiages\",\"DESCRIZIONE\"\n";
...
if ($report_display_type=="HTML") 
	...
	$GRAPH_text="</PRE>\n";
	$GRAPH_text.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"CUSTOM STATUS CATEGORIA STATS\" class=\"horizontalgraph\">\n";
	$GRAPH_text.="  <caption align=\"top\">CUSTOM STATUS CATEGORIA STATS</caption>\n";
	$GRAPH_text.="  <tr>\n";
	$GRAPH_text.="	<th class=\"thgraph\" scope=\"col\">CATEGORIA </th>\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage INITIAL QUEUE POSITION BREAKDOWN       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=6\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- STATISTICHE OPERATORE       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=7\">DOWNLOAD</a>\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$CSV_text7.="\"TOTALE Operatori: $TOTagents\",\"$TOTcalls\",\"$TOTtime\",\"$TOTavg\"\n";

##############################
#########  TIME STATS

$MAIN.="\n";
$MAIN.="---------- STATISTICHE TEMPO       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=9\">DOWNLOAD</a>\n";
...
$MAIN.="\n";
$MAIN.="---------- $rpt_type_verbiage RISPOSTAED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&INVIA=$INVIA&file_download=8\">DOWNLOAD</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"$rpt_type_verbiage RISPOSTAED TIME BREAKDOWN IN SECONDS\"\n";
...
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="|TOTALI|                                                                                           | $BDansweredCALLS |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\"TOTALI\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"$BDansweredCALLS\"\n";
