...
if ($records_to_print > 0)
	...
	{
	echo "Campañas Permissions Error: |$PHP_AUTH_USER|$user_group|\n";
	exit;
	}
...
if ($bareformat < 1)
	...
	$MAIN.="</TD><TD VALIGN=TOP ROWSPAN=2> Campañas:<BR>";
	...
	$MAIN.="<a href=\"$PHP_SELF?DB=$DB&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date$groupQS&include_rollover=$include_rollover&time_interval=$time_interval&REMITIR=$REMITIR&shift=$shift&file_download=1\">DESCARGAR</a> | ";
...
if ($group_ct < 1)
	{
	$MAIN.="\n\n";
	$MAIN.="PLEASE SELECT A CAMPAIGN AND DATE RANGE ABOVE AND CLICK REMITIR\n";
	}
	...
	if ($group_ct > 0)
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "|                                          |        | SYSTEM | AGENTE  |        |        | NO     |        | AGENTE      | AGENTE      |\n";
		$ASCII_text .= "|                                          | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | RESPUESTA | DROP   | LOGIN      | PAUSE      |\n";
		$ASCII_text .= "| CAMPAIGN                                 | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

		$CSV_main.="\"MULTI-CAMPAIGN BREAKDOWN:\"\n";
		$CSV_main.="\"CAMPAIGN\",\"LLAMADAS TOTALES\",\"SYSTEM RELEASE CALLS\",\"AGENTE RELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO RESPUESTA PERCENT\",\"DROP PERCENT\",\"AGENTE LOGIN TIME(H:M:S)\",\"AGENTE PAUSE TIME(H:M:S)\"\n";
		$CSV_subreports="";
		...
		$GRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown1'><a href='#' onClick=\"DrawMultiCampañaGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown2'><a href='#' onClick=\"DrawMultiCampañaGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown3'><a href='#' onClick=\"DrawMultiCampañaGraph('AGENTRELEASE', '3'); return false;\">AGENTE RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown4'><a href='#' onClick=\"DrawMultiCampañaGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown5'><a href='#' onClick=\"DrawMultiCampañaGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown6'><a href='#' onClick=\"DrawMultiCampañaGraph('NAS', '6'); return false;\">NO RESPUESTA PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown7'><a href='#' onClick=\"DrawMultiCampañaGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown8'><a href='#' onClick=\"DrawMultiCampañaGraph('LOGINTIME', '8'); return false;\">AGENTE LOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown9'><a href='#' onClick=\"DrawMultiCampañaGraph('PAUSETIME', '9'); return false;\">AGENTE PAUSE TIME</a></th></tr>";
		...
		$AGENTRELEASE_graph=$graph_header."<th class='thgraph' scope='col'>AGENTE RELEASE CALLS</th></tr>";
		...
		$NAS_graph=$graph_header."<th class='thgraph' scope='col'>NO RESPUESTA PERCENT</th></tr>";
		$DROPS_graph=$graph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
		$LOGINTIME_graph=$graph_header."<th class='thgraph' scope='col'>AGENTE LOGIN TIME (H:M:S)</th></tr>";
		$PAUSETIME_graph=$graph_header."<th class='thgraph' scope='col'>AGENTE PAUSE TIME (H:M:S)</th></tr>";
		###########################
		...
		while($i < $group_ct)
			...
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
			$SUB_ASCII_text .= "|                     |        | SYSTEM | AGENTE  |        |        | NO     |        | AGENTE      | AGENTE      |\n";
			$SUB_ASCII_text .= "|                     | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | RESPUESTA | DROP   | LOGIN      | PAUSE      |\n";
			$SUB_ASCII_text .= "| INTERVAL            | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

			$CSV_subreports.="\n\n\"$group[$i] - $group_cname[$i]\"\n\"INTERVAL BREAKDOWN:\"\n";
			$CSV_subreports.="\"INTERVAL\",\"LLAMADAS TOTALES\",\"SYSTEM RELEASE CALLS\",\"AGENTE RELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO RESPUESTA PERCENT\",\"DROP PERCENT\",\"AGENTE LOGIN TIME (H:M:S)\",\"AGENTE PAUSE TIME(H:M:S)\"\n";
			...
			$SUBGRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."1'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."2'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."3'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('AGENTRELEASE', '3'); return false;\">AGENTE RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."4'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."5'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."6'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('NAS', '6'); return false;\">NO RESPUESTA PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."7'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."8'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('LOGINTIME', '8'); return false;\">AGENTE LOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."9'><a href='#' onClick=\"Draw".$SUBrpt_campaign."CampañaGraph('PAUSETIME', '9'); return false;\">AGENTE PAUSE TIME</a></th></tr>";
			...
			$SUBCALLS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>LLAMADAS TOTALES</th></tr>";
			$SUBSYSTEMRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>SYSTEM RELEASE CALLS</th></tr>";
			$SUBAGENTRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>AGENTE RELEASE CALLS</th></tr>";
			...
			$SUBNAS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>NO RESPUESTA PERCENT</th></tr>";
			$SUBDROPS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
			$SUBLOGINTIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>AGENTE LOGIN TIME (H:M:S)</th></tr>";
			$SUBPAUSETIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>AGENTE PAUSE TIME (H:M:S)</th></tr>";
			###########################
			...
			$JS_onload.="\tDraw".$SUBrpt_campaign."CampañaGraph('CALLS', '1');\n"; 
			$JS_text.="function Draw".$SUBrpt_campaign."CampañaGraph(graph, th_id) {\n";
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "| TOTALS       Campañas: $i             | $TOTcalls_count | $TOTsystem_count | $TOTagent_count | $TOTptp_count | $TOTrtp_count | $TOTna_percent%| $TOTdrop_percent%| $TOTagent_sec | $TOTpause_sec |\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$CSV_main.="\"TOTALS       Campañas: $i\",\"$TOTcalls_count\",\"$TOTsystem_count\",\"$TOTagent_count\",\"$TOTptp_count\",\"$TOTrtp_count\",\"$TOTna_percent%\",\"$TOTdrop_percent%\",\"$TOTagent_sec\",\"$TOTpause_sec\"\n";
		}
	...
	$JS_onload.="\tDrawMultiCampañaGraph('CALLS', '1');\n"; 
	$JS_text.="function DrawMultiCampañaGraph(graph, th_id) {\n";
