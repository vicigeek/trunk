...
if (
	...
	echo "<p>The following are basic lead management tools.  They will only work on listas inactivas with less than $list_lead_limit leads in them. This is to avoid data inconsistencies.</p>";
