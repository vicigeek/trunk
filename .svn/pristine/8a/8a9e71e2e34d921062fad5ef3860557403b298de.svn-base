...
#
//Get QC Utilisateur permissions
...
//Modifiermenuing to allow qc users into the system (if they have no permission otherwise)
//Copied Rapports-Only user setup for QC-Only user (Poundteam QC setup)
$qc_only_user=0;
