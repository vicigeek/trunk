...
if ($use_lists > 0)
	...
	$MAIN.="</SELECT>\n<BR>\n";
	$MAIN.="<a href=\"$PHP_SELF?use_lists=0&DB=$DB\">SWITCH TO CAMPANHAS</a>";
	}
else
	{
	$MAIN.="</TD><TD VALIGN=TOP> Campanhas:<BR>";
	$MAIN.="<SELECT SIZE=5 NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
if (strlen($group[0]) > 1)
	{
	$MAIN.=" <a href=\"./admin.php?ADD=34&campaign_id=$group[0]\">ALTERAR</a> | \n";
	$MAIN.=" <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a> </FONT>\n";
	}
else
	{
	$MAIN.=" <a href=\"./admin.php?ADD=10\">CAMPANHAS</a> | \n";
	$MAIN.=" <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a> </FONT>\n";
	}
$MAIN.="</TD></TR></TABLE>";
$MAIN.="</FORM>\n\n";
...
if (strlen($group[0]) < 1)
	{
	$MAIN.="\n\n";
	$MAIN.="POR FAVOR SELECIONE UMA CAMPANHA E UMA DATA ACIMA E CLIQUE EM ENVIAR\n";
	}
	...
	$OUToutput .= "\n";
	$OUToutput .= "---------- ID DA LISTA SUMMARY     <a href=\"$PHP_SELF?DB=$DB$groupQS&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a>\n";
	...
	$OUToutput .= "|  LOAD DATE | ID DA LISTA and NAME                         | CAMPANHA | COUNT      | ACTIVE   |";
	...
	$CSV_text1.="\"ID DA LISTA SUMMARY\"\n";
	$CSV_text1.="\"FIRST LOAD DATE\",\"LIST\",\"CAMPANHA\",\"LEADS\",\"ACTIVE\"";
	...
	$GRAPH="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"ID DA LISTA Summary\" class=\"horizontalgraph\">\n";
	$GRAPH.="<caption align='top'>ID DA LISTA SUMMARY</caption>";
	$GRAPH.="<tr>\n";
	...
	$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>ID DA LISTA SUMMARY</caption><tr><th class='thgraph' scope='col'>LISTS</th>";
