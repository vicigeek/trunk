...
$report_name = 'Listas Status da Campanha Report';
$db_source = 'M';
...
if (strlen($group[0]) < 1)
	...
	{
	$OUToutput = '';
	$OUToutput .= "Listas de Status Estatísticas da campanha                             $NOW_TIME\n";
	...
	$OUToutput .= "\n";
	$OUToutput .= "\n";
	$OUToutput .= "---------- STATUS FLAGS SUMMARY:    (and % of leads in selected lists)     <a href=\"$PHP_SELF?DB=$DB$groupQS&ENVIAR=$ENVIAR&file_download=2\">DOWNLOAD</a>\n";
	$OUToutput .= "+------------------+------------+----------+\n";
	$OUToutput .= "| Resposta Humana     | $HA_count |  $HA_percent% |\n";
	...
	$CSV_text2 .= "\"Resposta Humana\",\"$HA_count\",\"$HA_percent%\"\n";
	...
	$GRAPH.="  <tr>\n";
	$GRAPH.="	<td class=\"chart_td first\">Resposta Humana</td>\n";
	...
	$OUToutput .= "\n";
	$OUToutput .= "---------- CUSTOM STATUS CATEGORIA STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&ENVIAR=$ENVIAR&file_download=3\">DOWNLOAD</a>\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";
	$OUToutput .= "| CATEGORIA             | CALLS      | DESCRIPTION                    |\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";

	$CSV_text3.="\"CUSTOM STATUS CATEGORIA STATS\"\n";
	$CSV_text3.="\"CATEGORIA\",\"CALLS\",\"DESCRIPTION\"\n";
	...
	$TOTALleads = 0;
	$OUToutput .= "\n";
	$OUToutput .= "---------- PER LIST DETAIL STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&ENVIAR=$ENVIAR&file_download=4\">DOWNLOAD</a>\n";
	$OUToutput .= "\n";
	...
	while ($i < $listids_to_print)
		...
		$STATUS_graph=$graph_header."<tr><th class='thgraph' scope='col'>STATUS</th><th class='thgraph' scope='col'>QUANTIDADE</th></tr>";

		$CSV_text4.="\"ID DA LISTA: $LISTIDlists[$i]\",\"$LISTIDlist_names[$i]\",\"$LISTIDlist_active[$i]\"\n";
		...
		$FLAGS_graph.="  <tr><td class='chart_td first'>RESPOSTA HUMANOA</td><td nowrap class='chart_td value first'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$HA_count, $max_flags))."' height='16' />$HA_count ($HA_percent%)</td></tr>";
		...
		$CSV_text4.="\"Resposta Humana:\",\"$HA_count\",\"$HA_percent%\"\n";
		...
		$CSV_text4.="\"Agendamento de Chamadas:\",\"$SC_count\",\"$SC_percent%\"\n\n";
