...
$report_name = 'Estatísticas de Usuário';
$db_source = 'M';
...
if ($did > 0)
	...
	{$MAIN.="<B> &nbsp; Estatísticas de Usuário for $user";}
...
if ($did > 0)
	...
	$MAIN.=" | <a href=\"./admin.php?ADD=3311&did_id=$did_id\">AlterarDID</a>\n";
	}
else
	{
	$MAIN.="<a href=\"./AST_agent_time_sheet.php?agent=$user\">Agent Planilha de Tempo</a>\n";
	$MAIN.=" | <a href=\"./user_status.php?user=$user\">Status do Usuário</a>\n";
	$MAIN.=" | <a href=\"./admin.php?ADD=3&user=$user\">Alterar Usuário</a>\n";
	$MAIN.=" | <a href=\"./AST_agent_days_detail.php?user=$user&query_date=$begin_date&end_date=$end_date&group[]=--ALL--&shift=ALL\">Usuário multiple day status detail report</a>";
	}
$MAIN.="</center>\n";
...
if ($pause_code_rpt >= 1)
	...
	$MAIN.="<B>AGENTE PAUSE LOGS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=11'>[DOWNLOAD]</a></B>\n";

	$MAIN.="<center><TABLE width=600 cellspacing=0 cellpadding=1>\n";
	$MAIN.="<tr><td><font size=2>EVENT TIME</td><td align=right><font size=2>ID</td><td align=right><font size=2>GRUPO DE USUÁRIOS</td><td align=right><font size=2>PAUSE CODE</td><td align=right><font size=2>PAUSE LENGTH (HH:MM:SS)</td></tr>\n";

	$CSV_text11.="\"AGENTE PAUSE LOGS\"\n";
	$CSV_text11.="\"\",\"EVENT TIME\",\"ID\",\"GRUPO DE USUÁRIOS\",\"PAUSE CODE\",\"PAUSE LENGTH (HH:MM:SS)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>AGENTE TEMPO E STATUS DA CHAMADA:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=1'>[DOWNLOAD]</a></B>\n";

		$MAIN.="<center><TABLE width=300 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>STATUS</td><td align=right><font size=2>QUANTIDADE</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";

		$CSV_text1.="\"AGENTE TEMPO E STATUS DA CHAMADA\"\n";
		...
		$MAIN.="<tr><td><font size=2>TOTAL DE CHAMADAS </td><td align=right><font size=2> $total_calls</td><td align=right><font size=2> $call_hours_minutes</td></tr>\n";
		$CSV_text1.="\"\",\"TOTAL DE CHAMADAS\",\"$total_calls\",\"$call_hours_minutes\"\n";
		$MAIN.="</TABLE></center>\n";


		##### Login and Sair time from vicidial agent interface #####

		$MAIN.="<br><br>\n";

		$MAIN.="<center>\n";

		$MAIN.="<B>AGENTE HORÁRIO DE LOGIN/LOGOUT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=2'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=850 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>EVENTO</td><td align=right><font size=2> DATA</td><td align=right><font size=2> CAMPANHA</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>SESSION<BR>HOURS:MM:SS</td><td align=right><font size=2>SERVER</td><td align=right><font size=2>PHONE</td><td align=right><font size=2>COMPUTER</td><td align=right><font size=2>PHONE<BR>LOGIN</td><td align=right><font size=2>PHONE IP</td></tr>\n";

		$CSV_text2.="\"AGENTE HORÁRIO DE LOGIN/LOGOUT\"\n";
		$CSV_text2.="\"\",\"EVENT\",\"DATE\",\"CAMPANHA\",\"GROUP\",\"HOURS:MM:SS\",\"SESSION\",\"SERVER\",\"PHONE\",\"COMPUTER\",\"PHONE_LOGIN\",\"PHONE_IP\"\n";
		...
		$MAIN.="<B>TIMECLOCK HORÁRIO DE LOGIN/LOGOUT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=3'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2>EVENTO</td><td align=right><font size=2> DATA</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";
		$CSV_text3.="\"TIMECLOCK HORÁRIO DE LOGIN/LOGOUT\"\n";
		...
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2> CAMPANHA</td><td align=left><font size=2>BLEND</td><td align=left><font size=2> GROUPS</td><td align=left><font size=2> MANAGER</td></tr>\n";

		$CSV_text4.="\"CLOSER IN-GROUP SELECTION LOGS\"\n";
		$CSV_text4.="\"\",\"#\",\"DATE/TIME\",\"CAMPANHA\",\"BLEND\",\"GROUPS\",\"MANAGER\"\n";
		...
		if ($firstlastname_display_user_stats > 0)
			{
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> CAMPANHA</td><td align=right><font size=2> GROUP</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> NAME</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
			}
		else
			{
		...
		if ($firstlastname_display_user_stats > 0)
			{$CSV_text5.="\"\",\"#\",\"DATE/TIME\",\"LENGTH\",\"STATUS\",\"PHONE\",\"CAMPANHA\",\"GROUP\",\"LIST\",\"LEAD\",\"NAME\",\"HANGUP REASON\"\n";}
		else
			{$CSV_text5.="\"\",\"#\",\"DATE/TIME\",\"LENGTH\",\"STATUS\",\"PHONE\",\"CAMPANHA\",\"GROUP\",\"LIST\",\"LEAD\",\"HANGUP REASON\"\n";}
		...
		while ($logs_to_print > $u) 
			...
			if ($LOGadmin_hide_phone_data != '0')
				{
				if ($DB > 0) {echo "ESCONDERPHONEDATA|$row[10]|$LOGadmin_hide_phone_data|\n";}
				$phone_temp = $row[10];
		...
		if ($allow_emails>0) 
			...
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>USER</td><td align=left><font size=2> CAMPANHA</td><td align=left><font size=2> EMAIL TO</td><td align=right><font size=2> ATTACHMENTS</td><td align=right><font size=2> LEAD</td></tr>\n";
			$CSV_text5.="\"OUTBOUND EMAILS FOR THIS TIME PERIOD: (10000 record limit)\"\n";
			$CSV_text5.="\"\",\"#\",\"DATE/TIME\",\"USER\",\"CAMPANHA\",\"EMAIL TO\",\"ATTACHMENT\",\"LEAD\",\"MESSAGE\"\n";
	...
	if ($firstlastname_display_user_stats > 0)
		{
		$CSV_text6.="\"\",\"#\",\"DATE/TIME\",\"LENGTH\",\"STATUS\",\"PHONE\",\"CAMPANHA\",\"WAIT(S)\",\"AGENT(S)\",\"LIST\",\"LEAD\",\"NAME\",\"HANGUP REASON\"\n";
		}
	else
		{
		$CSV_text6.="\"\",\"#\",\"DATE/TIME\",\"LENGTH\",\"STATUS\",\"PHONE\",\"CAMPANHA\",\"WAIT(S)\",\"AGENT(S)\",\"LIST\",\"LEAD\",\"HANGUP REASON\"\n";
		}
	...
	if ($did < 1)
		{
		$MAIN.="<B>Atividade do agente para esse período: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=7'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td colspan=2><font size=1> &nbsp; </td><td colspan=6 align=center bgcolor=white><font size=1>estes campos estão em segundos </td><td colspan=4><font size=1> &nbsp; </td></tr>\n";
		...
		$CSV_text7.="\"Atividade do agente para esse período: (10000 record limit)\"\n";
		$CSV_text7.="\"\",\"#\",\"DATE/TIME\",\"PAUSE\",\"WAIT\",\"TALK\",\"DISPO\",\"DEAD\",\"CUSTOMER\",\"STATUS\",\"LEAD\",\"CAMPANHA\",\"PAUSE CODE\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>LEAD procura por este período de tempo: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=10'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		...
		$CSV_text10.="\"LEAD procura por este período de tempo: (10000 record limit)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=1># </td><td NOWRAP><font size=2>DATE/TIME &nbsp; </td><td align=right NOWRAP><font size=2> LEAD ID &nbsp; </td><td align=right NOWRAP><font size=2> STATUS &nbsp; </td><td align=right NOWRAP><font size=2> COUNT &nbsp; </td><td align=right NOWRAP><font size=2> CAMPANHA</td></tr>\n";
		$CSV_text11.="\"PREVIEW LEAD SKIPS FOR THIS TIME PERIOD: (10000 record limit)\"\n";
		$CSV_text11.="\"\",\"#\",\"DATE/TIME\",\"LEAD ID\",\"STATUS\",\"COUNT\",\"CAMPANHA\"\n";
