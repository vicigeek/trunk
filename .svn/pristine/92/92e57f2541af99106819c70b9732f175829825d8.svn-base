...
<title>VERWALTUNG: Kampagne Multi-Alt-Leads
<?php 
...
if ($action == "BLANK")
	...
	echo "<br>Multi-Kanal-Auto-Dialing-Einstellungen Alt Formular<form action=$PHP_SELF method=POST>\n";
	...
	echo "<br><b>PHONE TYPES WITHIN THE LISTS FOR THIS KAMPAGNE: <a href=\"./admin.php?ADD=31&campaign_id=$campaign_id\">$campaign_id</a></b>\n";
	echo "<TABLE width=700 cellspacing=3>\n";
	echo "<tr><td>PHONE NUMBER TYPE</td><td>BENANNT</td><td>NICHT BENANNT</td><td>SELECTED</td><td>OLD RANK</td><td>NEW RANK</td></tr>\n";
	...
	echo "<tr bgcolor=\"#9BB9FB\"><td><font size=1>GESAMTMENGE</td><td colspan=3 align=center><font size=1>$lead_list[count]</td><td align=center><font size=1>$o</td></tr>\n";
	...
	echo "<tr bgcolor=#B6D3FC><td align=right>Liste Auftrag Randomize: </td><td align=left><select size=1 name=lead_order_randomize><option>Y</option><option>N</option><option SELECTED>$lead_order_randomize</option></select></td></tr>\n";
	echo "<tr bgcolor=#B6D3FC><td align=right>Liste Auftrag Sekundäre: </td><td align=left><select size=1 name=lead_order_secondary><option>LEAD_ASCEND</option><option>LEAD_DESCEND</option><option>CALLTIME_ASCEND</option><option>CALLTIME_DESCEND</option><option SELECTED>$lead_order_secondary</option></select></td></tr>\n";
