...
echo "<CENTER><H2>CHAMADA INBOUND VIVA</H2>\n";
...
#		Zap/73|"V.I.C.I. MARKET" <7275338730>|2005-04-28 14:01:21|7274514936|Inbound direct to Matt|||||
		...
		echo "</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td>O Número Marcou: </td><td align=left>$row[8]</td></tr>\n";
		...
		echo "<a href=\"#\" onclick=\"liveredirect_send_vmail('$row[1]','$vmail_box');return false;\">EMITA A MEU VOICEMAIL</a>\n";
		echo "</span></td></tr>\n";
		echo "</table>\n";
