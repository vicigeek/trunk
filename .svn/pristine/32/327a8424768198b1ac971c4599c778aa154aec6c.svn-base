...
if (!$group)
	...
	$ASCII_text="---------- RENDIMIENTO Detalles -------------\n";

	$HTML_text.="Agent Performance Comparison                        $NOW_TIME\n";
	$HTML_text.="Starting date: $query_date                         <a href=\"$LINKbase&stage=$stage&file_download=1\">[DESCARGAR]</a>\n\n";
	...
	for ($q=0; $q<count($rpt_date_array); $q++) 
		...
		$CSV_header2.='"CALLS","SALES","CONVERSIÓN RATE TO CALLS","SALES PER HOUR","TIME",';
		...
		$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>$rpt_subtitle SUMMARY</caption><tr><th class='thgraph' scope='col'>USUARIOS</th>";
