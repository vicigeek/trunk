...
echo "<b> &nbsp; Básico Lead Tools &nbsp; | &nbsp; <a href=\"lead_tools_advanced.php\">Advanced Lead Tools</a></b>\n";
echo "</font>\n";
echo "</td>\n";
...
if (
	...
	echo "<p>The following are basic lead management tools.  They will only work on listas inativas with less than $list_lead_limit leads in them. This is to avoid data inconsistencies.</p>";
