...
$report_name='In-Group Χρήστης List';
...
echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=3111&group_id=$group\">ΤΡΟΠΟΠΟΙΗΣΗ</a> \n";
echo "</FORM>\n\n";
...
if (!$group)
	{
	echo "\n\n";
	echo "PLEASE SELECT A IN-GROUP ABOVE AND CLICK ΕΠΙΒΕΒΑΙΩΣΗ\n";
	}

else
	{
	echo "Live Current Πράκτορες logged in to take calls from $group - $selected_name         $NOW_TIME\n";
	...
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
	echo "| #    | ΧΡΗΣΤΗΣ                        | CAMPAIGN             | STATUS | LAST ACTIVITY       |\n";
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
