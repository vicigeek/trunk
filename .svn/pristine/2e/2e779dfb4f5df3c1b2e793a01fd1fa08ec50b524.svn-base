...
$report_name = 'Agent Performance Détail';
$db_source = 'M';
...
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Lundi week start\n";
$HTML_text.="</script>\n";
...
$HTML_text.="</TD><TD VALIGN=TOP> Campagnes:<BR>";
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Groupes d'utilisateurs:<BR>";
$HTML_text.="<SELECT SIZE=5 NAME=user_group[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$user_group_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL GROUPES D'UTILISATEURS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL GROUPES D'UTILISATEURS --</option>\n";}
$o=0;
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Utilisateurs: <BR>";
$HTML_text.="<SELECT SIZE=5 NAME=users[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$users_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL UTILISATEURS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL UTILISATEURS --</option>\n";}
$o=0;
...
$HTML_text.="<INPUT TYPE=Submit NAME=VALIDER VALUE=VALIDER>$NWB#agent_performance_detail$NWE\n";
$HTML_text.="</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";

$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
$HTML_text.=" <a href=\"./admin.php?ADD=999999\">RAPPORTS</a> </FONT>\n";
$HTML_text.="</FONT>\n";
...
{
$HTML_text.="\n";
$HTML_text.="S'IL VOUS PLAÎT CHOISIR UNE CAMPAGNE ET DATE EN TEMPS ET CLIQUEZ CI-DESSUS VALIDER\n";
...
$HTML_text.="Agent Performance Détail                        $NOW_TIME\n";

$HTML_text.="Time range: $query_date_BEGIN to $query_date_END\n\n";
$HTML_text.="---------- AGENTS Détails -------------\n\n";
...
$CSV_header="\"Agent Performance Détail                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"---------- AGENTS Détails -------------\"\n";

if ($show_percentages) {
	$CSV_header.='"USER NAME","ID","CURRENT GROUPE D'UTILISATEURS","MOST RECENT GROUPE D'UTILISATEURS","CALLS","TIME","PAUSE","PAUSE %","PAUSAVG","WAIT","WAIT %","WAITAVG","TALK","TALK %","TALKAVG","DISPO","DISPO %","DISPAVG","DEAD","DEAD %","DEADAVG","CUSTOMER","CUSTOMER %","CUSTAVG"';
} else {
	$CSV_header.='"USER NAME","ID","CURRENT GROUPE D'UTILISATEURS","MOST RECENT GROUPE D'UTILISATEURS","CALLS","TIME","PAUSE","PAUSAVG","WAIT","WAITAVG","TALK","TALKAVG","DISPO","DISPAVG","DEAD","DEADAVG","CUSTOMER","CUSTAVG"';
}
...
$ASCII_text.="CALL STATS BREAKDOWN: (Statistics related to handling of calls only)     <a href=\"$LINKbase&stage=$stage&file_download=1\">[TÉLÉCHARGER]</a>\n";

if ($show_percentages) {
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+$statusesHEAD\n";
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GROUPE D'UTILISATEURS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    | PAUSE %    |PAUSAVG | WAIT     | WAIT %     |WAITAVG | TALK     | TALK %     |TALKAVG | DISPO    | DISPO %    |DISPAVG | DEAD     | DEAD %     |DEADAVG | CUSTOMER | CUSTOMER % |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+$statusesHEAD\n";
} else {
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GROUPE D'UTILISATEURS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    |PAUSAVG | WAIT     |WAITAVG | TALK     |TALKAVG | DISPO    |DISPAVG | DEAD     |DEADAVG | CUSTOMER |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
}
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>PAUSE CODE BREAKDOWN</caption><tr><th class='thgraph' scope='col'>ETAT</th>";
...
$ASCII_text.="PAUSE CODE BREAKDOWN:     <a href=\"$LINKbase&stage=$stage&file_download=2\">[TÉLÉCHARGER]</a>\n\n";
$ASCII_text.="+-----------------+----------+----------------------+----------------------+----------+----------+----------+  +$sub_statusesHEAD\n";
$ASCII_text.="| USER NAME       | ID       | CURRENT GROUPE D'UTILISATEURS   | MOST RECENT USER GRP | TOTAL    | NONPAUSE | PAUSE    |  |$sub_statusesHTML\n";
$ASCII_text.="+-----------------+----------+----------------------+----------------------+----------+----------+----------+  +$sub_statusesHEAD\n";

$CSV_header="\"Agent Performance Détail                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"PAUSE CODE BREAKDOWN:\"\n";
$CSV_header.="\"USER NAME\",\"ID\",\"CURRENT GROUPE D'UTILISATEURS\",\"MOST RECENT GROUPE D'UTILISATEURS\",\"TOTAL\",\"NONPAUSE\",\"PAUSE\",$CSV_statuses\n";
