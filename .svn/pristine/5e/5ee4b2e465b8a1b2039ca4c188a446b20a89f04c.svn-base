...
$report_name = 'Benutzer-GruppeTimeclock Status Report';
$db_source = 'M';
...
$MAIN.="<B>USER STATUS FOR User Gruppe:$user_group &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$PHP_SELF?DB=$DB&user_group=$user_group&submit=$submit&file_download=1'>[DOWNLOAD]</a></B>\n";
...
$CSV_text.="\"USER STATUS FOR User Gruppe:$user_group\"\n";
...
$MAIN.="<B>TIMECLOCK LOGIN/LOGOUT ZEIT:</B>\n";
