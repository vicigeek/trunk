...
$report_name = 'UserTimeclock Report';
$db_source = 'M';
...
$MAIN.="<font class=\"select_bold\"><B>Zeitraum:</B></font><BR><CENTER>\n";
...
$MAIN.="<font class=\"select_bold\"><B>Benutzer-Gruppen:</B></font><BR><CENTER>\n";
...
$MAIN.="UserTimeclock Report                        $NOW_TIME\n";

$CSV_text.="\"UserTimeclock Report - $NOW_TIME\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"CALL HANGUP GRUND STATS\" class=\"horizontalgraph\">\n";
