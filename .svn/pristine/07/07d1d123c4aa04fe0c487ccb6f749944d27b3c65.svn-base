...
if ($type == 'inbound')
	...
	$MAIN.="<a href=\"$PHP_SELF?DB=$DB&type=$type&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS&shift=$shift&file_download=1\">TÉLÉCHARGER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=3111&group_id=$group[0]\">MODIFIER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=999999\">RAPPORTS</a> | ";
	$MAIN.="<a href=\"./AST_CLOSERstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">RAPPORT SUR LES CLOSERS</a> \n";
	$MAIN.="</FONT>\n";
	}
else
	{
	...
	$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ";
	$MAIN.="<a href=\"$PHP_SELF?DB=$DB&type=$type&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS&shift=$shift&file_download=1\">TÉLÉCHARGER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=31&campaign_id=$group[0]\">MODIFIER</a> | ";
	$MAIN.="<a href=\"./admin.php?ADD=999999\">RAPPORTS</a> | ";
...
$MAIN.="&nbsp; &nbsp; <input type=button value=\"VALIDER\" name=smt id=smt onClick=\"submit_form()\">\n";
...
if ($groups_to_print < 1)
	...
	#### PRINT TOTAL DES APPELSINTO THIS IVR
	$MAIN.="\n";
	...
	$MAIN.="GRAPHIQUE INCREMENTE PAR TRANCHE DE 15 MINUTES DU TOTAL DES APPELS TAKEN INTO THIS IVR\n";
	$CSV_text.="\n\"GRAPHIQUE INCREMENTE PAR TRANCHE DE 15 MINUTES DU TOTAL DES APPELS TAKEN INTO THIS IVR\"\n";
