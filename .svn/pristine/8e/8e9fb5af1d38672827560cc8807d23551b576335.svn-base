...
if (!$group)
	{
	echo "\n";
	echo "PLEASE SELECT A ΔΙΑΚΟΜΙΣΤΗΣ AND DATE/TIME RANGE ABOVE AND CLICK ΕΠΙΒΕΒΑΙΩΣΗ\n";
	}
	...
	echo "Σύνολο καλεί in/out on this διακομιστή:        $TOTALcalls\n";
	echo "Total Off-Hook time on this server (min): $OFFHOOKtime\n";
	echo "Average/Peak channels in use for διακομιστή:  $AVGchannels / $HIGHchannels\n";
	echo "Average/Peak load for διακομιστή:             $AVGload / $HIGHload\n";
