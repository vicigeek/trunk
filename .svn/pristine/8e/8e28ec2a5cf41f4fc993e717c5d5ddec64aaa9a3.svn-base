...
if ($groups_to_print < 1)
	...
	$MAIN.="\n\n";
	if ($EMAIL=='Y')
		{$MAIN.="PLEASE SELECT AN EMAIL ACCOUNT AND DATE RANGE ABOVE AND CLICK ENVIAR\n";}
	if ($DID=='Y')
		{$MAIN.="PLEASE SELECT A DID AND DATE RANGE ABOVE AND CLICK ENVIAR\n";}
	else
...
if ($EMAIL=='Y') 
	{
	$MAIN.="Inbound Email Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
else
	{
	$MAIN.="Inbound Call Stats: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a>\n";
	$CSV_text1.="\"Inbound Call Stats:\",\"$group_string\",\"$NOW_TIME\"\n";
	}
...
$RESPOSTAEDpercent = (MathZDC($RESPOSTAEDcalls, $TOTALcalls) * 100);
...
if ($EMAIL=='Y')
	...
	$MAIN.="Answered Emails:                               $RESPOSTAEDcalls  $RESPOSTAEDpercent%\n";
	...
	$CSV_text1.="\"Answered Emails:\",\"$RESPOSTAEDcalls\",\"$RESPOSTAEDpercent%\"\n";
	...
	{
	$MAIN.="Total de chamadas recebidas pelo Grupo:        $TOTALcalls\n";
	$MAIN.="Average Call Length for all Calls:            $average_call_seconds seconds\n";
	$MAIN.="Answered Calls:                               $RESPOSTAEDcalls  $RESPOSTAEDpercent%\n";
	...
	$CSV_text1.="\"Total de chamadas recebidas pelo Grupo:\",\"$TOTALcalls\"\n";
	$CSV_text1.="\"Average Call Length for all Calls:\",\"$average_call_seconds seconds\"\n";
	$CSV_text1.="\"Answered Calls:\",\"$RESPOSTAEDcalls\",\"$RESPOSTAEDpercent%\"\n";
...
$DROP_RESPOSTAEDpercent = (MathZDC($DROPcalls, $RESPOSTAEDcalls) * 100);
$DROP_RESPOSTAEDpercent = round($DROP_RESPOSTAEDpercent, 0);

if ($EMAIL=='Y')
	{
	$MAIN.="Total DROP Emails:                             $DROPcalls  $DROPpercent%               drop/answered: $DROP_RESPOSTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Emails:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Emails:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RESPOSTAEDpercent%\"\n";
	$CSV_text1.="\"Average hold time for DROP Emails:\",\"$average_hold_seconds seconds\"\n";
	}
else
	{
	$MAIN.="Total de chamadas derrubadas:                 $DROPcalls  $DROPpercent%               drop/answered: $DROP_RESPOSTAEDpercent%\n";
	$MAIN.="Average hold time for DROP Calls:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Calls:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_RESPOSTAEDpercent%\"\n";
...
if (strlen($group_SQL)>3)
	...
	if ($DID!='Y')
		...
		$PCTanswer_sec_pct_rt_stat_one = (MathZDC($answer_sec_pct_rt_stat_one, $RESPOSTAEDcalls) * 100);
		...
		$PCTanswer_sec_pct_rt_stat_two = (MathZDC($answer_sec_pct_rt_stat_two, $RESPOSTAEDcalls) * 100);
...
if ($EMAIL=='Y')
	...
	$MAIN.="GDE (Answered/Total emails taken in to this In-Group):  $RESPOSTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RESPOSTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Total emails taken in to this In-Group):\",\"$RESPOSTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RESPOSTAEDpercent%\"\n";
	}
else
	{
	$MAIN.="\n";
	$MAIN.="---------- CUSTOM INDICATORS\n";
	$MAIN.="GDE (Answered/Chamadas totais atendidas in to this In-Group):  $RESPOSTAEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_RESPOSTAEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Chamadas totais atendidas in to this In-Group):\",\"$RESPOSTAEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_RESPOSTAEDpercent%\"\n";
	}
...
if ($EMAIL=='Y')
	...
	{
	$MAIN.="Total de chamadas That entered Queue:               $QUEUEcalls  $QUEUEpercent%\n";
	...
	$CSV_text1.="\"Total de chamadas That entered Queue:\",\"$QUEUEcalls\",\"$QUEUEpercent%\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HOLD TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=2\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="           $rpt_type_verbiage RESPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"$rpt_type_verbiage RESPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
if ($report_display_type=="HTML") {
	...
	$GRAPH_text.="g.render(\"CallTimeCanvas\", \"CALL RESPOSTAED TIME BREAKDOWN\");\n";
	$GRAPH_text.="</script>";
	$MAIN.=$GRAPH_text;
	}
else
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage HANGUP REASON STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=3\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage STATUS STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=4\">DOWNLOAD</a>\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
$ASCII_text.="| STATUS | DESCRIPTION          | CATEGORIA             | $rpt_type_verbiages     | TOTAL TIME | AVG TIME |$rpt_type_verbiages/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
...
$CSV_text4.="\"STATUS\",\"DESCRIPTION\",\"CATEGORIA\",\"$rpt_type_verbiages\",\"TOTAL TIME\",\"AVG TIME\",\"$rpt_type_verbiages/HOUR\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CUSTOM STATUS CATEGORIA STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=5\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";
$ASCII_text.="| CATEGORIA             | $rpt_type_verbiages     | DESCRIPTION                    |\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";

$CSV_text5.="\n\"CUSTOM STATUS CATEGORIA STATS\"\n";
$CSV_text5.="\"CATEGORIA\",\"$rpt_type_verbiages\",\"DESCRIPTION\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- $rpt_type_verbiage INITIAL QUEUE POSITION BREAKDOWN       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=6\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- AGENTE STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=7\">DOWNLOAD</a>\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$MAIN.="\n";
$MAIN.="---------- ESTATÍSTICAS DE TEMPO       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=9\">DOWNLOAD</a>\n";
...
$MAIN.="\n";
$MAIN.="---------- $rpt_type_verbiage RESPOSTAED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=8\">DOWNLOAD</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"$rpt_type_verbiage RESPOSTAED TIME BREAKDOWN IN SECONDS\"\n";
