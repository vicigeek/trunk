...
$report_name = 'Listas Campaña Estados de  Report';
$db_source = 'M';
...
if (strlen($group[0]) < 1)
	...
	{
	$OUToutput = '';
	$OUToutput .= "Listas de Estadísticas de Estado de Campaña                             $NOW_TIME\n";
	...
	$OUToutput .= "\n";
	$OUToutput .= "\n";
	$OUToutput .= "---------- STATUS FLAGS SUMMARY:    (and % of leads in selected lists)     <a href=\"$PHP_SELF?DB=$DB$groupQS&REMITIR=$REMITIR&file_download=2\">DESCARGAR</a>\n";
	$OUToutput .= "+------------------+------------+----------+\n";
	$OUToutput .= "| Respuesta Humana     | $HA_count |  $HA_percent% |\n";
	...
	$CSV_text2 .= "\"Respuesta Humana\",\"$HA_count\",\"$HA_percent%\"\n";
	...
	$GRAPH.="  <tr>\n";
	$GRAPH.="	<td class=\"chart_td first\">Respuesta Humana</td>\n";
	...
	##############################
	#########  STATUS CATEGORÍA STATS

	$OUToutput .= "\n";
	$OUToutput .= "---------- CUSTOM STATUS CATEGORÍA STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&REMITIR=$REMITIR&file_download=3\">DESCARGAR</a>\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";
	$OUToutput .= "| CATEGORÍA             | CALLS      | DESCRIPTION                    |\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";

	$CSV_text3.="\"CUSTOM STATUS CATEGORÍA STATS\"\n";
	$CSV_text3.="\"CATEGORÍA\",\"CALLS\",\"DESCRIPTION\"\n";

	$max_calls=1; $graph_stats=array();
	$GRAPH.="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"DID Summary\" class=\"horizontalgraph\">\n";
	$GRAPH.="<caption align='top'>CUSTOM STATUS CATEGORÍA STATS</caption>";
	$GRAPH.="<tr>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">CATEGORÍA</th>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">CALLS</th>\n";
	$GRAPH.="</tr>\n";
	...
	$TOTALleads = 0;
	$OUToutput .= "\n";
	$OUToutput .= "---------- PER LIST DETAIL STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&REMITIR=$REMITIR&file_download=4\">DESCARGAR</a>\n";
	$OUToutput .= "\n";
	...
	while ($i < $listids_to_print)
		...
		$STATUS_graph=$graph_header."<tr><th class='thgraph' scope='col'>ESTADO</th><th class='thgraph' scope='col'>CUENTA</th></tr>";

		$CSV_text4.="\"LISTA  ID: $LISTIDlists[$i]\",\"$LISTIDlist_names[$i]\",\"$LISTIDlist_active[$i]\"\n";
		...
		$FLAGS_graph.="  <tr><td class='chart_td first'>RESPUESTA HUMANOA</td><td nowrap class='chart_td value first'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$HA_count, $max_flags))."' height='16' />$HA_count ($HA_percent%)</td></tr>";
		...
		$CSV_text4.="\"Respuesta Humana:\",\"$HA_count\",\"$HA_percent%\"\n";
		...
		$CSV_text4.="\"Remarcaciones Programadas:\",\"$SC_count\",\"$SC_percent%\"\n\n";
