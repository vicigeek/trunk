...
$report_name = 'UserTimeclock Detail Report';
$db_source = 'M';
...
if (strlen($user_group[0]) < 1)
	...
	if ($file_download < 1)
		{
		$ASCII_text.="MITTELTIME-CLOCK DETAIL:\n";
		$ASCII_text.="+-----------------+----------+----------------------+------------+--------------------\n";
		...
		$GRAPH.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"MITTELTIME-CLOCK DETAIL\" class=\"horizontalgraph\">\n";
		$GRAPH.="  <caption align=\"top\">MITTELTIME-CLOCK DETAIL</caption>\n";
		$GRAPH.="  <tr>\n";
