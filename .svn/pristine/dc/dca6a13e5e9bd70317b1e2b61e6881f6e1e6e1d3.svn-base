...
$report_name = 'Agent Performance Detalhes';
$db_source = 'M';
...
$HTML_text.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP> Datas:<BR>";
...
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Segunda week start\n";
$HTML_text.="</script>\n";
...
$HTML_text.="</TD><TD VALIGN=TOP> Campanhas:<BR>";
$HTML_text.="<SELECT SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL CAMPANHAS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL CAMPANHAS --</option>\n";}
$o=0;
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Grupos de Usuário:<BR>";
$HTML_text.="<SELECT SIZE=5 NAME=user_group[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$user_group_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL GRUPOS DE USUÁRIOS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL GRUPOS DE USUÁRIOS --</option>\n";}
$o=0;
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Usuários: <BR>";
$HTML_text.="<SELECT SIZE=5 NAME=users[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$users_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL USUÁRIOS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL USUÁRIOS --</option>\n";}
$o=0;
...
$HTML_text.="<INPUT TYPE=Submit NAME=ENVIAR VALUE=ENVIAR>$NWB#agent_performance_detail$NWE\n";
$HTML_text.="</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";

$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
$HTML_text.=" <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a> </FONT>\n";
$HTML_text.="</FONT>\n";
...
{
$HTML_text.="\n";
$HTML_text.="POR FAVOR SELECIONE UMA CAMPANHA E PERÍODO ACIMA E CLIQUE ENVIAR\n";
...
$HTML_text.="Agent Performance Detalhes                        $NOW_TIME\n";

$HTML_text.="Time range: $query_date_BEGIN to $query_date_END\n\n";
$HTML_text.="---------- AGENTS Detalhess -------------\n\n";
...
$CSV_header="\"Agent Performance Detalhes                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"---------- AGENTS Detalhess -------------\"\n";

if ($show_percentages) {
	$CSV_header.='"USER NAME","ID","CURRENT GRUPO DE USUÁRIOS","MOST RECENT GRUPO DE USUÁRIOS","CALLS","TIME","PAUSE","PAUSE %","PAUSAVG","WAIT","WAIT %","WAITAVG","TALK","TALK %","TALKAVG","DISPO","DISPO %","DISPAVG","DEAD","DEAD %","DEADAVG","CUSTOMER","CUSTOMER %","CUSTAVG"';
} else {
	$CSV_header.='"USER NAME","ID","CURRENT GRUPO DE USUÁRIOS","MOST RECENT GRUPO DE USUÁRIOS","CALLS","TIME","PAUSE","PAUSAVG","WAIT","WAITAVG","TALK","TALKAVG","DISPO","DISPAVG","DEAD","DEADAVG","CUSTOMER","CUSTAVG"';
}
...
if ($show_percentages) {
	...
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GRUPO DE USUÁRIOS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    | PAUSE %    |PAUSAVG | WAIT     | WAIT %     |WAITAVG | TALK     | TALK %     |TALKAVG | DISPO    | DISPO %    |DISPAVG | DEAD     | DEAD %     |DEADAVG | CUSTOMER | CUSTOMER % |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+$statusesHEAD\n";
} else {
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GRUPO DE USUÁRIOS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    |PAUSAVG | WAIT     |WAITAVG | TALK     |TALKAVG | DISPO    |DISPAVG | DEAD     |DEADAVG | CUSTOMER |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
}
...
$ASCII_text.="| USER NAME       | ID       | CURRENT GRUPO DE USUÁRIOS   | MOST RECENT USER GRP | TOTAL    | NONPAUSE | PAUSE    |  |$sub_statusesHTML\n";
$ASCII_text.="+-----------------+----------+----------------------+----------------------+----------+----------+----------+  +$sub_statusesHEAD\n";

$CSV_header="\"Agent Performance Detalhes                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"PAUSE CODE BREAKDOWN:\"\n";
$CSV_header.="\"USER NAME\",\"ID\",\"CURRENT GRUPO DE USUÁRIOS\",\"MOST RECENT GRUPO DE USUÁRIOS\",\"TOTAL\",\"NONPAUSE\",\"PAUSE\",$CSV_statuses\n";
