...
echo "<TITLE>Server-Specific Tempo Real Report</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
echo "Agentes Time On Calls           $NOW_TIME    <a href=\"$PHP_SELF?server_ip=$server_ip&DB=$DB&reset_counter=$reset_counter&closer_display=$closer_display_reverse\">$closer_reverse_link</a> | <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a>\n\n";
...
$talking_to_print = mysqli_num_rows($rslt);
	...
	#	echo "  <SPAN class=\"blue\"><B>          </SPAN> - Acima de 5 minutos em chamada</B>\n";
	#	echo "  <SPAN class=\"purple\"><B>          </SPAN> - Acima de 10 minutos em chamada</B>\n";
		}
	else
		{
		echo "+------------+------------+--------+-----------+---------------------+--------+----------+---------+\n";
		...
		echo "  <SPAN class=\"yellow\"><B>          </SPAN> - Agentes em pausa</B>\n";
		echo "  <SPAN class=\"blue\"><B>          </SPAN> - Acima de 5 minutos em chamada</B>\n";
		echo "  <SPAN class=\"purple\"><B>          </SPAN> - Acima de 10 minutos em chamada</B>\n";
		}
...
$parked_to_print = mysqli_num_rows($rslt);
	...
	#	if ($call_time_M_int >= 6) {$G='<SPAN class="red"><B>'; $EG='</B></SPAN>';}
		...
		echo "  <SPAN class=\"green\"><B>          </SPAN> - CHAMADAS EM ESPERA</B>\n";
