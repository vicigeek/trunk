...
<?php
echo "<title>AGENTS DISTANTS: $LOGfullname - $PHP_AUTH_USER   ";

if (!$ADD)			{$ADD="31111";}
if ($ADD==31111)	{echo "Modifier les agents distants";}
if ($ADD==41111)	{echo "Modifier les agents distants";}
...
if ($ADD==71111)
	...
	if ( (strlen($server_ip) < 2) or (strlen($user) < 2) )
		...
		echo "Statistiques des agents distants en entrée                               $NOW_TIME\n\n";
		echo "\n";
