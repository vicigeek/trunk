...
$report_name='User Gruppe Stündlicher Notfall';
...
<title>ADMINISTRATION: Gruppe Stündlicher Notfall
<?php
...
<CENTER>
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; Gruppe Stündlicher Notfall <?php echo $group ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; </TD></TR>
...
echo "<br>Melden Sie bitte die Gruppe an, die Sie stündlichen Notfall fürerhalten möchten: <form action=$PHP_SELF method=GET>\n";
