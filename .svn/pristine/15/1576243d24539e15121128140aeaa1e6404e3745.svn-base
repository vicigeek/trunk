...
$report_name = 'Agent Performance Detalle';
$db_source = 'M';
...
$HTML_text.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP> Fechas:<BR>";
...
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Lunes week start\n";
$HTML_text.="</script>\n";
...
$HTML_text.="</TD><TD VALIGN=TOP> Campañas:<BR>";
$HTML_text.="<SELECT SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL CAMPAÑAS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL CAMPAÑAS --</option>\n";}
$o=0;
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Grupos De Usuario:<BR>";
$HTML_text.="<SELECT SIZE=5 NAME=user_group[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$user_group_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL GRUPOS DE USUARIO --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL GRUPOS DE USUARIO --</option>\n";}
$o=0;
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD VALIGN=TOP>Usuarios: <BR>";
$HTML_text.="<SELECT SIZE=5 NAME=users[] multiple>\n";

if  (preg_match('/\-\-ALL\-\-/',$users_string))
	{$HTML_text.="<option value=\"--ALL--\" selected>-- ALL USUARIOS --</option>\n";}
else
	{$HTML_text.="<option value=\"--ALL--\">-- ALL USUARIOS --</option>\n";}
$o=0;
...
$HTML_text.="<INPUT TYPE=Submit NAME=REMITIR VALUE=REMITIR>$NWB#agent_performance_detail$NWE\n";
$HTML_text.="</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";

$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
$HTML_text.=" <a href=\"./admin.php?ADD=999999\">INFORMES</a> </FONT>\n";
$HTML_text.="</FONT>\n";
...
{
$HTML_text.="\n";
$HTML_text.="POR FAVOR SELECCIONE UNA CAMPAÑA Y FECHA-HORA ARRIBA Y HAGA CLICK REMITIR\n";
...
$HTML_text.="Agent Performance Detalle                        $NOW_TIME\n";

$HTML_text.="Time range: $query_date_BEGIN to $query_date_END\n\n";
$HTML_text.="---------- AGENTS Detalles -------------\n\n";
...
$CSV_header="\"Agent Performance Detalle                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"---------- AGENTS Detalles -------------\"\n";

if ($show_percentages) {
	$CSV_header.='"USER NAME","ID","CURRENT GRUPO DE USUARIOS","MOST RECENT GRUPO DE USUARIOS","CALLS","TIME","PAUSE","PAUSE %","PAUSAVG","WAIT","WAIT %","WAITAVG","TALK","TALK %","TALKAVG","DISPO","DISPO %","DISPAVG","DEAD","DEAD %","DEADAVG","CUSTOMER","CUSTOMER %","CUSTAVG"';
} else {
	$CSV_header.='"USER NAME","ID","CURRENT GRUPO DE USUARIOS","MOST RECENT GRUPO DE USUARIOS","CALLS","TIME","PAUSE","PAUSAVG","WAIT","WAITAVG","TALK","TALKAVG","DISPO","DISPAVG","DEAD","DEADAVG","CUSTOMER","CUSTAVG"';
}
...
$ASCII_text.="CALL STATS BREAKDOWN: (Statistics related to handling of calls only)     <a href=\"$LINKbase&stage=$stage&file_download=1\">[DESCARGAR]</a>\n";

if ($show_percentages) {
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+$statusesHEAD\n";
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GRUPO DE USUARIOS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    | PAUSE %    |PAUSAVG | WAIT     | WAIT %     |WAITAVG | TALK     | TALK %     |TALKAVG | DISPO    | DISPO %    |DISPAVG | DEAD     | DEAD %     |DEADAVG | CUSTOMER | CUSTOMER % |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+----------+------------+--------+$statusesHEAD\n";
} else {
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
	$ASCII_text.="| <a href=\"$LINKbase\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | CURRENT GRUPO DE USUARIOS   | MOST RECENT USER GRP | <a href=\"$LINKbase&stage=LEADS\">CALLS</a>  | <a href=\"$LINKbase&stage=TIME\">TIME</a>      | PAUSE    |PAUSAVG | WAIT     |WAITAVG | TALK     |TALKAVG | DISPO    |DISPAVG | DEAD     |DEADAVG | CUSTOMER |CUSTAVG |$statusesHTML\n";
	$ASCII_text.="+-----------------+----------+----------------------+----------------------+--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
}
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>PAUSE CODE BREAKDOWN</caption><tr><th class='thgraph' scope='col'>ESTADO</th>";
...
$ASCII_text.="PAUSE CODE BREAKDOWN:     <a href=\"$LINKbase&stage=$stage&file_download=2\">[DESCARGAR]</a>\n\n";
$ASCII_text.="+-----------------+----------+----------------------+----------------------+----------+----------+----------+  +$sub_statusesHEAD\n";
$ASCII_text.="| USER NAME       | ID       | CURRENT GRUPO DE USUARIOS   | MOST RECENT USER GRP | TOTAL    | NONPAUSE | PAUSE    |  |$sub_statusesHTML\n";
$ASCII_text.="+-----------------+----------+----------------------+----------------------+----------+----------+----------+  +$sub_statusesHEAD\n";

$CSV_header="\"Agent Performance Detalle                        $NOW_TIME\"\n";
$CSV_header.="\"Time range: $query_date_BEGIN to $query_date_END\"\n\n";
$CSV_header.="\"PAUSE CODE BREAKDOWN:\"\n";
$CSV_header.="\"USER NAME\",\"ID\",\"CURRENT GRUPO DE USUARIOS\",\"MOST RECENT GRUPO DE USUARIOS\",\"TOTAL\",\"NONPAUSE\",\"PAUSE\",$CSV_statuses\n";
