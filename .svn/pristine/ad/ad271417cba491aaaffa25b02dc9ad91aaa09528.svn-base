...
if ($end_call > 0)
	...
	echo "Chamada finalizada &nbsp; &nbsp; &nbsp; $NOW_TIME\n<BR><BR>\n";
	...
	if ($lead_count > 0)
		...
		echo "<tr><td colspan=2>Vendor ID: $vendor_id &nbsp; &nbsp; ID da Campanha: $campaign_id</td></tr>\n";
		echo "<tr><td colspan=2>Fronter: $tsr &nbsp; &nbsp; ID da Lista: $list_id</td></tr>\n";
		...
		echo "<tr><td align=right>Tel. Alt. : </td><td align=left><input type=text name=alt_phone size=10 maxlength=10 value=\"$alt_phone\"></td></tr>\n";
		...
		echo "<tr><td align=right>Comentários : </td><td align=left><input type=text name=comments size=30 maxlength=255 value=\"$comments\"></td></tr>\n";
		...
		echo "<tr><td colspan=2><input type=submit name=submit value=\"FINAL. CHAM.\"></td></tr>\n";
		echo "</table></form>\n";
		echo "<BR><BR><BR>\n";
		}
	else
