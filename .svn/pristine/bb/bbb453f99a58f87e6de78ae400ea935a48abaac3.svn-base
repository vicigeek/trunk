...
if (!$group)
	...
	$ASCII_text="---------- PERFORMANCE Detalhess -------------\n";
	...
	for ($q=0; $q<count($rpt_date_array); $q++) 
		...
		$CSV_header2.='"CALLS","SALES","CONVERSÃO RATE TO CALLS","SALES PER HOUR","TIME",';
		...
		$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>$rpt_subtitle SUMMARY</caption><tr><th class='thgraph' scope='col'>USUÁRIOS</th>";
