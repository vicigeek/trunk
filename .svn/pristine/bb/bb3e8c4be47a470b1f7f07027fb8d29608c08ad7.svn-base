...
$HTML_text.="<INPUT TYPE=submit NAME=VALIDER VALUE=VALIDER>\n";
$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <a href=\"$PHP_SELF?query_date=$query_date&group=$group&shift=$shift&file_download=1\">TÉLÉCHARGER</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFIER</a> | <a href=\"./admin.php?ADD=999999\">RAPPORTS</a><BR/></FONT>\n";
$HTML_text.="</FORM>\n\n";
...
{
$HTML_text.="\n\n";
$HTML_text.="PLEASE SELECT AN IN-GROUP AND DATE ABOVE THEN CLICK VALIDER\n";
}
