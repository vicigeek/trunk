...
$HTML_text.="<a href=\"./admin.php?ADD=999999\">RAPPORTS</a>\n";
$HTML_text.="</FONT>\n";
...
$HTML_text.="VDL: IVR Filter Stats:           $NOW_TIME   <a href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&hourly_breakdown=$hourly_breakdown&DB=$DB&VALIDER=$VALIDER&file_download=1\">[TÉLÉCHARGER]</a>\n";
