...
$report_name = 'Listen Kampagne Status Report';
$db_source = 'M';
...
if (strlen($group[0]) < 1)
	...
	{
	$OUToutput = '';
	$OUToutput .= "Listen Kampagnenstatus Stats                             $NOW_TIME\n";
	...
	$OUToutput .= "+------------------+------------+----------+\n";
	$OUToutput .= "| Human Antwort     | $HA_count |  $HA_percent% |\n";
	...
	$CSV_text2 .= "\"Human Antwort\",\"$HA_count\",\"$HA_percent%\"\n";
	...
	$GRAPH.="  <tr>\n";
	$GRAPH.="	<td class=\"chart_td first\">Human Antwort</td>\n";
	...
	##############################
	#########  STATUS KATEGORIE STATS

	$OUToutput .= "\n";
	$OUToutput .= "---------- CUSTOM STATUS KATEGORIE STATS     <a href=\"$PHP_SELF?DB=$DB$groupQS&SUBMIT=$SUBMIT&file_download=3\">DOWNLOAD</a>\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";
	$OUToutput .= "| KATEGORIE             | CALLS      | DESCRIPTION                    |\n";
	$OUToutput .= "+----------------------+------------+--------------------------------+\n";

	$CSV_text3.="\"CUSTOM STATUS KATEGORIE STATS\"\n";
	$CSV_text3.="\"KATEGORIE\",\"CALLS\",\"DESCRIPTION\"\n";

	$max_calls=1; $graph_stats=array();
	$GRAPH.="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"DID Summary\" class=\"horizontalgraph\">\n";
	$GRAPH.="<caption align='top'>CUSTOM STATUS KATEGORIE STATS</caption>";
	$GRAPH.="<tr>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">KATEGORIE</th>\n";
	$GRAPH.="<th class=\"thgraph\" scope=\"col\">CALLS</th>\n";
	$GRAPH.="</tr>\n";
	...
	while ($i < $listids_to_print)
		...
		$STATUS_graph=$graph_header."<tr><th class='thgraph' scope='col'>STATUS</th><th class='thgraph' scope='col'>ZÄHLIMPULS</th></tr>";

		$CSV_text4.="\"LISTE IDENTIFIKATION: $LISTIDlists[$i]\",\"$LISTIDlist_names[$i]\",\"$LISTIDlist_active[$i]\"\n";
		...
		$FLAGS_graph.="  <tr><td class='chart_td first'>MENSCHLICHE ANTWORT</td><td nowrap class='chart_td value first'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$HA_count, $max_flags))."' height='16' />$HA_count ($HA_percent%)</td></tr>";
		...
		$CSV_text4.="\"Human Antwort:\",\"$HA_count\",\"$HA_percent%\"\n";
		...
		$CSV_text4.="\"Zeitlich geplante Wiederholungsbesuche:\",\"$SC_count\",\"$SC_percent%\"\n\n";
