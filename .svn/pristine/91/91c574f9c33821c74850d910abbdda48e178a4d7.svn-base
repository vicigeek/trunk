...
if( (strlen($user)<2) or (strlen($pass)<2) or (!$auth) or ($relogin == 'YES') )
	...
	echo "<TABLE><TR><TD></TD>\n";
	echo "<!-- ILPA -->\n";
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_tw/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">中文繁體 <img src=\"../agc/images/tw.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";	echo "</TR></TABLE>\n";
	...
	echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"../agc/images/agc_tab_astguiclient.gif\" 邊界=0></TD>";
...
echo "<html>\n";
echo "<head>\n";
echo "<!-- 版本: $version     版次: $build      ADD: $ADD-->\n";

if ( (strlen($phone_login)<2) or (strlen($phone_pass)<2) )
{
echo "<title>astGUIclient web client: 登入分機</title>\n";
echo "</head>\n";
echo "<BODY BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0>\n";
echo "<TABLE><TR><TD></TD>\n";
echo "<!-- ILPA -->\n";
...
echo "<BR><BR><BR><CENTER><TABLE WIDTH=360 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#CCC2E0\"><TR BGCOLOR=WHITE>";
echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"../agc/images/agc_tab_astguiclient.gif\" 邊界=0></TD>";
echo "<TD ALIGN=CENTER VALIGN=MIDDLE> 登入分機 </TD>";
echo "</TR>\n";
echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
echo "<TR><TD ALIGN=RIGHT>登入分機: </TD>";
echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=phone_login SIZE=10 maxlength=20 VALUE=\"$phone_login\"></TD></TR>\n";
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_tw/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">中文繁體 <img src=\"../agc/images/tw.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";	echo "</TR></TABLE>\n";
	...
	echo "<TD ALIGN=CENTER VALIGN=MIDDLE> 登入分機 </TD>";
	echo "</TR>\n";
	echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; <BR><FONT SIZE=3>抱歉，分機所輸入的帳號密碼於系統中尚未啟用，請再試一次: <BR> &nbsp; </TD></TR>\n";
	echo "<TR><TD ALIGN=RIGHT>登入分機: </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=phone_login SIZE=10 maxlength=20 VALUE=\"$phone_login\"></TD></TR>\n";
	echo "<TR><TD ALIGN=RIGHT>分機密碼:  </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=PASSWORD NAME=phone_pass SIZE=10 maxlength=20 VALUE=\"$phone_pass\"></TD></TR>\n";
...
?>
	...
	image_voicemail_OFF.src="../agc/images/agc_check_voicemail_OFF_tw.gif";
	var image_voicemail_ON = new Image();
	image_voicemail_ON.src="../agc/images/agc_check_voicemail_ON_tw.gif";
	var image_voicemail_BLINK = new Image();
	image_voicemail_BLINK.src="../agc/images/agc_check_voicemail_BLINK_tw.gif";
...
// ################################################################################
// ACTIVE EXTENSIONS LIST 更新 FUNCTIONS
...
// ################################################################################
// BUSY EXTENSIONS LIST 更新 FUNCTIONS
...
// ################################################################################
// Send Originate command for local dial to 經理sends phone name where call is going to
	...
	function liverecording_send_recording(taskvar,taskchan,taskspan,taskfile) 
		...
		if (xmlhttp) 
			...
			if (taskvar == 'Monitor')
				...
				var rec_start_html = "<a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + monitorchannelvalue + "','" + taskspan + "','" + filename + "');return false;\">停止錄音";
	...
	function conf_send_recording(taskconfrectype,taskconfspan,taskconfrec,taskconffile) 
		...
		if (xmlhttp) 
			...
			if (taskconfrectype == 'MonitorConf')
				...
				var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('StopMonitorConf','" + taskconfspan + "','" + taskconfrec + "','" + filename + "');return false;\">停止錄音</a>";
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	pause();
					...
					if (live_calls > 0)
						{
						var live_calls_HTML = "<font face=\"Arial,Helvetica\"><B>通話號碼清單:</B></font><BR><table width=100%><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">進端通道</td><td><font class=\"log_title\">遠端通道</td><td><font class=\"log_title\">RECORD</td><td><font class=\"log_title\">掛斷</td><td><font class=\"log_title\"轉接</td><td><font class=\"log_title\">PARK</td></tr>";
						...
						while (loop_ct < live_calls)
							...
							if (recLIST.match(regx)) 
								{live_calls_HTML = live_calls_HTML + "<span id=\"recordlive" + loop_ct + "\"><a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + channelfieldBtrunk_array[1] + "','recordlive" + loop_ct + "');return false;\">停止錄音</span>";}
							else 
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (out_calls > 0)
						{
						var out_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通話日期\/時間</td><td><font class=\"log_title\">號碼</td><td align=right><font class=\"log_title\">LENGTH (M:SS)</td><td><font class=\"log_title\"> </td></tr>"
					...
					if (in_calls > 0)
						{
						var in_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通話日期\/時間</td><td><font class=\"log_title\">IN-NUMMER</td><td COLSPAN=2><font class=\"log_title\">CALLERID</td><td align=right><font class=\"log_title\">LENGTH</td><td><font class=\"log_title\"> </td></tr>"
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (parked_count > 0)
						{
						var park_HTML = "<table width=600><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">CHANNEL<BR>&nbsp; 撥號 ID</td><td><font class=\"log_title\">PARKED BY<BR>&nbsp; PARKED TIME</td><td><font class=\"log_title\">掛斷</td><td><font class=\"log_title\"轉接</td><td><font class=\"log_title\">接起</td></tr>"
						while (loop_ct < parked_count)
							...
							park_HTML = park_HTML + "<tr bgcolor=\"" + row_color + "\"><td><font class=\"log_text\">" + loop_ct + "</td><td><font class=\"log_text\">" + park_channel + "<BR>&nbsp; " + park_call_id + "</td><td><font class=\"log_text\">" + parked_by + "<BR>&nbsp; " + parked_time + "</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"livehangup_send_hangup('" + park_channel + "');return false;\">掛斷</a></td><td><font class=\"log_text\"><a href=\"#\" onclick=\"showMainXfeR('MainXfeRBox','" + park_channel + "');return false;\"轉接</a></td><td><font class=\"log_text\"><a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + park_channel + "');return false;\">接起</a></td></tr>";
...
// display general conference meetme room header info and refresh detail content
	function conference_header_display(taskconf,taskreg,taskrefresh)
		...
		var conf_head_HTML = "<font class=\"sh_text\">會議 " + head_conf + "</b></font><font class=\"sb_text\">&nbsp; &nbsp; 註冊至: " + head_reg + " &nbsp; " + reglink + " &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"basic_originate_call('" + head_conf + "','NO','NO');return false;\">進入電話會議 </a><BR><a href=\"#\" onclick=\"check_for_conf_calls('" + head_conf + "','1');return false;\">更新 </a> &nbsp; &nbsp; <span id=\"conf_rec_link\"><a href=\"#\" onclick=\"conf_send_recording('MonitorConf','conf_rec_link','" + head_conf + "');return false;\">Record</a></span> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dtmf STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendConfDTMF(" + head_conf + ");\">傳送 DTMF</A> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dial STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendManualDial('YES'," + head_conf + ");\">由電話會議中撥號</A><BR></font>";
				...
				//	alert(xmlhttp.responseText);
					...
					var conf_chan_array = check_conf_array[1].split(" ~");
					   if (live_conf_calls > 0)
						...
						var conv_start=-1;
						var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>多方通話中的參與號碼:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">遠端通道</TD><TD><font class=\"log_title\">掛斷</TD><TD><font class=\"log_title\"轉接</TD></TR>";
...
// ################################################################################
// Send Originate command to manager to direct user to 語音信箱
...
//('BuilD','ADD','REMOVE','UP','DOWN')
	...
	//		alert(favorites_listEDIT);
		...
		var favedit_HTML = "<center><table cellpadding=5 cellspacing=5 width=750><tr><td colspan=2 align=center bgcolor=\"#DDDD99\"><B>有空閒的分機</B></td><td align=center bgcolor=\"#CCCC99\"><B> 我的最愛</B></td></tr><tr><td bgcolor=\"#DDDD99\" height=380 width=200 valign=top><font class=\"ss_text\"><span id=FavSelectA>";
		loop_ct = 0;
...
// Log the user out of the system, if active call or active dial is occuring, don't let them.
	function LogouT()
		...
		document.getElementById("LogouTBoxLink").innerHTML = "<a href=\"" + agcPAGE + "?relogin=YES&session_epoch=" + epoch_sec + "&session_name=" + session_name + "&user=" + user + "&pass=" + pass + "&user=" + user + "&phone_login=" + phone_login + "&phone_pass=" + phone_pass + "\">按此重新登入</a>\n";
...
<TABLE 邊界=0 CELLPADDING=0 CELLSPACING=0 BGCOLOR=white WIDTH=640 MARGINWIDTH=0 MARGINHEIGHT=0 LEFTMARGIN=0 TOPMARGIN=0 VALIGN=TOP ALIGN=LEFT>
<TR VALIGN=TOP ALIGN=LEFT><TD COLSPAN=5 VALIGN=TOP ALIGN=LEFT>
<INPUT TYPE=HIDDEN NAME=extension>
<font class="body_text">
<?php	echo "歡迎 $LOGfullname, 您已登入此分機: $fullname - $protocol/$extension on $server_ip &nbsp; <a href=\"#\" onclick=\"LogouT();return false;\">登出</a><BR>\n"; ?>
</TD></TR>
<TR VALIGN=TOP ALIGN=LEFT>
<TD><A HREF="#" onclick="MainPanelToFront();"><IMG SRC="../agc/images/agc_tab_main_tw.gif" ALT="主控台" WIDTH=83 HEIGHT=30 邊界=0></A></TD>
<TD><A HREF="#" onclick="ActiveLinesPanelToFront();"><IMG SRC="../agc/images/agc_tab_active_lines_tw.gif" ALT="現行線路控制台" WIDTH=139 HEIGHT=30 邊界=0></A></TD>
<TD><A HREF="#" onclick="ConfereNcesPanelToFront();"><IMG SRC="../agc/images/agc_tab_conferences_tw.gif" ALT="電話會議控制台" WIDTH=139 HEIGHT=30 邊界=0></A></TD>
<TD><A HREF="#" onclick="SendCheckVoiceMail();"><IMG SRC="../agc/images/agc_check_voicemail_ON_tw.gif" NAME=voicemail ALT="檢視語音信箱" WIDTH=170 HEIGHT=30 邊界=0></A></TD>
<TD><IMG SRC="../agc/images/agc_live_call_OFF.gif" NAME=livecall ALT="通話中電話" WIDTH=109 HEIGHT=30 邊界=0></TD>
</TR></TABLE>
</SPAN>
...
<span style="position:absolute;left:0px;top:12px;z-index:29;" id="TrunkHangupBox">
    <table border=1 bgcolor="#CDE0C2" width=600 height=500><TR><TD> TRUNK 掛斷 <BR><BR>
	<span id="TrunkHangupContent"> Active Trunks Menu </span><BR>
	<span id="TrunkHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Trunk');return false;">掛斷 Trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','HIJACK');return false;">介入 Trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','LISTEN');return false;">監聽 Trunk</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busytrunkhangup_force_refresh();return false;">更新</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideTrunkHangup('TrunkHangupBox');">回主畫面</a>
	</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:12px;z-index:28;" id="LocalHangupBox">
    <table border=1 bgcolor="#CDE0C2" width=600 height=500><TR><TD> LOCAL 掛斷 <BR><BR>
	<span id="LocalHangupContent"> 啟用Local畫面 </span><BR>
	<span id="LocalHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Local');return false;">掛斷 Local</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Local');return false;">介入 Local</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Local','LISTEN');return false;">監聽 Local</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busylocalhangup_force_refresh();return false;">更新</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideLocalHangup('LocalHangupBox');">回主畫面</a>
	</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:80px;top:12px;z-index:42;" id="MainXfeRBox">
    ...
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 來電轉接</b> <BR>通話已被轉接: <span id="MainXfeRChanneL">Channel</span><BR></tr>
	<tr><td>分機:<BR><span id="MainXfeRContent"> 分機表 </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_redirect('XfeR');return false;">傳送給所選分機</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('VMAIL');return false;">傳送給所選語音信箱</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('ENTRY');return false;">傳送至該號碼</a>:<BR><input type=text name=extension_xfer_entry size=20 maxlength=50> <BR><BR>
	<a href="#" onclick="getactiveext('MainXfeRBox');return false;">更新</a> <BR><BR><BR>
	<a href="#" onclick="hideMainXfeR('MainXfeRBox');">回主畫面</a> <BR><BR>
	</TD>
	<TD>會議:<BR><font size=1>(點選號碼以送出會議邀請n)<BR><input type=checkbox name=MainXfeRconfXTRA size=1 value="1"> 傳送我的CHANNEL<div class="scroll_list" id="MainXfeRconfContent"> 電話會議功能 </div></td></TR></TABLE>
</span>

<span style="position:absolute;left:80px;top:12px;z-index:43;" id="LocalDialBox">
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 撥給LOCAL分機</b> <BR>電話來源: <span id="LocalDialChanneL">Channel</span><BR></tr>
	<tr><td>分機:<BR><span id="LocalDialContent"> 分機表 </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_originate('DiaL','','');return false;">撥打所選分機</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_originate('VMAIL');return false;">撥打所選語音信箱</a> <BR><BR>
	<a href="#" onclick="getactiveext('LocalDialBox');return false;">更新</a> <BR><BR><BR>
	<a href="#" onclick="hideLocalDial('LocalDialBox');">回主畫面</a> <BR><BR>
	</TD>
	<TD></td></TR></TABLE>
</span>

<span style="position:absolute;left:40px;top:12px;z-index:41;" id="ParkDisplayBox">
    <table border=0 bgcolor="#FFFFCC" width=640 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> PARKED 撥號S:</b> <div class="scroll_park" id="ParkDisplayContents"></div>
	<a href="#" onclick="hideParkDisplay('ParkDisplayBox');">回主畫面</a> <BR><BR>
	</td></TR></TABLE>
</span>
...
<tr><td align=center><font face="Arial,Helvetica"><B>語音信箱 &nbsp; &nbsp; </B></font> 新: <span id="new_vmail_span"></span> &nbsp; &nbsp; 舊: <span id="old_vmail_span"></span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font face="Arial,Helvetica"><B>人工撥號 &nbsp; &nbsp; &nbsp; </B></font><input TYPE=TEXT SIZE=20 NAME=manual_dial STYLE="font-family : sans-serif; font-size : 10px"> <A HREF="#" onclick="SendManualDial();">DIAL</A></td></tr>

<tr><td align=center><a href="#" onclick="showParkDisplay('ParkDisplayBox');return false;"><font face="Arial,Helvetica"><B>PARKED 撥號S</B></a>:  <span id="parked_calls_count">0</span> &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="#" onclick="showLocalDial('LocalDialBox');return false;"><font face="Arial,Helvetica"><B>LOCAL撥打分機</a></td></tr>

<tr><td align=center><font face="Arial,Helvetica"><B>外撥電話:</B></font></td></tr>
<tr><td align=center><div class="scroll_log" id="outboundcallsspan"></div></td></tr>
<tr><td align=center><font face="Arial,Helvetica"><B>進線電話:</B></font></td></tr>
<tr><td align=center><div class="scroll_log" id="inboundcallsspan"></div></td></tr>
<tr><td align=left><font face="Arial,Helvetica" size=1>astGUIclient web-client版本:<?php echo $version ?> 版次:<?php echo $build ?></font></td></tr>
</TABLE>

<span style="position:absolute;left:640px;top:0px;z-index:33;" id="FavoriteSBox">
    <table border=0 bgcolor="#DDDDFF" width=200 height=400 cellpadding=2 ALIGN=TOP><TR><TD align=center><span id="FavoriteSContent"><font class="sh_text"> 我的最愛</font><font class="sb_text"> &nbsp; &nbsp; &nbsp; <a href="#" onclick="favorites_editor('BuilD');return false;"> 編輯</a></span></TD></TR>
<?php
	$h=0;
	while ($favorites_count > $h)
	{
...
<span style="position:absolute;left:5px;top:5px;z-index:34;" id="FavoriteSEdiT">
    <table border=0 bgcolor="#DDDDFF" width=800 height=450 cellpadding=2 ALIGN=TOP><TR HEIGHT=95%><TD align=center HEIGHT=95%><span id="FavoriteSEditContent"> 我的最愛</span></TD></TR>
	<TR><TD ALIGN=CENTER><BR> &nbsp; </TD></TR>
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="SubmiT_FavoritE_ChangEs();return false;">確認送出我的最愛變更 - 需要登出</a></TD></TR>
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="hideDiv('FavoriteSEdiT');return false;">回到主視窗 - 忽略變更</a></TD></TR>
	</TABLE>
</span>
...
<tr><td colspan=3>
<a href="#" onclick="pause();return false;">STOP</a> | <a href="#" onclick="start();return false;">START</a> &nbsp; &nbsp; 更新比例: <span id="refresh_rate">1000 ms</span> <a href="#" onclick="faster();return false;">較快速</a> | <a href="#" onclick="slower();return false;">較慢速</a></p>
	<div id="status"><em>起始中..</em></div>
</td></tr>
<tr><td>使用中分機 <BR> 
<a href="#" onclick="activeext_force_refresh();return false;">更新</a> | 
<span id="activeext_order"><a href="#" onclick="activeext_order_desc();return false;">次序</a> | </span>
</td>

<td>外線 <BR>
<a href="#" onclick="busytrunk_force_refresh();return false;">更新</a> | 
<span id="busytrunk_order"><a href="#" onclick="busytrunk_order_desc();return false;">次序</a> | </span>
</td>

<td>區域分機 <BR>
<a href="#" onclick="busyext_force_refresh();return false;">更新</a> | 
<span id="busyext_order"><a href="#" onclick="busyext_order_desc();return false;">次序</a> | </span>
</td></tr>

<tr><td VALIGN=TOP>
	<span id="activeext"><em>資料至此</em></span><BR><BR>
</td><td VALIGN=TOP>
	<span id="busytrunk"><em>資料至此</em></span><BR><BR><span id="TrunkHangupLink"><a href="#" onclick="showTrunkHangup('TrunkHangupBox');return false;">Trunk 活動</a></span>
</td><td VALIGN=TOP>
	<span id="busyext"><em>資料至此</em></span><BR><BR><span id="LocalHangupLink"><a href="#" onclick="showLocalHangup('LocalHangupBox');return false;">Local 活動</a></span>
</td></tr>
...
<span id="ConfereNcesListContent">電話會議列表 </span>
</span>
...
<span style="width:540;height:400;" id="ConfereNceDetailContent">點選會議室左方可瀏覽相關資訊 </span>
</span>
