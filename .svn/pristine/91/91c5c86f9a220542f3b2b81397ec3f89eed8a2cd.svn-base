...
$report_name='Χρήστης Ομαδοποιημένα Ωριαία Στατιστικά';
...
<title>ADMINISTRATION: Ομαδοποιημένα Ωριαία Στατιστικά
<?php
...
<CENTER>
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; Ομαδοποιημένα Ωριαία Στατιστικά <?php echo $group ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; </TD></TR>
...
echo "<br>Παρακαλώ, καταχωρήστε την ομάδα για την οποία θέλετε στατιστικά ανά ώρα: <form action=$PHP_SELF method=GET>\n";
