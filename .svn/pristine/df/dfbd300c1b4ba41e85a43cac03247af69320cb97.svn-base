...
if( (strlen($user)<2) or (strlen($pass)<2) or (!$auth) or ($relogin == 'YES') )
	...
	echo "<TABLE><TR><TD></TD>\n";
	echo "<!-- ILPA -->\n";
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_dk/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">Dansk <img src=\"../agc/images/dk.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";	echo "</TR></TABLE>\n";
...
{
echo "<title>web client astGUIclient: Telefon login</title>\n";
echo "</head>\n";
echo "<BODY BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0>\n";
echo "<TABLE><TR><TD></TD>\n";
echo "<!-- ILPA -->\n";
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_dk/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">Dansk <img src=\"../agc/images/dk.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";	echo "</TR></TABLE>\n";
	...
	echo "<TD ALIGN=CENTER VALIGN=MIDDLE> Telefon login </TD>";
	echo "</TR>\n";
	echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; <BR><FONT SIZE=3>Beklager din telefonlogin/password er ikke aktive på dette system, prøv igen: <BR> &nbsp; </TD></TR>\n";
	echo "<TR><TD ALIGN=RIGHT>Telefon login: </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=phone_login SIZE=10 maxlength=20 VALUE=\"$phone_login\"></TD></TR>\n";
	echo "<TR><TD ALIGN=RIGHT>Telefon password:  </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=PASSWORD NAME=phone_pass SIZE=10 maxlength=20 VALUE=\"$phone_pass\"></TD></TR>\n";
...
// ################################################################################
// ACTIVE EXTENSIONS LIST GENOPFRISK FUNCTIONS
...
// ################################################################################
// BUSY TRUNK LIST GENOPFRISK FUNCTIONS
...
// ################################################################################
// BUSY EXTENSIONS LIST GENOPFRISK FUNCTIONS
	...
	function busyhangup_send_redirect(taskvar,tasktrunkaction) 
		...
		if (tasktrunkaction == 'LISTEN')
			...
			if (listenvalue.match(regLa))
				...
				{
				bsr_continue=0;
				alert("Du kan kun medlytte zap kanaler:\n" + listenvalue);
				}
			}
		if (bsr_continue == '1')
			{
...
// ################################################################################
// Send Originate command for local dial to Din ledersends phone name where call is going to
	...
	function liverecording_send_recording(taskvar,taskchan,taskspan,taskfile) 
		...
		if (xmlhttp) 
			...
			if (taskvar == 'Monitor')
				...
				var rec_start_html = "<a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + monitorchannelvalue + "','" + taskspan + "','" + filename + "');return false;\">Stop indspillning";
	...
	function conf_send_recording(taskconfrectype,taskconfspan,taskconfrec,taskconffile) 
		...
		if (xmlhttp) 
			...
			if (taskconfrectype == 'MonitorConf')
				...
				var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('StopMonitorConf','" + taskconfspan + "','" + taskconfrec + "','" + filename + "');return false;\">Stop indspillning</a>";
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	pause();
					...
					if (live_calls > 0)
						{
						var live_calls_HTML = "<font face=\"Arial,Helvetica\"><B>Denne telefons aktive samtaler:</B></font><BR><table width=100%><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">KUNDE KANAL</td><td><font class=\"log_title\">REMOTE KANAL</td><td><font class=\"log_title\">RECORD</td><td><font class=\"log_title\">LÆGPÅ</td><td><font class=\"log_title\">XFER</td><td><font class=\"log_title\">PARK</td></tr>";
						...
						while (loop_ct < live_calls)
							...
							if (recLIST.match(regx)) 
								{live_calls_HTML = live_calls_HTML + "<span id=\"recordlive" + loop_ct + "\"><a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + channelfieldBtrunk_array[1] + "','recordlive" + loop_ct + "');return false;\">Stop indspillning</span>";}
							else 
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (out_calls > 0)
						{
						var out_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> OPKALD DATO\/TID</td><td><font class=\"log_title\">NUMMER</td><td align=right><font class=\"log_title\">LENGTH (M:SS)</td><td><font class=\"log_title\"> </td></tr>"
					...
					if (in_calls > 0)
						{
						var in_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> OPKALD DATO\/TID</td><td><font class=\"log_title\">IN-NUMMER</td><td COLSPAN=2><font class=\"log_title\">CALLERID</td><td align=right><font class=\"log_title\">LENGTH</td><td><font class=\"log_title\"> </td></tr>"
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (parked_count > 0)
						{
						var park_HTML = "<table width=600><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">CHANNEL<BR>&nbsp; OPKALD ID</td><td><font class=\"log_title\">SAT PÅ VENT AF<BR>&nbsp; VENTETID</td><td><font class=\"log_title\">LÆGPÅ</td><td><font class=\"log_title\">XFER</td><td><font class=\"log_title\">LØFT</td></tr>"
...
// display general conference meetme room header info and refresh detail content
	function conference_header_display(taskconf,taskreg,taskrefresh)
		...
		var conf_head_HTML = "<font class=\"sh_text\">konference " + head_conf + "</b></font><font class=\"sb_text\">&nbsp; &nbsp; Registrered til: " + head_reg + " &nbsp; " + reglink + " &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"basic_originate_call('" + head_conf + "','NO','NO');return false;\">Medvirk i konference </a><BR><a href=\"#\" onclick=\"check_for_conf_calls('" + head_conf + "','1');return false;\">Genopfrisk </a> &nbsp; &nbsp; <span id=\"conf_rec_link\"><a href=\"#\" onclick=\"conf_send_recording('MonitorConf','conf_rec_link','" + head_conf + "');return false;\">Record</a></span> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dtmf STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendConfDTMF(" + head_conf + ");\">Send DTMF</A> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dial STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendManualDial('YES'," + head_conf + ");\">Ring fra Konf</A><BR></font>";
				...
				//	alert(xmlhttp.responseText);
					...
					var conf_chan_array = check_conf_array[1].split(" ~");
					   if (live_conf_calls > 0)
						...
						var conv_start=-1;
						var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>PÅGÅENDE SAMTALER I DENNA konference:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">REMOTE KANAL</TD><TD><font class=\"log_title\">LÆGPÅ</TD><TD><font class=\"log_title\">XFER</TD></TR>";
...
//('BuilD','ADD','REMOVE','UP','DOWN')
	...
	//		alert(favorites_listEDIT);
		...
		var favedit_HTML = "<center><table cellpadding=5 cellspacing=5 width=750><tr><td colspan=2 align=center bgcolor=\"#DDDD99\"><B>TILGÆNGLIGE LINJER</B></td><td align=center bgcolor=\"#CCCC99\"><B> FAVORITER</B></td></tr><tr><td bgcolor=\"#DDDD99\" height=380 width=200 valign=top><font class=\"ss_text\"><span id=FavSelectA>";
		loop_ct = 0;
...
// Log the user out of the system, if active call or active dial is occuring, don't let them.
	function LogouT()
		...
		document.getElementById("LogouTBoxLink").innerHTML = "<a href=\"" + agcPAGE + "?relogin=YES&session_epoch=" + epoch_sec + "&session_name=" + session_name + "&user=" + user + "&pass=" + pass + "&user=" + user + "&phone_login=" + phone_login + "&phone_pass=" + phone_pass + "\">KLIK HER FOR AT LOGGE PÅ IGEN</a>\n";
...
<?php	echo "Velkommen $LOGfullname, Du er pålogget denne telefon: $fullname - $protocol/$extension på $server_ip &nbsp; <a href=\"#\" onclick=\"LogouT();return false;\">LOGUD</a><BR>\n"; ?>
</TD></TR>
<TR VALIGN=TOP ALIGN=LEFT>
<TD><A HREF="#" onclick="MainPanelToFront();"><IMG SRC="../agc/images/agc_tab_main.gif" ALT="Hoved Panel" WIDTH=83 HEIGHT=30 Border=0></A></TD>
<TD><A HREF="#" onclick="ActiveLinesPanelToFront();"><IMG SRC="../agc/images/agc_tab_active_lines.gif" ALT="Aktive linjer" WIDTH=139 HEIGHT=30 Border=0></A></TD>
<TD><A HREF="#" onclick="ConfereNcesPanelToFront();"><IMG SRC="../agc/images/agc_tab_conferences.gif" ALT="konference panel" WIDTH=139 HEIGHT=30 Border=0></A></TD>
...
<TD><IMG SRC="../agc/images/agc_live_call_OFF.gif" NAME=livecall ALT="Aktive samtaler" WIDTH=109 HEIGHT=30 Border=0></TD>
</TR></TABLE>
</SPAN>
...
<span style="position:absolute;left:0px;top:12px;z-index:29;" id="TrunkHangupBox">
    <table border=1 bgcolor="#CDE0C2" width=600 height=500><TR><TD> TRUNK dille <BR><BR>
	<span id="TrunkHangupContent"> Active Trunks Menu </span><BR>
	<span id="TrunkHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Trunk');return false;">Læg på trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','HIJACK');return false;">Overtage trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','LISTEN');return false;">Lytte trunk</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busytrunkhangup_force_refresh();return false;">Genopfrisk</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideTrunkHangup('TrunkHangupBox');">Tilbage til hovedvinduet</a>
	</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:12px;z-index:28;" id="LocalHangupBox">
    <table border=1 bgcolor="#CDE0C2" width=600 height=500><TR><TD> LÆG PÅ LOKALT <BR><BR>
	<span id="LocalHangupContent"> Aktive lokal menu </span><BR>
	<span id="LocalHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Local');return false;">Læg på lokal</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Local');return false;">Overtage lokal</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Local','LISTEN');return false;">lytte lokal</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busylocalhangup_force_refresh();return false;">Genopfrisk</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideLocalHangup('LocalHangupBox');">Tilbage til hovedvinduet</a>
	</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:80px;top:12px;z-index:42;" id="MainXfeRBox">
    ...
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> VIDERESTILLING AF PÅGÅENDE SAMTALE</b> <BR>Kanal at viderestille: <span id="MainXfeRChanneL">Channel</span><BR></tr>
	<tr><td>Linjer:<BR><span id="MainXfeRContent"> Lokalnummer menu </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_redirect('XfeR');return false;">Send til valgt lokalnummer</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('VMAIL');return false;">Send til valgt voicemail</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('ENTRY');return false;">Send til dette nummer</a>:<BR><input type=text name=extension_xfer_entry size=20 maxlength=50> <BR><BR>
	<a href="#" onclick="getactiveext('MainXfeRBox');return false;">Genopfrisk</a> <BR><BR><BR>
	<a href="#" onclick="hideMainXfeR('MainXfeRBox');">Tilbage til hovedvinduet</a> <BR><BR>
	</TD>
	<TD>konferencer:<BR><font size=1>(klik på et nummer forneden for at sende til en konference)<BR><input type=checkbox name=MainXfeRconfXTRA size=1 value="1"> Send min kanal også<div class="scroll_list" id="MainXfeRconfContent"> konference Menu </div></td></TR></TABLE>
</span>

<span style="position:absolute;left:80px;top:12px;z-index:43;" id="LocalDialBox">
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> Lokal numre opkald</b> <BR>Telefon ringer fra: <span id="LocalDialChanneL">Channel</span><BR></tr>
	<tr><td>Linjer:<BR><span id="LocalDialContent"> Lokalnummer menu </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_originate('DiaL','','');return false;">Ring valgt forbindelse</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_originate('VMAIL');return false;">Ring valgt voicemail</a> <BR><BR>
	<a href="#" onclick="getactiveext('LocalDialBox');return false;">Genopfrisk</a> <BR><BR><BR>
	<a href="#" onclick="hideLocalDial('LocalDialBox');">Tilbage til hovedvinduet</a> <BR><BR>
	</TD>
	<TD></td></TR></TABLE>
</span>

<span style="position:absolute;left:40px;top:12px;z-index:41;" id="ParkDisplayBox">
    <table border=0 bgcolor="#FFFFCC" width=640 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> SAMTALE SAT PÅ VENT:</b> <div class="scroll_park" id="ParkDisplayContents"></div>
	<a href="#" onclick="hideParkDisplay('ParkDisplayBox');">Tilbage til hovedvinduet</a> <BR><BR>
	</td></TR></TABLE>
</span>
...
<tr><td align=center><font face="Arial,Helvetica"><B>VOICEMAIL &nbsp; &nbsp; </B></font> NY: <span id="new_vmail_span"></span> &nbsp; &nbsp; GAMMEL: <span id="old_vmail_span"></span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font face="Arial,Helvetica"><B>MANUELT OPKALD &nbsp; &nbsp; &nbsp; </B></font><input TYPE=TEXT SIZE=20 NAME=manual_dial STYLE="font-family : sans-serif; font-size : 10px"> <A HREF="#" onclick="SendManualDial();">DIAL</A></td></tr>

<tr><td align=center><a href="#" onclick="showParkDisplay('ParkDisplayBox');return false;"><font face="Arial,Helvetica"><B>SAMTALE SAT PÅ VENT</B></a>:  <span id="parked_calls_count">0</span> &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="#" onclick="showLocalDial('LocalDialBox');return false;"><font face="Arial,Helvetica"><B>LOKALNUMRE</a></td></tr>

<tr><td align=center><font face="Arial,Helvetica"><B>UDGÅENDE OPKALD:</B></font></td></tr>
<tr><td align=center><div class="scroll_log" id="outboundcallsspan"></div></td></tr>
<tr><td align=center><font face="Arial,Helvetica"><B>INDKOMMENDE OPKALD:</B></font></td></tr>
<tr><td align=center><div class="scroll_log" id="inboundcallsspan"></div></td></tr>
<tr><td align=left><font face="Arial,Helvetica" size=1>astGUIclient web-klient VERSION:<?php echo $version ?> BUILD:<?php echo $build ?></font></td></tr>
</TABLE>

<span style="position:absolute;left:640px;top:0px;z-index:33;" id="FavoriteSBox">
    <table border=0 bgcolor="#DDDDFF" width=200 height=400 cellpadding=2 ALIGN=TOP><TR><TD align=center><span id="FavoriteSContent"><font class="sh_text"> FAVORITER</font><font class="sb_text"> &nbsp; &nbsp; &nbsp; <a href="#" onclick="favorites_editor('BuilD');return false;"> edit</a></span></TD></TR>
<?php
	$h=0;
	while ($favorites_count > $h)
	{
...
<span style="position:absolute;left:5px;top:5px;z-index:34;" id="FavoriteSEdiT">
	...
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="SubmiT_FavoritE_ChangEs();return false;">ANGIV VALG AF FAVORITER - udlogning er påkrævet</a></TD></TR>
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="hideDiv('FavoriteSEdiT');return false;">TILBAGE TIL HOVEDVINDUE - gem ikke ændringer</a></TD></TR>
	</TABLE>
</span>
...
<tr><td colspan=3>
<a href="#" onclick="pause();return false;">STOP</a> | <a href="#" onclick="start();return false;">START</a> &nbsp; &nbsp; Genopfrisk hyppighed: <span id="refresh_rate">1000 ms</span> <a href="#" onclick="faster();return false;">hurtigt</a> | <a href="#" onclick="slower();return false;">langsomt</a></p>
	<div id="status"><em>opstart..</em></div>
</td></tr>
<tr><td>Aktive forbindelser <BR> 
<a href="#" onclick="activeext_force_refresh();return false;">GENOPFRISK</a> | 
<span id="activeext_order"><a href="#" onclick="activeext_order_desc();return false;">ORDER</a> | </span>
</td>

<td>Externe linjer <BR>
<a href="#" onclick="busytrunk_force_refresh();return false;">GENOPFRISK</a> | 
<span id="busytrunk_order"><a href="#" onclick="busytrunk_order_desc();return false;">ORDER</a> | </span>
</td>

<td>Lokalforbindelser <BR>
<a href="#" onclick="busyext_force_refresh();return false;">GENOPFRISK</a> | 
<span id="busyext_order"><a href="#" onclick="busyext_order_desc();return false;">ORDER</a> | </span>
</td></tr>

<tr><td VALIGN=TOP>
	<span id="activeext"><em>Data placeres her</em></span><BR><BR>
</td><td VALIGN=TOP>
	<span id="busytrunk"><em>Data placeres her</em></span><BR><BR><span id="TrunkHangupLink"><a href="#" onclick="showTrunkHangup('TrunkHangupBox');return false;">Trunk handling</a></span>
</td><td VALIGN=TOP>
	<span id="busyext"><em>Data placeres her</em></span><BR><BR><span id="LocalHangupLink"><a href="#" onclick="showLocalHangup('LocalHangupBox');return false;">Lokal handling</a></span>
</td></tr>
...
<span id="ConfereNcesListContent">konference liste </span>
</span>
...
<span style="width:540;height:400;" id="ConfereNceDetailContent">Klik på et konference nummer til venstre for info vdr den konference </span>
</span>
