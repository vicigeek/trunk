...
$report_name = 'UtenteOrologio Report';
$db_source = 'M';
...
$MAIN.="<font class=\"select_bold\"><B>Date:</B></font><BR><CENTER>\n";
...
$MAIN.="<font class=\"select_bold\"><B>Gruppi Utenti:</B></font><BR><CENTER>\n";
...
$MAIN.="</TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="<font class=\"select_bold\"><B>Utente:</B></font><BR>\n";
$MAIN.="<INPUT TYPE=text NAME=user SIZE=7 MAXLENGTH=20 VALUE=\"$user\">\n";

$MAIN.="<BR><BR><INPUT TYPE=Submit NAME=INVIA VALUE=INVIA>\n";
$MAIN.="</TD></TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="</TD><TD ALIGN=CENTER VALIGN=TOP ROWSPAN=3>\n";	
$MAIN.="<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB$user_groupQS&query_date=$query_date&end_date=$end_date&order=$order&user=$user&INVIA=$INVIA&file_download=1\">DOWNLOAD</a><FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; | &nbsp; <a href=\"./admin.php?ADD=999999\">REPORT</a> </FONT>\n";
...
$MAIN.="UtenteOrologio Report                        $NOW_TIME\n";

$CSV_text.="\"UtenteOrologio Report - $NOW_TIME\"\n";
$CSV_text.="\"Intervallo Di Tempo: $query_date to $end_date\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	{
	$MAIN.="Intervallo Di Tempo: $query_date to $end_date\n\n";
	...
	$MAIN.="<TD ALIGN=LEFT COLSPAN=4><FONT class=\"data_records\">TOTALI</TD>\n";
	$MAIN.="<TD ALIGN=RIGHT><FONT class=\"data_records_fix\"> $TOThours</TD>\n";
	$MAIN.="</TR>\n";
	$CSV_text.="\"\",\"TOTALI\",\"\",\"\",\"\",\"$TOThours\"\n";
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"INVITO hangup MOTIVO STATS\" class=\"horizontalgraph\">\n";
	$MAIN.="  <caption align=\"top\">USER TIMECLOCK DETAILS<br /><font size='-1'>Intervallo Di Tempo: $query_date to $end_date<br/>These totals do NOT include any active sessions</font><br /></caption>\n";
	$MAIN.="  <tr>\n";
	...
	for ($i=0; $i<count($ct_ary); $i++) {
		...
		$MAIN.="	<td class=\"chart_td value$class\"><img src=\"../vicidial/images/bar.png\" alt=\"\" width=\"".round(MathZDC(400*$ct_ary[$i][1], $high_ct))."\" height=\"16\" />".$ct_ary[$i][1]."</td>\n";
		$MAIN.="  </tr>\n";
	}
	$MAIN.="  <tr>\n";
