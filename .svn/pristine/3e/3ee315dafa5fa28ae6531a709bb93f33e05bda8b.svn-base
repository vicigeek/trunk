...
$HTML_text.="<a href=\"./admin.php?ADD=999999\">REPORT</a>\n";
$HTML_text.="</FONT>\n";
...
$HTML_text.="VDL: IVR Filter Stats:           $NOW_TIME   <a href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&hourly_breakdown=$hourly_breakdown&DB=$DB&INVIA=$INVIA&file_download=1\">[DOWNLOAD]</a>\n";
...
$Utotalsta=0;
	...
	$HTML_text.="\n";
	$HTML_text.="+------------------------------+-------------------------+-----------------------------------------------------+-------------------------+-------------------------+-------------------------+-------------------------+\n";
	$HTML_text.="|                              |          TOTALI         |              SENT TO QUEUE                          |   CALLERID NOT FOUND    |       PREVIOUS DNC      |       PREVIOUS SALE     |       ARCHIVE ONLY      |\n";
	$HTML_text.="|                              +--------+--------+-------+----------------------+----------------------+-------+--------+--------+-------+--------+--------+-------+--------+--------+-------+--------+--------+-------+\n";
	$HTML_text.="| HOURS                        | CALLS  | UNIQUE |     % | CALLS**              | UNIQUE**             |     % | CALLS  | UNIQUE |     % | CALLS  | UNIQUE |     % | CALLS  | UNIQUE |     % | CALLS  | UNIQUE |     % |\n";
	$HTML_text.="+------------------------------+--------+--------+-------+----------------------+----------------------+-------+--------+--------+-------+--------+--------+-------+--------+--------+-------+--------+--------+-------+\n";
	
	$CSV_text.="\n";
	$CSV_text.="\"\",\"\",\"TOTALI\",\"\",\"\",\"SENT TO QUEUE\",\"\",\"\",\"CALLERID NOT FOUND\",\"\",\"\",\"PREVIOUS DNC\",\"\",\"\",\"PREVIOUS SALE\",\"\",\"\",\"ARCHIVE ONLY\",\n";
...
#	$CSV_text.="\"TOTALS\",\"$total\",\"$Utotal\",\"n/a\",\"$queue_str\",\"$Uqueue_str\",\"$UtotalPERCENT\",\"".$count_ary[$key][2]."\",\"".$count_ary[$key][3]."\",\"$UagentPERCENT\",\"".$count_ary[$key][4]."\",\"".$count_ary[$key][5]."\",\"$UntfndPERCENT\",\"".$count_ary[$key][6]."\",\"".$count_ary[$key][7]."\",\"$UprdncPERCENT\",\"".$count_ary[$key][8]."\",\"".$count_ary[$key][9]."\",\"$UpsalePERCENT\"\n";
	...
	$CSV_text.="\"TOTALI\",\"$total\",\"$Utotal\",\"n/a\",\"$queue_str\",\"$Uqueue_str\",\"$UtotalPERCENT\",\"$totalnocid\",\"$Utotalnocid\",\"$UnocidPERCENT\",\"$totaldnc\",\"$Utotaldnc\",\"$UprdncPERCENT\",\"$totalsale\",\"$Utotalsale\",\"$UpsalePERCENT\",\"$totalarch\",\"$Utotalarch\",\"$UarchPERCENT\",\n";
