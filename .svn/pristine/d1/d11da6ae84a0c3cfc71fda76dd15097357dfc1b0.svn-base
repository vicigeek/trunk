...
if (!$group)
	...
	echo "Nombre total d appels in/out on this serveur:        $TOTALcalls\n";
	echo "Total Off-Hook time on this server (min): $OFFHOOKtime\n";
	echo "Average/Peak channels in use for serveur:  $AVGchannels / $HIGHchannels\n";
	echo "Average/Peak load for serveur:             $AVGload / $HIGHload\n";
