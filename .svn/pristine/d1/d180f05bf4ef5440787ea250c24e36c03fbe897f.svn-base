...
$report_name = 'Usuario Reloj de Asistencia Report';
$db_source = 'M';
...
$MAIN.="<font class=\"select_bold\"><B>Rango de Fecha:</B></font><BR><CENTER>\n";
...
$MAIN.="<font class=\"select_bold\"><B>Grupos De Usuario:</B></font><BR><CENTER>\n";
...
$MAIN.="</TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="<font class=\"select_bold\"><B>Usuario:</B></font><BR>\n";
$MAIN.="<INPUT TYPE=text NAME=user SIZE=7 MAXLENGTH=20 VALUE=\"$user\">\n";

$MAIN.="<BR><BR><INPUT TYPE=Submit NAME=REMITIR VALUE=REMITIR>\n";
$MAIN.="</TD></TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="</TD><TD ALIGN=CENTER VALIGN=TOP ROWSPAN=3>\n";	
$MAIN.="<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB$user_groupQS&query_date=$query_date&end_date=$end_date&order=$order&user=$user&REMITIR=$REMITIR&file_download=1\">DESCARGAR</a><FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; | &nbsp; <a href=\"./admin.php?ADD=999999\">INFORMES</a> </FONT>\n";
...
$MAIN.="Usuario Reloj de Asistencia Report                        $NOW_TIME\n";

$CSV_text.="\"Usuario Reloj de Asistencia Report - $NOW_TIME\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"ESTADÍSTICAS MOTIVOS CIERRE LLAMADAS\" class=\"horizontalgraph\">\n";
