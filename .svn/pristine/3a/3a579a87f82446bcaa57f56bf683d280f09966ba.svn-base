...
if ($calls_summary)
	...
	$MAIN.="LLAMADAS TOTALES TAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[DESCARGAR]</a>\n";
	...
	$CSV_text1.="\"\",\"LLAMADAS TOTALES TAKEN: $row[0]\"\n";
...
$MAIN.="<B>TIMECLOCK TIEMPO LOGIN/LOGOUT:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[DESCARGAR]</a></B>\n";
