...
if($reports_only_user > 0)
	...
	if ( (!preg_match("/$report_name/",$LOGallowed_reports)) and (!preg_match("/ALL REPORTS/",$LOGallowed_reports)) )
		...
		Header("WWW-Authenticate: Basic realm=\"CONTACT-CENTER-ADMIN\"");
		Header("HTTP/1.0 401 Unauthorized");
		echo "Sie sind nicht berechtigt, diesen Bericht zu sehen: |$USER|$report_name|\n";
		exit;
		}
	else
		{
...
if ($action == "CALLCARD_DETAIL")
	...
	if ($details_to_print > 0) 
		...
		echo "<tr bgcolor=#B6D3FC><td align=right>In-Gruppe:</td><td align=left><B>$inbound_group_id</B></td></tr>\n";
		...
		echo "<tr bgcolor=#B6D3FC><td align=right>Anmerkungen: </td><td align=left><B>$note_comments</B></td></tr>\n";
		...
		echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=2 color=white>AGENTDATUM</B></TD>";
		echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=2 color=white>MITTELDISPO</B></TD>";
		echo "</TR>\n";
...
if ($action == "CALLCARD_SUMMARY")
	...
	echo "<TD><B><FONT FACE=\"Arial,Helvetica\" size=1 color=white>ZÄHLIMPULS</B></TD>";
	echo "</TR>\n";
	...
	if ($db_ct > 0)
		...
		echo "<b>Es gibt $DBcount batches in the system\n";
		}
	echo "<BR><BR>\n";
...
if ($action == "GENERATE")
	...
	echo "<tr bgcolor=#B6D3FC><td align=right>In-Gruppe:</td><td align=left><input type=text name=inbound_group_id size=20 maxlength=20></td></tr>\n";
...
<BR><font size=1>CallCard &nbsp; &nbsp; VERSION: <?php echo $version ?> &nbsp; &nbsp; BAU: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</TD></TR></TABLE>
