...
$report_name='Utente Statistiche Orarie Del Gruppo';
...
echo "<br>Per favore inserisci il gruppo per il quale vuoi le statistiche orarie: <form action=$PHP_SELF method=GET>\n";
