...
echo "<html>\n";
echo "<head>\n";
echo "<!-- バージョン: $version     ビルド: $build    UNIQUEID: $uniqueid   server_ip: $server_ip-->\n";
?>
...
#		Zap/73|"V.I.C.I. MARKET" <7275338730>|2005-04-28 14:01:21|7274514936|Inbound direct to Matt|||||
		...
		echo "<a href=\"http://www.whitepages.com/1014/log_click/search/Reverse_電話?npa=$NPA&phone=$NXX$XXXX\" target=\"_blank\">WHITEPAGES</a> - \n";
		echo "<a href=\"http://www.411.com/10742/search/Reverse_電話?phone=%28$NPA%29+$NXX$D$XXXX\" target=\"_blank\">411.COM</a> - \n";
		echo "<a href=\"http://www.phonenumber.com/10006/search/Reverse_電話?npa=$NPA&phone=$NXX$XXXX\" target=\"_blank\">411.COM</a> - \n";
		...
		echo "</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td>ダイアルした番号: </td><td align=left>$row[8]</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td>注：</td><td align=left>$row[9]|$row[10]|$row[11]|$row[12]|$row[13]|</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td colspan=2 align=center>\n<span id=\"callactions\">";
		echo "<a href=\"#\" onclick=\"livehangup_send_hangup('$row[1]');return false;\">電話を切る</a> - \n";
		echo "<a href=\"#\" onclick=\"liveredirect_send_vmail('$row[1]','$vmail_box');return false;\">マイボイスメールに送信する</a>\n";
		echo "</span></td></tr>\n";
		echo "</table>\n";
