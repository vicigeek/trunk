...
$report_name = 'UtilisateurHorloge en temps Report';
$db_source = 'M';
...
$MAIN.="<font class=\"select_bold\"><B>Groupes d'utilisateurs:</B></font><BR><CENTER>\n";
...
$MAIN.="</TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="<font class=\"select_bold\"><B>Utilisateur:</B></font><BR>\n";
$MAIN.="<INPUT TYPE=text NAME=user SIZE=7 MAXLENGTH=20 VALUE=\"$user\">\n";

$MAIN.="<BR><BR><INPUT TYPE=Submit NAME=VALIDER VALUE=VALIDER>\n";
$MAIN.="</TD></TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="</TD><TD ALIGN=CENTER VALIGN=TOP ROWSPAN=3>\n";	
$MAIN.="<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB$user_groupQS&query_date=$query_date&end_date=$end_date&order=$order&user=$user&VALIDER=$VALIDER&file_download=1\">TÉLÉCHARGER</a><FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; | &nbsp; <a href=\"./admin.php?ADD=999999\">RAPPORTS</a> </FONT>\n";
...
$MAIN.="UtilisateurHorloge en temps Report                        $NOW_TIME\n";

$CSV_text.="\"UtilisateurHorloge en temps Report - $NOW_TIME\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"FAIT APPEL Hangup STATS\" class=\"horizontalgraph\">\n";
