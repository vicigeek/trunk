...
$report_name = 'UtilisateurHorloge en temps Rapport détaillé';
$db_source = 'M';
...
if (strlen($user_group[0]) < 1)
	...
	if ($file_download < 1)
		{
		echo "Utilisateur Time-Clock Détail                     $NOW_TIME\n";

		echo "Time range: $query_date_BEGIN to $query_date_END\n\n";
		}
	else
		{
		$file_output .= "Utilisateur Time-Clock Détail                     $NOW_TIME\n";
	...
	if ($file_download < 1)
		...
		$ASCII_text.="+-----------------+----------+----------------------+------------+--------------------\n";
		$ASCII_text.="| <a href=\"$LINKbase&stage=NAME\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | <a href=\"$LINKbase&stage=GROUP\">GROUPE D'UTILISATEURS</a>           | <a href=\"$LINKbase&stage=TCLOCK\">TIME CLOCK</a> | TIME CLOCK PUNCHES\n";
		$ASCII_text.="+-----------------+----------+----------------------+------------+--------------------\n";
		...
		$GRAPH.="  <tr>\n";
		$GRAPH.="	<th class=\"thgraph\" scope=\"col\">USER/GROUPE D'UTILISATEURS</th>\n";
