...
if (!$group)
	{
	echo "\n";
	echo "PLEASE SELECT A SERVIDOR AND DATE/TIME RANGE ABOVE AND CLICK REMITIR\n";
	}
	...
	echo "Total de llamadas in/out on this servidor:        $TOTALcalls\n";
	echo "Total Off-Hook time on this server (min): $OFFHOOKtime\n";
	echo "Average/Peak channels in use for servidor:  $AVGchannels / $HIGHchannels\n";
	echo "Average/Peak load for servidor:             $AVGload / $HIGHload\n";
