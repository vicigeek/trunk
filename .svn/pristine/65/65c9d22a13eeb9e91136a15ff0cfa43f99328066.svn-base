...
if ($records_to_print > 0)
	...
	{
	echo "Εκστρατείες Permissions Error: |$PHP_AUTH_USER|$user_group|\n";
	exit;
	}
...
if ($bareformat < 1)
	...
	$MAIN.="</TD><TD VALIGN=TOP ROWSPAN=2> Εκστρατείες:<BR>";
	...
	$MAIN.="<a href=\"$PHP_SELF?DB=$DB&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date$groupQS&include_rollover=$include_rollover&time_interval=$time_interval&ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&shift=$shift&file_download=1\">ΛΗΨΗ</a> | ";
...
if ($group_ct < 1)
	{
	$MAIN.="\n\n";
	$MAIN.="PLEASE SELECT A CAMPAIGN AND DATE RANGE ABOVE AND CLICK ΕΠΙΒΕΒΑΙΩΣΗ\n";
	}
	...
	if ($group_ct > 0)
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "|                                          |        | SYSTEM | ΧΕΙΡΙΣΤΗΣ |        |        | NO     |        | ΧΕΙΡΙΣΤΗΣ     | ΧΕΙΡΙΣΤΗΣ     |\n";
		$ASCII_text .= "|                                          | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | ΑΠΑΝΤΗΣΗ | DROP   | LOGIN      | PAUSE      |\n";
		$ASCII_text .= "| CAMPAIGN                                 | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

		$CSV_main.="\"MULTI-CAMPAIGN BREAKDOWN:\"\n";
		$CSV_main.="\"CAMPAIGN\",\"ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣ\",\"SYSTEM RELEASE CALLS\",\"ΧΕΙΡΙΣΤΗΣRELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO ΑΠΑΝΤΗΣΗ PERCENT\",\"DROP PERCENT\",\"ΧΕΙΡΙΣΤΗΣLOGIN TIME(H:M:S)\",\"ΧΕΙΡΙΣΤΗΣPAUSE TIME(H:M:S)\"\n";
		$CSV_subreports="";
		...
		$GRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown1'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown2'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown3'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('AGENTRELEASE', '3'); return false;\">ΧΕΙΡΙΣΤΗΣRELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown4'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown5'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown6'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('NAS', '6'); return false;\">NO ΑΠΑΝΤΗΣΗ PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown7'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown8'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('LOGINTIME', '8'); return false;\">ΧΕΙΡΙΣΤΗΣLOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown9'><a href='#' onClick=\"DrawMultiΕκστρατείαGraph('PAUSETIME', '9'); return false;\">ΧΕΙΡΙΣΤΗΣPAUSE TIME</a></th></tr>";
		...
		$AGENTRELEASE_graph=$graph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣRELEASE CALLS</th></tr>";
		...
		$NAS_graph=$graph_header."<th class='thgraph' scope='col'>NO ΑΠΑΝΤΗΣΗ PERCENT</th></tr>";
		$DROPS_graph=$graph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
		$LOGINTIME_graph=$graph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣLOGIN TIME (H:M:S)</th></tr>";
		$PAUSETIME_graph=$graph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣPAUSE TIME (H:M:S)</th></tr>";
		###########################
		...
		while($i < $group_ct)
			...
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
			$SUB_ASCII_text .= "|                     |        | SYSTEM | ΧΕΙΡΙΣΤΗΣ |        |        | NO     |        | ΧΕΙΡΙΣΤΗΣ     | ΧΕΙΡΙΣΤΗΣ     |\n";
			$SUB_ASCII_text .= "|                     | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | ΑΠΑΝΤΗΣΗ | DROP   | LOGIN      | PAUSE      |\n";
			$SUB_ASCII_text .= "| INTERVAL            | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

			$CSV_subreports.="\n\n\"$group[$i] - $group_cname[$i]\"\n\"INTERVAL BREAKDOWN:\"\n";
			$CSV_subreports.="\"INTERVAL\",\"ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣ\",\"SYSTEM RELEASE CALLS\",\"ΧΕΙΡΙΣΤΗΣRELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO ΑΠΑΝΤΗΣΗ PERCENT\",\"DROP PERCENT\",\"ΧΕΙΡΙΣΤΗΣLOGIN TIME (H:M:S)\",\"ΧΕΙΡΙΣΤΗΣPAUSE TIME(H:M:S)\"\n";
			...
			$SUBGRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."1'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."2'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."3'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('AGENTRELEASE', '3'); return false;\">ΧΕΙΡΙΣΤΗΣRELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."4'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."5'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."6'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('NAS', '6'); return false;\">NO ΑΠΑΝΤΗΣΗ PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."7'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."8'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('LOGINTIME', '8'); return false;\">ΧΕΙΡΙΣΤΗΣLOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."9'><a href='#' onClick=\"Draw".$SUBrpt_campaign."ΕκστρατείαGraph('PAUSETIME', '9'); return false;\">ΧΕΙΡΙΣΤΗΣPAUSE TIME</a></th></tr>";
			...
			$SUBCALLS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣ</th></tr>";
			$SUBSYSTEMRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>SYSTEM RELEASE CALLS</th></tr>";
			$SUBAGENTRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣRELEASE CALLS</th></tr>";
			...
			$SUBNAS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>NO ΑΠΑΝΤΗΣΗ PERCENT</th></tr>";
			$SUBDROPS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
			$SUBLOGINTIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣLOGIN TIME (H:M:S)</th></tr>";
			$SUBPAUSETIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>ΧΕΙΡΙΣΤΗΣPAUSE TIME (H:M:S)</th></tr>";
			###########################
			...
			$JS_onload.="\tDraw".$SUBrpt_campaign."ΕκστρατείαGraph('CALLS', '1');\n"; 
			$JS_text.="function Draw".$SUBrpt_campaign."ΕκστρατείαGraph(graph, th_id) {\n";
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "| TOTALS       Εκστρατείες: $i             | $TOTcalls_count | $TOTsystem_count | $TOTagent_count | $TOTptp_count | $TOTrtp_count | $TOTna_percent%| $TOTdrop_percent%| $TOTagent_sec | $TOTpause_sec |\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$CSV_main.="\"TOTALS       Εκστρατείες: $i\",\"$TOTcalls_count\",\"$TOTsystem_count\",\"$TOTagent_count\",\"$TOTptp_count\",\"$TOTrtp_count\",\"$TOTna_percent%\",\"$TOTdrop_percent%\",\"$TOTagent_sec\",\"$TOTpause_sec\"\n";
		}
	...
	$JS_onload.="\tDrawMultiΕκστρατείαGraph('CALLS', '1');\n"; 
	$JS_text.="function DrawMultiΕκστρατείαGraph(graph, th_id) {\n";
