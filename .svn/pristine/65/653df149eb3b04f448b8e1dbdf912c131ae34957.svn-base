...
echo "<html>\n";
echo "<head>\n";
echo "<!-- 版本: $version     版次: $build    UNIQUEID: $uniqueid   server_ip: $server_ip-->\n";
?>
...
#		Zap/73|"V.I.C.I. MARKET" <7275338730>|2005-04-28 14:01:21|7274514936|Inbound direct to Matt|||||
		...
		echo "</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td>已撥號碼: </td><td align=left>$row[8]</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td>注意: </td><td align=left>$row[9]|$row[10]|$row[11]|$row[12]|$row[13]|</td></tr>\n";
		echo "<tr bgcolor=\"#DDDDFF\"><td colspan=2 align=center>\n<span id=\"callactions\">";
		echo "<a href=\"#\" onclick=\"livehangup_send_hangup('$row[1]');return false;\">掛斷</a> - \n";
		echo "<a href=\"#\" onclick=\"liveredirect_send_vmail('$row[1]','$vmail_box');return false;\">傳送至我的語音信箱</a>\n";
		echo "</span></td></tr>\n";
		echo "</table>\n";
