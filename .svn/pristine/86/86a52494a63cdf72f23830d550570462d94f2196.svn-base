...
$report_name = 'UsuárioRelógio Ponto Report';
$db_source = 'M';
...
$MAIN.="<font class=\"select_bold\"><B>Período:</B></font><BR><CENTER>\n";
...
$MAIN.="<font class=\"select_bold\"><B>Grupos de Usuário:</B></font><BR><CENTER>\n";
...
$MAIN.="</TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="<font class=\"select_bold\"><B>Usuário:</B></font><BR>\n";
$MAIN.="<INPUT TYPE=text NAME=user SIZE=7 MAXLENGTH=20 VALUE=\"$user\">\n";

$MAIN.="<BR><BR><INPUT TYPE=Submit NAME=ENVIAR VALUE=ENVIAR>\n";
$MAIN.="</TD></TD><TD ALIGN=LEFT VALIGN=TOP>\n";
$MAIN.="</TD><TD ALIGN=CENTER VALIGN=TOP ROWSPAN=3>\n";	
$MAIN.="<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB$user_groupQS&query_date=$query_date&end_date=$end_date&order=$order&user=$user&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a><FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; | &nbsp; <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a> </FONT>\n";
...
$MAIN.="UsuárioRelógio Ponto Report                        $NOW_TIME\n";

$CSV_text.="\"UsuárioRelógio Ponto Report - $NOW_TIME\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"ESTATÍSTICA DE MOTIVO DE DESLIGAMENTO\" class=\"horizontalgraph\">\n";
