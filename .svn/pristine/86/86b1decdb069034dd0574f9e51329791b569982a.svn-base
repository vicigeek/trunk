...
$report_name='Usuário Estatísticas Horárias do Grupo';
...
<title>ADMINISTRATION: Estatísticas Horárias do Grupo
<?php
...
<CENTER>
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; Estatísticas Horárias do Grupo <?php echo $group ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; </TD></TR>
...
echo "<br>Por favor entre com o grupo que deseja visualizar estatísticas horárias: <form action=$PHP_SELF method=GET>\n";
