...
$HTML_text.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <a href=\"$PHP_SELF?query_date=$query_date&group=$group&shift=$shift&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">ÄNDERN Sie</a> | <a href=\"./admin.php?ADD=999999\">REPORTS</a><BR/></FONT>\n";
$HTML_text.="</FORM>\n\n";
...
$ASCII_text.="+--------------------------+-------+--------+--------+------+------+------+\n";
$ASCII_text.="| MITTEL                   |SUCCESS| XFERS  |SUCCESS%| SALE | DROP |OTHER |\n";
$ASCII_text.="+--------------------------+-------+--------+--------+------+------+------+\n";
...
$ASCII_text.="+--------------------------+--------+------+------+------+------+-------+\n";
$ASCII_text.="| MITTEL                   | CALLS  | SALE | DROP |OTHER | SALE | CONV %|\n";
$ASCII_text.="+--------------------------+--------+------+------+------+------+-------+\n";
