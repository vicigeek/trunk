...
$report_name = 'ΧρήστηΏρα ρολόι Λεπτομέρειες Έκθεση';
$db_source = 'M';
...
if (strlen($user_group[0]) < 1)
	...
	if ($file_download < 1)
		{
		echo "Χρήστης Time-Clock Λεπτομέρειες                     $NOW_TIME\n";

		echo "Time range: $query_date_BEGIN to $query_date_END\n\n";
		}
	else
		{
		$file_output .= "Χρήστης Time-Clock Λεπτομέρειες                     $NOW_TIME\n";
	...
	if ($file_download < 1)
		{
		$ASCII_text.="ΧΕΙΡΙΣΤΗΣTIME-CLOCK DETAIL:\n";
		$ASCII_text.="+-----------------+----------+----------------------+------------+--------------------\n";
		$ASCII_text.="| <a href=\"$LINKbase&stage=NAME\">USER NAME</a>       | <a href=\"$LINKbase&stage=ID\">ID</a>       | <a href=\"$LINKbase&stage=GROUP\">ΟΜΑΔΑ ΧΡΗΣΤΩΝ</a>           | <a href=\"$LINKbase&stage=TCLOCK\">TIME CLOCK</a> | TIME CLOCK PUNCHES\n";
		$ASCII_text.="+-----------------+----------+----------------------+------------+--------------------\n";

		$GRAPH.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"ΧΕΙΡΙΣΤΗΣTIME-CLOCK DETAIL\" class=\"horizontalgraph\">\n";
		$GRAPH.="  <caption align=\"top\">ΧΕΙΡΙΣΤΗΣTIME-CLOCK DETAIL</caption>\n";
		$GRAPH.="  <tr>\n";
		$GRAPH.="	<th class=\"thgraph\" scope=\"col\">USER/ΟΜΑΔΑ ΧΡΗΣΤΩΝ</th>\n";
