...
if ($did > 0)
	...
	{$MAIN.="<B> &nbsp; User-Statistiken for $user";}
...
if ($pause_code_rpt >= 1)
	...
	$MAIN.="<B>MITTELPAUSE LOGS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=11'>[DOWNLOAD]</a></B>\n";

	$MAIN.="<center><TABLE width=600 cellspacing=0 cellpadding=1>\n";
	$MAIN.="<tr><td><font size=2>EVENT TIME</td><td align=right><font size=2>Kampagnen-ID</td><td align=right><font size=2>User Group</td><td align=right><font size=2>PAUSE CODE</td><td align=right><font size=2>PAUSE LENGTH (HH:MM:SS)</td></tr>\n";

	$CSV_text11.="\"MITTELPAUSE LOGS\"\n";
	$CSV_text11.="\"\",\"EVENT TIME\",\"Kampagnen-ID\",\"User Group\",\"PAUSE CODE\",\"PAUSE LENGTH (HH:MM:SS)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>MITTELGESPRÄCH ZEIT UND STATUS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=1'>[DOWNLOAD]</a></B>\n";

		$MAIN.="<center><TABLE width=300 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>STATUS</td><td align=right><font size=2>ZÄHLIMPULS</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";

		$CSV_text1.="\"MITTELGESPRÄCH ZEIT UND STATUS\"\n";
		...
		$MAIN.="<tr><td><font size=2>GESAMTANRUFE</td><td align=right><font size=2> $total_calls</td><td align=right><font size=2> $call_hours_minutes</td></tr>\n";
		$CSV_text1.="\"\",\"GESAMTANRUFE\",\"$total_calls\",\"$call_hours_minutes\"\n";
		$MAIN.="</TABLE></center>\n";
		...
		$MAIN.="<B>MITTELLOGIN/LOGOUT ZEIT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=2'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=850 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>FALL </td><td align=right><font size=2>DATUM</td><td align=right><font size=2> KAMPAGNE</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>SESSION<BR>HOURS:MM:SS</td><td align=right><font size=2>SERVER</td><td align=right><font size=2>PHONE</td><td align=right><font size=2>COMPUTER</td><td align=right><font size=2>PHONE<BR>LOGIN</td><td align=right><font size=2>PHONE IP</td></tr>\n";

		$CSV_text2.="\"MITTELLOGIN/LOGOUT ZEIT\"\n";
		...
		$MAIN.="<tr><td><font size=2>GESAMTMENGE</td>";
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2> </td>\n";
		$MAIN.="<td align=right><font size=2> </td>\n";
		...
		$MAIN.="<B>TIMECLOCK LOGIN/LOGOUT ZEIT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=3'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2>FALL </td><td align=right><font size=2>DATUM</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>HOURS:MM:SS</td></tr>\n";
		$CSV_text3.="\"TIMECLOCK LOGIN/LOGOUT ZEIT\"\n";
		...
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2> KAMPAGNE</td><td align=left><font size=2>BLEND</td><td align=left><font size=2> GROUPS</td><td align=left><font size=2> MANAGER</td></tr>\n";
		...
		if ($firstlastname_display_user_stats > 0)
			{
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> KAMPAGNE</td><td align=right><font size=2> GROUP</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> NAME</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
			}
		else
			{
		...
		while ($logs_to_print > $u) 
			...
			if ($LOGadmin_hide_phone_data != '0')
				{
				if ($DB > 0) {echo "VerbergePHONEDATA|$row[10]|$LOGadmin_hide_phone_data|\n";}
				$phone_temp = $row[10];
		...
		if ($allow_emails>0) 
			...
			$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>USER</td><td align=left><font size=2> KAMPAGNE</td><td align=left><font size=2> EMAIL TO</td><td align=right><font size=2> ATTACHMENTS</td><td align=right><font size=2> LEAD</td></tr>\n";
	...
	if ($firstlastname_display_user_stats > 0)
		{
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> KAMPAGNE</td><td align=right><font size=2> WAIT (S)</td><td align=right><font size=2> MITTEL(S)</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> NAME</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
		}
	else
		{
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>LENGTH</td><td align=left><font size=2> STATUS</td><td align=left><font size=2> PHONE</td><td align=right><font size=2> KAMPAGNE</td><td align=right><font size=2> WAIT (S)</td><td align=right><font size=2> MITTEL(S)</td><td align=right><font size=2> LIST</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> HANGUP REASON</td></tr>\n";
		}
	...
	if ($did < 1)
		{
		$MAIN.="<B>Agentenaktivität Für diesen Zeitraum: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=7'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td colspan=2><font size=1> &nbsp; </td><td colspan=6 align=center bgcolor=white><font size=1>Diese Felder werden in Sekunden </td><td colspan=4><font size=1> &nbsp; </td></tr>\n";
		$MAIN.="<tr><td><font size=1># </td><td><font size=2>DATE/TIME </td><td align=left><font size=2>PAUSE</td><td align=left><font size=2> WAIT</td><td align=left><font size=2> TALK</td><td align=right><font size=2> DISPO</td><td align=right><font size=2> DEAD</td><td align=right><font size=2> CUSTOMER</td><td align=right><font size=2> STATUS</td><td align=right><font size=2> LEAD</td><td align=right><font size=2> KAMPAGNE</td><td align=right><font size=2> PAUSE CODE</td></tr>\n";
		$CSV_text7.="\"Agentenaktivität Für diesen Zeitraum: (10000 record limit)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>LEAD Abfragen Für diesen Zeitraum: (10000 record limit)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=10'>[DOWNLOAD]</a></B>\n";
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		...
		$CSV_text10.="\"LEAD Abfragen Für diesen Zeitraum: (10000 record limit)\"\n";
	...
	if ($did < 1)
		...
		$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td><font size=1># </td><td NOWRAP><font size=2>DATE/TIME &nbsp; </td><td align=right NOWRAP><font size=2> LEAD ID &nbsp; </td><td align=right NOWRAP><font size=2> STATUS &nbsp; </td><td align=right NOWRAP><font size=2> COUNT &nbsp; </td><td align=right NOWRAP><font size=2> KAMPAGNE</td></tr>\n";
...
$MAIN.="<font size=0>\n\n\n<br><br><br>\nIndexlaufzeit: $RUNtime seconds|$db_source</font>";
