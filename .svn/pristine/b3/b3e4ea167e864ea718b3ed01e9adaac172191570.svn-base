...
$report_name = 'Agente Time Dettagliata';
$db_source = 'M';
...
if ( (strlen($group[0]) < 1) or (strlen($user_group[0]) < 1) )
	...
	if ($file_download < 1)
		{
		$ASCII_text.="\nAgente Time Dettagliata                     $NOW_TIME\n";
		$ASCII_text.="Intervallo Di Tempo: $query_date_BEGIN to $query_date_END\n\n";

		$GRAPH.="Agente Time Dettagliata                     $NOW_TIME\n";
		$GRAPH.="Intervallo Di Tempo: $query_date_BEGIN to $query_date_END\n\n";
		}
	else
		{
		$file_output .= "Agente Time Dettagliata                     $NOW_TIME\n";
