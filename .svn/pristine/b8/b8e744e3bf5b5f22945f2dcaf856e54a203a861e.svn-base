...
$report_name = 'Utilisateur Feuille de temps';
$db_source = 'M';
...
{
$MAIN.="\n";
$MAIN.="PLEASE SELECT AN AGENT ID AND DATE-TIME ABOVE AND CLICK VALIDER\n";
...
if ($calls_summary)
	...
	$MAIN.="TOTAL DES APPELSTAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[TÉLÉCHARGER]</a>\n";
	...
	$CSV_text1.="\"\",\"TOTAL DES APPELSTAKEN: $row[0]\"\n";
...
$MAIN.="<B>TIMECLOCK HEURE DE CONNECTION/DECONNECTION:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[TÉLÉCHARGER]</a></B>\n";
...
$CSV_text2.=$CSV_login;
$CSV_text2.="\"TIMECLOCK HEURE DE CONNECTION/DECONNECTION:\"\n";
$CSV_text2.="\"\",\"ID\",\"EDIT\",\"EVENT\",\"DATE\",\"IP ADDRESS\",\"GROUP\",\"HEURES:MINUTES\"\n";
