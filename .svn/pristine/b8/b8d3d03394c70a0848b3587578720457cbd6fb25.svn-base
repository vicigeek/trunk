...
if ($records_to_print > 0)
	...
	{
	echo "Kampagnen Permissions Error: |$PHP_AUTH_USER|$user_group|\n";
	exit;
	}
...
if ($bareformat < 1)
	...
	$MAIN.="</TD><TD VALIGN=TOP ROWSPAN=2> Kampagnen:<BR>";
...
if ($group_ct < 1)
	...
	if ($group_ct > 0)
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "|                                          |        | SYSTEM | MITTEL |        |        | NO     |        | MITTEL     | MITTEL     |\n";
		$ASCII_text .= "|                                          | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | ANTWORT | DROP   | LOGIN      | PAUSE      |\n";
		$ASCII_text .= "| CAMPAIGN                                 | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

		$CSV_main.="\"MULTI-CAMPAIGN BREAKDOWN:\"\n";
		$CSV_main.="\"CAMPAIGN\",\"GESAMTANRUFE\",\"SYSTEM RELEASE CALLS\",\"MITTELRELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO ANTWORT PERCENT\",\"DROP PERCENT\",\"MITTELLOGIN TIME(H:M:S)\",\"MITTELPAUSE TIME(H:M:S)\"\n";
		$CSV_subreports="";
		...
		$GRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown1'><a href='#' onClick=\"DrawMultiKampagneGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown2'><a href='#' onClick=\"DrawMultiKampagneGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown3'><a href='#' onClick=\"DrawMultiKampagneGraph('AGENTRELEASE', '3'); return false;\">MITTELRELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown4'><a href='#' onClick=\"DrawMultiKampagneGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown5'><a href='#' onClick=\"DrawMultiKampagneGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown6'><a href='#' onClick=\"DrawMultiKampagneGraph('NAS', '6'); return false;\">NO ANTWORT PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown7'><a href='#' onClick=\"DrawMultiKampagneGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown8'><a href='#' onClick=\"DrawMultiKampagneGraph('LOGINTIME', '8'); return false;\">MITTELLOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown9'><a href='#' onClick=\"DrawMultiKampagneGraph('PAUSETIME', '9'); return false;\">MITTELPAUSE TIME</a></th></tr>";
		...
		$AGENTRELEASE_graph=$graph_header."<th class='thgraph' scope='col'>MITTELRELEASE CALLS</th></tr>";
		...
		$NAS_graph=$graph_header."<th class='thgraph' scope='col'>NO ANTWORT PERCENT</th></tr>";
		$DROPS_graph=$graph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
		$LOGINTIME_graph=$graph_header."<th class='thgraph' scope='col'>MITTELLOGIN TIME (H:M:S)</th></tr>";
		$PAUSETIME_graph=$graph_header."<th class='thgraph' scope='col'>MITTELPAUSE TIME (H:M:S)</th></tr>";
		###########################
		...
		while($i < $group_ct)
			...
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
			$SUB_ASCII_text .= "|                     |        | SYSTEM | MITTEL |        |        | NO     |        | MITTEL     | MITTEL     |\n";
			$SUB_ASCII_text .= "|                     | TOTAL  | RELEASE| RELEASE| SALE   | DNC    | ANTWORT | DROP   | LOGIN      | PAUSE      |\n";
			$SUB_ASCII_text .= "| INTERVAL            | CALLS  | CALLS  | CALLS  | CALLS  | CALLS  | PERCENT| PERCENT| TIME(H:M:S)| TIME(H:M:S)|\n";
			$SUB_ASCII_text .= "+---------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";

			$CSV_subreports.="\n\n\"$group[$i] - $group_cname[$i]\"\n\"INTERVAL BREAKDOWN:\"\n";
			$CSV_subreports.="\"INTERVAL\",\"GESAMTANRUFE\",\"SYSTEM RELEASE CALLS\",\"MITTELRELEASE CALLS\",\"SALE CALLS\",\"DNC CALLS\",\"NO ANTWORT PERCENT\",\"DROP PERCENT\",\"MITTELLOGIN TIME (H:M:S)\",\"MITTELPAUSE TIME(H:M:S)\"\n";
			...
			$SUBGRAPH.="<tr><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."1'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('CALLS', '1'); return false;\">CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."2'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('SYSTEMRELEASE', '2'); return false;\">SYSTEM RELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."3'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('AGENTRELEASE', '3'); return false;\">MITTELRELEASE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."4'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('SALES', '4'); return false;\">SALE CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."5'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('DNCS', '5'); return false;\">DNC CALLS</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."6'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('NAS', '6'); return false;\">NO ANTWORT PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."7'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('DROPS', '7'); return false;\">DROP PERCENT</a></th><th width='11%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."8'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('LOGINTIME', '8'); return false;\">MITTELLOGIN TIME</a></th><th width='12%' class='grey_graph_cell' id='campbreakdown".$SUBrpt_campaign."9'><a href='#' onClick=\"Draw".$SUBrpt_campaign."KampagneGraph('PAUSETIME', '9'); return false;\">MITTELPAUSE TIME</a></th></tr>";
			...
			$SUBCALLS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>GESAMTANRUFE</th></tr>";
			$SUBSYSTEMRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>SYSTEM RELEASE CALLS</th></tr>";
			$SUBAGENTRELEASE_graph=$SUBgraph_header."<th class='thgraph' scope='col'>MITTELRELEASE CALLS</th></tr>";
			...
			$SUBNAS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>NO ANTWORT PERCENT</th></tr>";
			$SUBDROPS_graph=$SUBgraph_header."<th class='thgraph' scope='col'>DROP PERCENT</th></tr>";
			$SUBLOGINTIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>MITTELLOGIN TIME (H:M:S)</th></tr>";
			$SUBPAUSETIME_graph=$SUBgraph_header."<th class='thgraph' scope='col'>MITTELPAUSE TIME (H:M:S)</th></tr>";
			###########################
			...
			$JS_onload.="\tDraw".$SUBrpt_campaign."KampagneGraph('CALLS', '1');\n"; 
			$JS_text.="function Draw".$SUBrpt_campaign."KampagneGraph(graph, th_id) {\n";
		...
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$ASCII_text .= "| TOTALS       Kampagnen: $i             | $TOTcalls_count | $TOTsystem_count | $TOTagent_count | $TOTptp_count | $TOTrtp_count | $TOTna_percent%| $TOTdrop_percent%| $TOTagent_sec | $TOTpause_sec |\n";
		$ASCII_text .= "+------------------------------------------+--------+--------+--------+--------+--------+--------+--------+------------+------------+\n";
		$CSV_main.="\"TOTALS       Kampagnen: $i\",\"$TOTcalls_count\",\"$TOTsystem_count\",\"$TOTagent_count\",\"$TOTptp_count\",\"$TOTrtp_count\",\"$TOTna_percent%\",\"$TOTdrop_percent%\",\"$TOTagent_sec\",\"$TOTpause_sec\"\n";
		}
	...
	$JS_onload.="\tDrawMultiKampagneGraph('CALLS', '1');\n"; 
	$JS_text.="function DrawMultiKampagneGraph(graph, th_id) {\n";
