...
echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=3111&group_id=$group\">ÄNDERN Sie</a> \n";
echo "</FORM>\n\n";
...
if (!$group)
	...
	{
	echo "Live Current Bevollmächtigte logged in to take calls from $group - $selected_name         $NOW_TIME\n";
	...
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
	echo "| #    | BENUTZER       | CAMPAIGN             | STATUS | LAST ACTIVITY       |\n";
	echo "+------+--------------------------------+----------------------+--------+---------------------+\n";
