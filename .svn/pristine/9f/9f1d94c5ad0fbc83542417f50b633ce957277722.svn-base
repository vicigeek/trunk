...
$ANTWORTEDpercent = (MathZDC($ANTWORTEDcalls, $TOTALcalls) * 100);
...
if ($EMAIL=='Y')
	{
	$MAIN.="Total Emails taken in to this In-Gruppe:       $TOTALcalls\n";
	$MAIN.="Average Email Length for all Emails:            $average_call_seconds seconds\n";
	$MAIN.="Answered Emails:                               $ANTWORTEDcalls  $ANTWORTEDpercent%\n";
	$MAIN.="Average queue time for Answered Emails:        $average_answer_seconds seconds\n";
	$MAIN.="Emails taken into the IVR for this In-Gruppe:  $IVRcalls\n";
	...
	$CSV_text1.="\"Answered Emails:\",\"$ANTWORTEDcalls\",\"$ANTWORTEDpercent%\"\n";
	...
	{
	$MAIN.="Insgesamt fordert die in dieser In-Gruppe:       $TOTALcalls\n";
	$MAIN.="Average Call Length for all Calls:            $average_call_seconds seconds\n";
	$MAIN.="Answered Calls:                               $ANTWORTEDcalls  $ANTWORTEDpercent%\n";
	$MAIN.="Average queue time for Answered Calls:        $average_answer_seconds seconds\n";
	$MAIN.="Calls taken into the IVR for this In-Gruppe:  $IVRcalls\n";

	$CSV_text1.="\"Insgesamt fordert die in dieser In-Group:\",\"$TOTALcalls\"\n";
	$CSV_text1.="\"Average Call Length for all Calls:\",\"$average_call_seconds seconds\"\n";
	$CSV_text1.="\"Answered Calls:\",\"$ANTWORTEDcalls\",\"$ANTWORTEDpercent%\"\n";
...
$DROP_ANTWORTEDpercent = (MathZDC($DROPcalls, $ANTWORTEDcalls) * 100);
$DROP_ANTWORTEDpercent = round($DROP_ANTWORTEDpercent, 0);

if ($EMAIL=='Y')
	{
	$MAIN.="Total DROP Emails:                             $DROPcalls  $DROPpercent%               drop/answered: $DROP_ANTWORTEDpercent%\n";
	$MAIN.="Average hold time for DROP Emails:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Emails:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_ANTWORTEDpercent%\"\n";
	$CSV_text1.="\"Average hold time for DROP Emails:\",\"$average_hold_seconds seconds\"\n";
	}
else
	{
	$MAIN.="Gesamt-TROPFEN Anrufe:                                          $DROPcalls  $DROPpercent%               drop/answered: $DROP_ANTWORTEDpercent%\n";
	$MAIN.="Average hold time for DROP Calls:             $average_hold_seconds seconds\n";

	$CSV_text1.="\"Total DROP Calls:\",\"$DROPcalls\",\"$DROPpercent%\",\"drop/answered:\",\"$DROP_ANTWORTEDpercent%\"\n";
...
if (strlen($group_SQL)>3)
	...
	if ($DID!='Y')
		...
		$PCTanswer_sec_pct_rt_stat_one = (MathZDC($answer_sec_pct_rt_stat_one, $ANTWORTEDcalls) * 100);
		...
		$PCTanswer_sec_pct_rt_stat_two = (MathZDC($answer_sec_pct_rt_stat_two, $ANTWORTEDcalls) * 100);
...
if ($EMAIL=='Y')
	...
	$MAIN.="GDE (Answered/Total emails taken in to this In-Group):  $ANTWORTEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_ANTWORTEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Total emails taken in to this In-Group):\",\"$ANTWORTEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_ANTWORTEDpercent%\"\n";
	}
else
	{
	$MAIN.="\n";
	$MAIN.="---------- CUSTOM INDICATORS\n";
	$MAIN.="GDE (Answered/Gesamtanrufe genommenin to this In-Group):  $ANTWORTEDpercent%\n";
	$MAIN.="ACR (Dropped/Answered):                                $DROP_ANTWORTEDpercent%\n";

	$CSV_text1.="\n\"CUSTOM INDICATORS\"\n";
	$CSV_text1.="\"GDE (Answered/Gesamtanrufe genommenin to this In-Group):\",\"$ANTWORTEDpercent%\"\n";
	$CSV_text1.="\"ACR (Dropped/Answered):\",\"$DROP_ANTWORTEDpercent%\"\n";
	}
...
if ($EMAIL=='Y')
	...
	{
	$MAIN.="Summe der Anrufe That entered Queue:               $QUEUEcalls  $QUEUEpercent%\n";
	...
	$CSV_text1.="\"Summe der Anrufe That entered Queue:\",\"$QUEUEcalls\",\"$QUEUEpercent%\"\n";
...
$ASCII_text="\n";
$ASCII_text.="           $rpt_type_verbiage ANTWORTED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"$rpt_type_verbiage ANTWORTED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
if ($report_display_type=="HTML") {
	...
	$GRAPH_text.="g.render(\"CallTimeCanvas\", \"CALL ANTWORTED TIME BREAKDOWN\");\n";
	$GRAPH_text.="</script>";
	$MAIN.=$GRAPH_text;
	}
else
...
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
$ASCII_text.="| STATUS | DESCRIPTION          | KATEGORIE             | $rpt_type_verbiages     | TOTAL TIME | AVG TIME |$rpt_type_verbiages/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+-----------+\n";
...
$CSV_text4.="\"STATUS\",\"DESCRIPTION\",\"KATEGORIE\",\"$rpt_type_verbiages\",\"TOTAL TIME\",\"AVG TIME\",\"$rpt_type_verbiages/HOUR\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CUSTOM STATUS KATEGORIE STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&SUBMIT=$SUBMIT&file_download=5\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";
$ASCII_text.="| KATEGORIE             | $rpt_type_verbiages     | DESCRIPTION                    |\n";
$ASCII_text.="+----------------------+------------+--------------------------------+\n";

$CSV_text5.="\n\"CUSTOM STATUS KATEGORIE STATS\"\n";
$CSV_text5.="\"KATEGORIE\",\"$rpt_type_verbiages\",\"DESCRIPTION\"\n";
...
if ($report_display_type=="HTML") 
	...
	$GRAPH_text="</PRE>\n";
	$GRAPH_text.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"CUSTOM STATUS KATEGORIE STATS\" class=\"horizontalgraph\">\n";
	$GRAPH_text.="  <caption align=\"top\">CUSTOM STATUS KATEGORIE STATS</caption>\n";
	$GRAPH_text.="  <tr>\n";
	$GRAPH_text.="	<th class=\"thgraph\" scope=\"col\">KATEGORIE </th>\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- MITTELSTATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&SUBMIT=$SUBMIT&file_download=7\">DOWNLOAD</a>\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
$ASCII_text.="| MITTEL                   | $rpt_type_verbiages     | TIME H:M:S |AVERAGE |\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>MITTELSTATS</caption><tr><th class='thgraph' scope='col'>AGENT</th>";
...
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
$ASCII_text.="| TOTAL Bevollmächtigte: $TOTagents | $TOTcalls | $TOTtime | $TOTavg |\n";
$ASCII_text.="+--------------------------+------------+------------+--------+\n";
...
$CSV_text7.="\"TOTAL Bevollmächtigte: $TOTagents\",\"$TOTcalls\",\"$TOTtime\",\"$TOTavg\"\n";
...
$MAIN.="\n";
$MAIN.="---------- $rpt_type_verbiage ANTWORTED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&SUBMIT=$SUBMIT&file_download=8\">DOWNLOAD</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"$rpt_type_verbiage ANTWORTED TIME BREAKDOWN IN SECONDS\"\n";
