...
$report_name = 'Gruppo UtenteOrologio Status Report';
$db_source = 'M';
...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>Orologio Status for $user_group</TD><TD ALIGN=RIGHT> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n";
$MAIN.="<a href=\"./timeclock_report.php\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>TIMECLOCK REPORT</a> | ";
$MAIN.="<a href=\"./admin.php?ADD=311111&user_group=$user_group\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>Utente Group</a>\n";
$MAIN.="</TD></TR>\n";
...
$MAIN.="<B>USER STATUS FOR Utente Gruppo: $user_group &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$PHP_SELF?DB=$DB&user_group=$user_group&submit=$submit&file_download=1'>[DOWNLOAD]</a></B>\n";
...
$CSV_text.="\"USER STATUS FOR Utente Gruppo: $user_group\"\n";
...
$MAIN.="<td colspan=4><font size=2>TOTALI</td>";
...
$CSV_text.="\"\",\"TOTALI\",\"\",\"\",\"\",\"\",\"$total_login_hours_int:$total_login_minutes_int\"\n";
...
$MAIN.="<B>TIMECLOCK TIEMPO LOGIN/LOGOUT:</B>\n";
