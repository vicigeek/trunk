...
$select_list .= "<a href=\"#\" onclick=\"hideDiv(\'campaign_select_list\');\">Fermer le panneau</a><BR><BR>";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right>";
	$select_list .= "Voir les statistiques Presets:  </TD><TD align=left><SELECT SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value=\"0\"";
...
$select_list .= "<INPUT type=button VALUE=VALIDER onclick=\"update_variables(\'form_submit\',\'\');\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; ";
$select_list .= "</TD></TR>";
...
$open_list = "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#D9E6FE\"><TR><TD ALIGN=CENTER><a href=\"#\" onclick=\"showDiv(\'campaign_select_list\');\"><font size=2>Rapport Choisissez Options d-affichage</a></TD></TR></TABLE>";
...
if (strlen($monitor_phone)>1)
	...
	if ($Mph_ct > 0)
		...
		#	echo "<!-- debug: $webphone_dialpad|$webphone_dialpad_override|$monitor_phone|$extension -->";
			...
			if ($webphone_auto_answer == 'Y') {$webphone_options .= "--AUTOREPONSE_Y";}
			if ($webphone_auto_answer == 'N') {$webphone_options .= "--AUTOREPONSE_N";}
...
function update_variables(task_option,task_choice,force_reload)
	...
	if (task_option == 'UGdisplay')
		{
		if (UGdisplay == '1') {UGdisplay='0';   document.getElementById("UGdisplayTXT").innerHTML = 'VIEW GROUPE D'UTILISATEURS';}
		else {UGdisplay='1';   document.getElementById("UGdisplayTXT").innerHTML = 'CACHER GROUPE D'UTILISATEURS';}
		}
	if (task_option == 'SERVdisplay')
		{
		if (SERVdisplay == '1') {SERVdisplay='0';   document.getElementById("SERVdisplayTXT").innerHTML = 'MONTRER SERVEUR INFO';}
		else {SERVdisplay='1';   document.getElementById("SERVdisplayTXT").innerHTML = 'CACHER SERVEUR INFO';}
		}
	if (task_option == 'CALLSdisplay')
		{
		if (CALLSdisplay == '1') {CALLSdisplay='0';   document.getElementById("CALLSdisplayTXT").innerHTML = 'MONTRER WAITING CALLS';}
		else {CALLSdisplay='1';   document.getElementById("CALLSdisplayTXT").innerHTML = 'CACHER WAITING CALLS';}
		}
	if (task_option == 'PHONEdisplay')
		{
		if (PHONEdisplay == '1') {PHONEdisplay='0';   document.getElementById("PHONEdisplayTXT").innerHTML = 'MONTRER PHONES';}
		else {PHONEdisplay='1';   document.getElementById("PHONEdisplayTXT").innerHTML = 'CACHER PHONES';}
		}
	if (task_option == 'CUSTPHONEdisplay')
		{
		if (CUSTPHONEdisplay == '1') {CUSTPHONEdisplay='0';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = 'MONTRER CUSTPHONES';}
		else {CUSTPHONEdisplay='1';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = 'CACHER CUSTPHONES';}
		}
	if (task_option == 'ALLINGROUPstats')
		{
		if (ALLINGROUPstats == '1') {ALLINGROUPstats='0';   document.getElementById("ALLINGROUPstatsTXT").innerHTML = 'MONTRER IN-GROUP STATS';}
		else {ALLINGROUPstats='1';   document.getElementById("ALLINGROUPstatsTXT").innerHTML = 'CACHER IN-GROUP STATS';}
		}
...
echo "<a href=\"#\" onclick=\"showDiv('campaign_select_list');\">Rapport Choisissez Options d-affichage</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
...
echo " &nbsp; ";
echo "</span>\n";
echo "<a href=\"#\" onclick=\"update_variables('form_submit','','YES')\">Rechargez maintenant</a>";
...
echo " &nbsp; &nbsp; &nbsp; rafraîchir: <span id=refresh_countdown name=refresh_countdown></span>\n\n";
...
if ($UGdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>CACHER GROUPE D'UTILISATEURS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('UGdisplay','');\"><font size=1><span id=UGdisplayTXT>VIEW GROUPE D'UTILISATEURS</span></font></a>";}
if ($SERVdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>CACHER SERVEUR INFO</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('SERVdisplay','');\"><font size=1><span id=SERVdisplayTXT>MONTRER SERVEUR INFO</span></font></a>";}
if ($CALLSdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CALLSdisplay','');\"><font size=1><span id=CALLSdisplayTXT>CACHER WAITING CALLS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CALLSdisplay','');\"><font size=1><span id=CALLSdisplayTXT>MONTRER WAITING CALLS</span></font></a>";}
if ($ALLINGROUPstats>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('ALLINGROUPstats','');\"><font size=1><span id=ALLINGROUPstatsTXT>CACHER IN-GROUP STATS</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('ALLINGROUPstats','');\"><font size=1><span id=ALLINGROUPstatsTXT>MONTRER IN-GROUP STATS</span></font></a>";}
if ($PHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('PHONEdisplay','');\"><font size=1><span id=PHONEdisplayTXT>CACHER PHONES</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('PHONEdisplay','');\"><font size=1><span id=PHONEdisplayTXT>MONTRER PHONES</span></font></a>";}
if ($CUSTPHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><font size=1><span id=CUSTPHONEdisplayTXT>CACHER CUSTPHONES</span></font></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><font size=1><span id=CUSTPHONEdisplayTXT>MONTRER CUSTPHONES</span></font></a>";}
