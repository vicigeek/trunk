...
{
$MAIN.="\n";
$MAIN.="PLEASE SELECT AN AGENT ID AND DATE-TIME ABOVE AND CLICK INVIA\n";
...
$MAIN.="AgentTime Sheet                            $NOW_TIME\n";

$MAIN.="Intervallo Di Tempo: $query_date_BEGIN to $query_date_END\n\n";
$MAIN.="---------- AGENT TIME SHEET: $agent - $full_name -------------\n\n";

$CSV_text_header.="\"AgentTime Sheet- $NOW_TIME\"\n";
$CSV_text_header.="\"Intervallo Di Tempo: $query_date_BEGIN to $query_date_END\"\n";
...
if ($calls_summary)
	...
	$MAIN.="TOTALE CHIAMATE TAKEN: $row[0]     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=1'>[DOWNLOAD]</a>\n";
	...
	$CSV_text1.="\"\",\"TOTALE CHIAMATE TAKEN: $row[0]\"\n";
...
$MAIN.="<B>TIMECLOCK TIEMPO LOGIN/LOGOUT:     <a href='$PHP_SELF?calls_summary=$calls_summary&agent=$agent&query_date=$query_date&file_download=2'>[DOWNLOAD]</a></B>\n";
$MAIN.="<TABLE width=550 cellspacing=0 cellpadding=1>\n";
$MAIN.="<tr><td><font size=2>ID </td><td><font size=2>EDIT </td><td align=right><font size=2>EVENTO </td><td align=right><font size=2> DATA</td><td align=right><font size=2> IP ADDRESS</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>ORE:MINUTI</td></tr>\n";

$CSV_text2.=$CSV_text_header;
$CSV_text2.=$CSV_login;
$CSV_text2.="\"TIMECLOCK TIEMPO LOGIN/LOGOUT:\"\n";
$CSV_text2.="\"\",\"ID\",\"EDIT\",\"EVENT\",\"DATE\",\"IP ADDRESS\",\"GROUP\",\"ORE:MINUTI\"\n";
...
$MAIN.="<td align=right><font size=2> </td>\n";
$MAIN.="<td align=right><font size=2> </td>\n";
$MAIN.="<td align=right colspan=2><font size=2><font size=2>TOTALE </td>\n";
