...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">ALTERAR</a> | <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a>";
$MAIN.="</FONT>\n";
$MAIN.="</FORM>\n\n";
...
$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>INBOUND SERVICE NÍVEL REPORT</caption><tr><th class='thgraph' scope='col'>STATUS</th>";
...
$ASCII_text.="+-------------+-----------------------+-------+-------+  +-----------------------+-------+-------+\n";
$ASCII_text.="|    TIME     |  AVG HOLD TIME (sec)  | (em segundo)  |  |    CALLS HANDLED      |       |       |\n";
...
$MAIN.="\n";
$MAIN.="---------- TEMPO DE ESPERA POR SEGUNDOS\n";
$MAIN.="+-------------+-------+-----------------------------------------+ +------+--------------------------------+\n";
$MAIN.="|    TIME     |       |  % OF CALLS GROUPED BY HOLD TIME (SEC)  | |   AVERAGE TIME BEFORE RESPOSTA (SEC)    |\n";
$MAIN.="| 15 MIN INT  | CALLS |    0   20   40   60   80  100  120 120+ | | AVG  |0   20   40   60   80  100  120 |\n";
$MAIN.="+-------------+-------+-----------------------------------------+ +------+--------------------------------+\n";

$CSV_text.="\"TEMPO DE ESPERA POR SEGUNDOS\"\n";
$CSV_text.="\"TIME 15-MIN INT\",\"CALLS\",\"0 (seconds)\",\"20\",\"40\",\"60\",\"80\",\"100\",\"120\",\"120+\",\"AVG TIME BEFORE RESPOSTA(SEC)\"\n";
